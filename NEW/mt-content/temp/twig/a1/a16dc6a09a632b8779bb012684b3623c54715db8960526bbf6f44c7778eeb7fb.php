...
class __TwigTemplate_5efb9f9a1b150b93207f5361036a0132d763e36702cd7f885c21d5f2064fd799 extends Twig_Template
{
...
";
        // line 113
        if (($this->getAttribute(($context["user"] ?? null), "language_locale", []) != "en_US")) {
            // line 114
            echo "<script src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Moto\Twig\Extension\AssetExtension')->getFileUrl((("@adminApplication/lang/" . $this->getAttribute(($context["user"] ?? null), "language_locale", [])) . ".min.js"), true), "html", null, true);
            echo "\" type=\"text/javascript\" data-cfasync=\"false\"></script>
";
        }
        // line 116
...
<script type=\"text/javascript\" data-cfasync=\"false\">
    angular.module('application.plugins', ";
        // line 118
        echo twig_jsonencode_filter($this->env->getExtension('Moto\Twig\Extension\AssetExtension')->renderHook("admin.application.plugins", []));
        echo ");
</script>
";
        // line 120
...
";
    ...
    {
        return new Twig_Source("", "application/index.html", "/home/buyersel/public_html/mt-admin/views/application/index.html");
    }
}
