                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <!--  <form class="form-horizontal form-row-seperated" action="#"> -->
                        {!! Form::open(array('route'=>array('admin.tradeshow-update',$pre_trade_data->tradeshow_id),'id'=>'form1','class'=>'form-horizontal  form-row-seperated trade_edit_form','files'=>true)) !!}
                                            ...
                                            <div class="tab-pane active" id="tab_general">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Country Name: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::text('location',$pre_trade_data->location,['class'=>'form-control','placeholder'=>'location','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Date: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-9">
                                                            {!! Form::text('date',$pre_trade_data->date,['class'=>'form-control date','placeholder'=>'Date','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Duration: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div style="margin-left:1.5%" class="col-md-9 navbar-form">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Venue: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-9">
                                                            {!! Form::text('venue',$pre_trade_data->venue,['class'=>'form-control','placeholder'=>'vanue','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="tab-pane" id="tab_meta">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::text('title',$pre_trade_data->title,['class'=>'form-control','placeholder'=>'Title','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::text('meta_title',$pre_trade_data->meta_title,['class'=>'form-control','placeholder'=>'Meta-Title','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::text('meta_keyword',$pre_trade_data->meta_keyword,['class'=>'form-control','placeholder'=>'Meta-keyword','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
