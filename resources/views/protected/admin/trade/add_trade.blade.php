                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::text('location',null,['class'=>'form-control','placeholder'=>'location','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-9">
                                                            {!! Form::text('date',null,['class'=>'form-control date','placeholder'=>'Date','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Vanue: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-9">
                                                            {!! Form::text('vanue',null,['class'=>'form-control','placeholder'=>'vanue','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="tab-pane" id="tab_meta">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::text('title',null,['class'=>'form-control','placeholder'=>'Title','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::text('meta_title',null,['class'=>'form-control','placeholder'=>'Meta-Title','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::text('meta_keyword',null,['class'=>'form-control','placeholder'=>'Meta-keyword','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
