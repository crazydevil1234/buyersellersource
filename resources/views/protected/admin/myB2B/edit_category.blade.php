                                        ...
                                        <div class="tab-content no-space">
                                            <div class="tab-pane active" id="tab_general">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Slug: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Tag: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-9">
                                                                    ...
                                                                    <ul class="list-unstyled">
                                                                        @if($categories->parent_id==0)
                                                                          ...
                                                                          <label><input type="checkbox" class="parent_id" name="categories[]" value="0">Parent</label> 
                                                                            <label>
                                                                                @if($parent)
                                                                                <input type="checkbox" checked=checked class="parent_id" name="categories[]" value="{{$parent->id}}">{{$parent->category_name->name}}
                                                                                @else
                                                                                @endif
                                                                            </label>          
                                                                        @endif
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">SEO keyword: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Top: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-6">
                                            ...
                                            <div class="tab-pane" id="tab_meta">
                                                <div class="form-body">
                                                    <div class="form-group" style="margin-top: 100px">
                                                        <label class="col-md-2 control-label">H1 headline:</label>
                                                        <div class="col-md-10">
