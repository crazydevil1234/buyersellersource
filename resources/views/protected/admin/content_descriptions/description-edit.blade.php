...
@section('content')
    ...
    <h3 class="page-title">
        Page-Content-Description Edit <small>create & edit content</small>
    </h3>
    <div class="page-bar">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <textarea id="editor" class="form-control" name="desc_name" value="{{ $description[0]->description }}" placeholder="Description Name">{{ $description[0]->description }}</textarea>
                                        </div>
                                    </div>
