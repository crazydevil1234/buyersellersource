    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            @endif
			  ...
			  <select class="form-control" name="supplier_list" id="supplier_list" style="important; width: 185px !important">
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="checkbox">
					  <label><input type="checkbox" name="make_wholesale">Make Wholesale Product</label>
					</div>
					<div class="checkbox">
					  <label><input type="checkbox" name="make_hot">Make Hot Product</label>
					</div>
					<div class="checkbox">
					  <label><input type="checkbox" name="make_bangladeshi">Make Bangladeshi Product</label>
					</div>
				</div>
