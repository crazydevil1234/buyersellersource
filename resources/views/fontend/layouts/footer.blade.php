...
<ul class="foot-list" style="font-weight:600"><li>{{ $footer->category_name }}</li></ul>
<ul class="foot-list">
...
<a target="_blank" style="color:#696763;display:inline-block" href="{{URL::to('Bdsource-home-page')}}">BdSource |</a>
