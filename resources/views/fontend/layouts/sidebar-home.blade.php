...
<h3 style="padding-left:15px"><a itemprop="url" href="{{ URL::to('online-marketplace',null)}}"><i class="fa fa-list-ul"></i> CATEGORIES</a></h3>
@if ($categorys)
...
<a class="fea-lk" target="_blank" href="{{ URL::to('Bdsource-home-page')}}">
<div class="fea-bg">
<div class="fea-info">
