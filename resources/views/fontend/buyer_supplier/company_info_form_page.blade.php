            ...
            <div class="tab-content">
               ...
               <div role="tabpanel" class="tab-pane" id="certification_trademarks">
                  ...
                  <div class="col-md-12" style="margin-top:2.5%;border:1px solid #ddd;padding: 0;">
                     <ul class="list-inline" style="margin:0%;height:33px">
                        <li style="border-right:1px solid #ddd;padding-bottom:0%;height:33px"><a class="certification_tab hvr-underline-from-center" href="#add_certificatons" style="line-height:33px;font-size:13px">Certifications/Test Report</a></li>
                        <li style="border-right:1px solid #ddd;padding-bottom:0%;height:33px"><a class="certification_tab hvr-underline-from-center" href="#add_awards" style="line-height:33px;font-size:13px">Honor &amp; Award Certifications</a></li>
                        <li style="border-right:1px solid #ddd;padding-bottom:0%;height:33px"><a class="certification_tab hvr-underline-from-center" href="#add_patents" style="line-height:33px;font-size:13px">Patents</a></li>
                        <li style="border-right:1px solid #ddd;padding-bottom:0%;height:33px"><a class="certification_tab hvr-underline-from-center" href="#add_trademarks" style="line-height:33px;font-size:13px">Trademarks</a></li>
                     </ul>
                  </div>
                  ...
                  <section id="add_certificatons" class="in_visible BdtdcCertificationImage">
                     ...
                     <div style="margin-top:0%;border:1px solid #ddd;padding-top:1%;padding-bottom:1%" class="col-md-12">
                        ...
                        <div style="margin-top:1%;margin-bottom:1%" class="row">
                           ...
                           <div class="col-xs-6">
                              <input type="submit" value="Save certifications" class="btn btn-default btn-xs certification_submit_btn" data-section_id="#add_certificatons">
                           </div>
                        </div>
                     </div>
                  </section>
                  ...
                  <section id="add_awards"  class="in_visible BdtdcHonorImage">
                     ...
                     <div style="margin-top:0%;border:1px solid #ddd;padding-top:1%;padding-bottom:1%" class="col-md-12">
                        ...
                        <div style="margin-top:1%;margin-bottom:1%" class="row">
                           ...
                           <div class="col-xs-6">
                              <input type="submit" value="Save certifications" data-section_id="#add_awards" class="btn btn-default btn-xs certification_submit_btn">
                           </div>
                        </div>
                     </div>
                  </section>
                  ...
                  <section id="add_patents" class="in_visible BdtdcPatentImage">
                     ...
                     <div style="margin-top:0%;border:1px solid #ddd;padding-top:1%;padding-bottom:1%" class="col-md-12">
                        ...
                        <div style="margin-top:1%;margin-bottom:1%" class="row">
                           ...
                           <div class="col-xs-6">
                              <input type="submit" value="Save Patent" data-section_id="#add_patents" class="btn btn-default btn-xs form_data certification_submit_btn">
                           </div>
                        </div>
                     </div>
                  </section>
                  ...
                  <section id="add_trademarks" class="in_visible BdtdcTrademarksImage">
                     ...
                     <div style="margin-top:0%;border:1px solid #ddd;padding-top:1%;padding-bottom:1%" class="col-md-12">
                        ...
                        <div style="margin-top:1%;margin-bottom:1%" class="row">
                           ...
                           <div class="col-xs-6">
                              <input type="submit" value="Save Trademark" data-section_id="#add_trademarks" class="btn btn-default btn-xs form_data certification_submit_btn">
                           </div>
                        </div>
                     </div>
                  </section>
   ...
   (function() {
      ...
      $(document).on({
         click: function(e) {
            ...
            url = window.location.origin + '/user/post_company_info';
               ...
               $.ajax({
                  ...
                  success: function(data, textStatus, jqXHR) {
                     if (parseInt(data[0]) == 1) {
                        img_path = window.location.origin + '/uploads/' + data[1];
      ...
      $(document).on({
         click: function(e) {
            ...
            $.ajax({
               ...
               success: function(data, textStatus, jqXHR) {
                  if (parseInt(data[0]) == 1) {
                     img_path = window.location.origin + '/uploads/' + data[1].image;
      ...
      $(document).on({
         click: function(e) {
            ...
            url = window.location.origin + '/user/post_certification_info';
            $.post(url, form_data, function(r) {
               // console.log(r);
               obj = $.parseJSON(r);
               if(obj.status){
         ...
         click: function(e) {
            ...
            $.ajax({
               ...
               success: function(data, textStatus, jqXHR) {
                  if (parseInt(data[0]) == 1) {
                     $('.default_icon').remove();
                     tempalte = '<div class="col-md-4 text-center"><input type="hidden" name="image_name[]" value="' + data[1].image + '" /><img style="width:100%;border:1px solid #0087CF;padding:2%;height:115px" src="' + window.location.origin + '/uploads/' + data[1].image + '" class="img-responsive" alt=""><a href="#" data-id_to_delete="' + data[1].id + '" data-modal="' + modal + '" style="width:37%;margin-top:2%" class="btn btn-danger btn-xs delete_img"><i class="fa fa-times"></i></a></div>';
                     tr_holder = '<tr><td><img style="width:32%;border:1px solid #0087CF;padding:2%;height:89px" src="' + window.location.origin + '/uploads/' + data[1].image + '" class="img-responsive" alt=""></td></tr>';
      ...
      $(document).on({
         click: function(e) {
            ...
            if (confirm('Are you sure?')) {
               ...
               var url = window.location.origin + '/user/delete_image/' + id + '/' + section_class;
               _this = $(this);
               $.get(url, function(r) {
                  if (parseInt(r) == 1) {
                     _this.parent().remove();
