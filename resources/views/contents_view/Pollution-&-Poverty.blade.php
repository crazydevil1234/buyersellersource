...
<div class="row padding_0">
   <div class="col-sm-12" style="padding: 0; min-height: 60px; padding-top: 15px;">
      <ul class="nav nav-tab nav-pills trade-show-ul" style="background:none;border-bottom: 1px solid #dae2ed; margin-left: 0;" aria-label="Navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
         ...
         <li class="" style="margin-left: 10px;"><a itemprop="url" itemprop="url"  class="padding_0" href="{{route('select.suppliers')}}" target="_blank" data-toggle="tab" aria-expanded="false" style="background-color: #f5f5f5;color: #5b9bd1;">Quality Suppliers</a></li>
         <li class=""><a itemprop="url" itemprop="url"  style="font-size: 13px;" class="padding_0" href="{{route('trade.show')}}" data-toggle="tab" aria-expanded="false">BuyerSeller Events</a></li>
         ...
         <li class=""><a itemprop="url" itemprop="url"  style="font-size: 13px;" class="padding_0" href="{{route('bdtdc.service')}}" data-toggle="tab" aria-expanded="false" target="_blank">Service Highlight</a></li>
      </ul>
   </div>
</div>
