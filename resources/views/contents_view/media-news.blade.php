	...
	<div class="col-sm-2">
		<div class="side-bdtdc-menu">
				<ul style="padding-left: 0;">
					<li><a itemprop="url"   href="{{URL::to('tradeshow',null)}}" class="frIco event" target="_blank"><p>Events</p></a></li>
					<li><a itemprop="url"   href="{{URL::to('prease-release/the-daily-star',null)}}" class="frIco press"><p>Press Release</p></a></li>
					
					<li style="height: 50px;"><a itemprop="url"    href="{{URL::to('bangladesh/business',null)}}" class="frIco bangla"><p>Bangladesh Means Business</p></a></li>
					...
					<li><a itemprop="url"    href="{{URL::to('contact',null)}}" target="_blank" class="frIco contac-con"><p>Contact Us</p></a></li>
					<li><a itemprop="url"    href="{{URL::to('bdtdc-media-news',null)}}" target="_blank" class="fa fa-newspaper-o" style="font-size: 22px;color:#666;margin-top: 5%;"><p style="margin-top: -7%;margin-left: -12%;font-size:16px;"></i>Media News</p></a></li>
				</ul>
		</div>
		<div class="promo-img">
