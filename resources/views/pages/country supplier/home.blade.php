        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel" style="background-color:#fff; height: 320px">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <img itemprop="image" style="width:auto; height: auto" src="{!! asset('assets/country-images/'.$country->country_image_one->image) !!}" alt="bdtdc" class=""> @if($country->id==18)
            ...
            <div class="business-tit">
                ...
                <div class="item">
                    <img itemprop="image" style="width:100%;" src="{!! asset('assets/country-images/'.$data->image) !!}" alt="supplier" class=""> @if($country->id==18)
                    <!--   <div class="carousel-caption" style="top:18%; left:24%;">
            <div class="business-tit">
       </div></div> -->
        ...
        @endif
          <div class="img-hilight  product-hover single-products" itemscope itemtype="http://schema.org/Product" style="margin-top:5%;">
           ...
           @if($data->select_product_images)
            <img itemprop="image" title="{{ $data->pro_name_string->name  }}" style="height: 200px;width: 200px;" class="img-thumbnail bd-prduct" src="{{ URL::to(''.$data->select_product_images->image,null) }}" alt="{{ $data->pro_name_string->name  }}" />
          @else
