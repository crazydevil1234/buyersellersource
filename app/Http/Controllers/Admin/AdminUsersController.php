...
class AdminUsersController extends Controller
{
    ...
    public function index(Request $request, $sear=null)
    {
        ...
        $users = $user_query->with('companies','companies.name_string','customers','suppliers','suppliers.business_types')->whereNotIn('role',['admin'])->orderBy('created_at','desc')->paginate(15);
     ...
     * @return Response
     */
    public function update(AdminUsersEditFormRequest $request)
    {
        $id=$request->id;
        $user = User::find($id);
