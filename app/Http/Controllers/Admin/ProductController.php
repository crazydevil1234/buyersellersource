...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $category=BdtdcCategory::with('sub_cat')->get();

        return view('protected.admin.product.product_lists',compact('products', 'country', 'category'));
    }
    ...
    public function product_search(Request $request){
        ...
        return view('protected.admin.product.product_lists',compact('products'));
    }
