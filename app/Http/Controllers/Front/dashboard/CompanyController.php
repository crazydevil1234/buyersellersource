...
class CompanyController extends Controller
{
    ...
    public function index($section=false){
        ...
        if(Sentinel::check())
        {
            ...
            return View::make('fontend.supplier.dashboard',$data,compact(['supplier','supplier_product','template_setting_data','section','template_setting_section','favorite_product']));
