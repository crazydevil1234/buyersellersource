...
<section>
	<div class="desktop">
		<?php echo $__env->make('Aboutus.about-us-header-home', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	</div>
	<div class="mobil-phone">

	<?php echo $__env->make('Aboutus.about-us-top-m-menu', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	</div>
</section>
  ...
  <div class="row padding_0 abt-top">
  		    <div class="col-md-12 col-sm-12 padding_0">
  				...
  				<ul class="feature-list my-ftch">
  					<li><a href="<?php echo URL::to('BuyerChannel/pages/sustainable_manufacturing',7); ?>">
  					Promoting Sustainable Manufacturing</a></li>
  					<li><a href="<?php echo URL::to('tradeshow',null); ?>">Conferences and Expositions</a></li>
  					<li><a href="<?php echo URL::to('promoting/bangladesh',null); ?>">Supporting Bangladesh Services</a></li>
  					<li><a href="<?php echo URL::to('promoting/bangladesh/product'); ?>">Supporting Bangladesh Products</a></li>
  					<li><a href="<?php echo URL::to('business/matching',null); ?>">Matching Businesses </a></li>
  					<li><a href="<?php echo URL::to('marketing/bangladesh',null); ?>">Representing Bangladesh Brands to the World  </a></li>
  					<li><a href="<?php echo URL::to('global/partnership',null); ?>">Buyer Seller Global Partnerships </a></li>
  				</ul>
  		</div>
  		</div>
 </div>
 		...
 		<div class="col-md-12 col-sm-12 padding_0" style="padding-bottom: 40px;">
 		  <div>
 				<div class="sut-pp">
 				 ...
 				 <img style="width: 200px; margin-top: 30px;" src="<?php echo asset('assets/fontend/images/think-asia-bangladeshg.jpg'); ?>"  alt="think asia bangladeshg">
 				</div>
 				<div style="max-width: 800px; margin: 0 auto;">
 				 <ul class="feature-list">
  					<li><a style="color: #fff !important;" href="<?php echo URL::to('sustainable/business-case',null); ?>">
  					Eco-minded Business Practices </a></li>
  					<li><a style="color: #fff !important;" href="<?php echo URL::to('how-to/business-bangladesh',null); ?>">How to Do Businesses in Bangladesh </a></li>
  					<li><a style="color: #fff !important;" href="<?php echo URL::to('promoting/bangladesh',null); ?>">Bangladesh's Services  </a></li>
  					<li><a style="color: #fff !important;" href="<?php echo URL::to('bangladesh/advantage',null); ?>">Bangladesh's Advantages  </a></li>
  				</ul>
 				</div>
 			</div>
 		</div>
...
<div class="container padding_0" style="background:#FFFFFF;">
  <div class="row padding_0 abt-top">
  			<div class="col-sm-12 col-md-12 col-xs-12">
  				<div class="sut-pp">
                           <div class="h2-head-title" style="font-size: 23px; color:#333; margin-bottom: 30px;">OUR MISSION</div>
                           	    <p class="sut-pp"><br>The BuyerSeller.Asia is a leading, eco-minded B2B marketplace and a primary facilitator of trade within Greater Bangladesh and South Asia. Our aim is to explore new markets and create global business opportunities for Bangladesh SMEs.
  			...
  			<div class="col-sm-12 col-md-12 col-xs-12">
  				<div style="max-width: 800px; margin: 0 auto;">
	  				...
	  				<ul class="feature-list my-ftch">
	  					<li><a href="<?php echo URL::to('research',null); ?>">Buyer Seller Research
	  					</a></li>
	  					<li><a href="<?php echo URL::to('start/programe',null); ?>">Startup Program </a></li>
	  					<li><a href="<?php echo URL::to('world-sme/expo',null); ?>">World SME Expo </a></li>
	  					<li><a href="<?php echo URL::to('entrepreneur/day',null); ?>">Entrepreneur Day </a></li>
	  					<li><a href="<?php echo URL::to('portal/support-program',null); ?>">SME/Start-up Portal</a></li>
	  					<li><a href="<?php echo URL::to('sme-center',null); ?>">Buyer Seller SME Center</a></li>
	  					<li><a href="<?php echo URL::to('business/advisory',null); ?>">Business Advisory </a></li>
	  				<li><a href="<?php echo URL::to('tradeshow',null); ?>">Seminars & Workshop </a></li>
	  					<li><a href="<?php echo URL::to('database-listing',null); ?>">Buyer Seller Databank Listings </a></li>
	  				</ul>
 				</div>
  			</div>
  </div>
       			...
       			<div class="col-md-12 col-sm-12" style="padding: 0 5rem 0 0;">
 								...
 								<div class="jcarousel_mng">
 								  <div class="corporate-mng-box">
 									...
 									<img style="height: 164px; width: 164px; margin-top: 10px;" class="img-circle" src="<?php echo asset('assets/fontend/aboutus-images/kazi-ahammed.png'); ?>" alt="kazi ahammed">
 								...
 								<div class="richrd">
	 								 <div class="mang-cor">
	 									<img class="img-circle" style="height: 164px; width: 164px;" src="<?php echo asset('assets/fontend/aboutus-images/reshard.png'); ?>" alt="reshard">
	 									<div class="degint-ttle">
	 								...
	 								<div class="mang-cor" style="margin-top: 10px;">
	 									<img class="img-circle" src="<?php echo asset('assets/fontend/aboutus-images/Ferries.jpg'); ?>" alt="Ferries">
	 									<div class="degint-ttle">
 ...
 <section class="corporate-bg">
	<div class="container">
 	...
 	<div style="text-align: center; margin: 0 auto;">
 		...
 		<div class="link-circle"><span class="frame"><a href="<?php echo URL::to('tradeshow',null); ?>" class="corporate-title-"> Exhibitions</a></span>
 		</div>
 	<div class="link-circle"><span class="frame"><a href="<?php echo URL::to('',null); ?>" class="corporate-title-">Bangladesh & International Relations</a></span>
 	</div>
 		<div class="link-circle"><span class="frame"><a href="<?php echo URL::to('promoting/bangladesh',null); ?>" class="corporate-title-">Product Promotion</a></span>
 		</div>
 		<div class="link-circle"><span class="frame"><a href="<?php echo URL::to('',null); ?>" class="corporate-title-">Publications and E-Commerce</a></span>
 		</div>
 	</div>
 	</div>
 <div class="row abr-margin">
 	<div style="text-align: center; margin: 0 auto;">
 		<div class="link-circle"><span class="frame"><a href="<?php echo URL::to('promoting/bangladesh',null); ?>" class="corporate-title-">Service Promotion</a></span></div>
 		<div class="link-circle"><span class="frame"><a href="<?php echo URL::to('',null); ?>" class="corporate-title-">Communication and Public Affairs</a></span></div>
 		<div class="link-circle"><span class="frame"><a href="<?php echo URL::to('marketing/bangladesh',null); ?>" class="corporate-title-">Marketing and Customer Service</a></span></div>
 		<div class="link-circle"><span class="frame"><a href="<?php echo URL::to('research',null); ?>" class="corporate-title-">Research</a></span></div>
 	</div>
	</div>
	</div>
</section>
  ...
  <div class="container padding_0">
		...
		<div class="col-sm-12 col-md-12 ">
	     ...
	     <div id="container" style="max-width: 800px; margin: 0 auto;">
					  <ul class="showcase">
					    <li class="thumb1"> <a href="<?php echo URL::to('web-developer/laravel',null); ?>"><img src="<?php echo asset('assets/fontend/aboutus-images/laravel-developer.jpg'); ?>" width="500" height="374" alt="web3canvas">
					      <div class="sh-hov">
                ...
                <p>Are you enthusiastic about Android, gadgets and constructing great products? If so, we want to hear from you! This might just be your dream job!</p>
					    ...
					    <li class="thumb2"> <a href="<?php echo URL::to('executive',null); ?>" target="_blank"><img src="<?php echo asset('assets/fontend/aboutus-images/business-handshake.png'); ?>" width="500" height="374" alt="web3canvas">
                <div class="sh-hov">
                  <h3>Marketing Executive<i>+</i></h3>
                    <p>Make this your ideal job as you build-up and deal with activities and materials to support sales, as well as utilize marketing automation tools and strategies.</p>
					    ...
					    <li class="thumb3"> <a href="<?php echo URL::to('content/writer',null); ?>"><img src="<?php echo asset('assets/fontend/aboutus-images/content-writing-service.jpg'); ?>" width="500" height="374" alt="web3canvas">
                <div class="sh-hov">
...
<section class="corporate-business">
  <div class="container padding_0">
		...
		<div class="col-sm-12 col-md-12 padding_0 " style="background: #fff; opacity: .9;">
			...
			<div>
			<img style="width: 100%;margin: 25px 14px 0px 0px;" src="<?php echo asset('assets/fontend/aboutus-images/b2b_service.jpg'); ?>" alt="b2b service">
			</div>
		</div>
	...
	<div class="col-sm-12 col-md-12" style="background: #fff;opacity: .9;">
		...
		<div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
			<img class="buyer-lst-bd" itemprop="image" src="<?php echo asset('assets/fontend/images/FreeTek-International.png'); ?>" alt="FreeTek International">
		</div>
		<div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
			<img class="buyer-lst-bd" itemprop="image" src="<?php echo asset('assets/fontend/images/Metro-Goldwyn-Mayer.png'); ?>" alt="Metro Goldwyn Mayer">
		</div>
		<div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
			<img class="buyer-lst-bd" itemprop="image" src="<?php echo asset('assets/fontend/images/Yinsaviny.png'); ?>" alt="Yinsaviny">
		</div>
		<div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
			<img class="buyer-lst-bd" itemprop="image" src="<?php echo asset('assets/fontend/images/Guangzhou-Sincere.png'); ?>" alt="Guangzhou Sincere">
		</div>
		</div>
	</div>
	<div class="col-sm-12 col-md-12" style="background: #fff;opacity: .9;">
		<div class="row padding_0" style="max-width: 800px; margin: 0 auto;">
	   <div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
			<img class="buyer-lst-bd" itemprop="image"  src="<?php echo asset('assets/fontend/images/ORICO-Technology.png'); ?>" alt="ORICO Technology">
		</div>
	 <div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
			<img class="buyer-lst-bd" itemprop="image"  src="<?php echo asset('assets/fontend/images/Shenzhen-Yoobao-Technology.png'); ?>" alt="Shenzhen Yoobao Technology">
		</div>
	<div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
			<img class="buyer-lst-bd" itemprop="image"  src="<?php echo asset('assets/fontend/images/Weihai-Noeby-Fishing.png'); ?>" alt="Weihai Noeby Fishing">
		</div>
	    <div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
			<img class="buyer-lst-bd" itemprop="image"  src="<?php echo asset('assets/fontend/images/Shenzhen-Shenhuo.png'); ?>" alt="Shenzhen Shenhuo">
		</div>
	</div>
	</div>
</div>
...
<br>
				...
				<div class="col-sm-3 col-md-3 col-lg-3 padding_0">
					<div>
				        ...
				        <div class="logoShow">
				          <img style="width: 265px;padding: 10px;" class="carOrg" src="<?php echo asset('images/logo-white.png'); ?>" alt="Buyer Seller"> 
				        </div>
				      </div>
				</div>
			</div>
        ...
        <div class="modal-body">
         	<div class="row">
         			<div class="col-sm-4 col-xs-5">
         				<img src="<?php echo asset('assets/fontend/aboutus-images/kazi-ahammed.png'); ?>" alt="kazi-ahammed">
         			</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('fontend.about-us-topbar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>