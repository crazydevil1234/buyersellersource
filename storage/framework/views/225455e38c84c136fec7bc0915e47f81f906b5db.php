    ...
    <link property='stylesheet' href="<?php echo asset('css/sourcing-easier.css'); ?>" rel="stylesheet">    
...
<div class="container">
    ...
    <div class="col-md-12 padding_0" style=" margin-top: 20px;">
      ...
      <li style="float: left" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" style="color: #000"> Home <i class="fa fa-angle-right"></i></a></li>
              <li style="float: left" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('ServiceChannel/pages/for_buyer',35)); ?>" style="color: #000"> Help Center <i class="fa fa-angle-right"></i></a></li>
              <li style="float: left" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('services')); ?>" style="color: #000">  Service <i class="fa fa-angle-right"></i></a></li>
	...
	<div class="row padding_0" style="background-color: #fff;">
            ...
            <tbody><tr>
                 ...
                 <td style="width: 50%; padding-left: 0;">
                    <img style="height:324px;width:100%;"  src="<?php echo asset('assets/fontend/bdtdc-images/Screenshot_1.png'); ?>" alt="bangladesh means business" />
                </td>
                        </tr>
        			</tbody>
	...
	<div class="row padding_0" style="background:#f1f1f1;">
    	...
    	<div class="source-wrapper">
        	<table>
                   ...
                   <img style="height:324px;width:100%; padding-right: 20px;"  src="<?php echo asset('assets/fontend/bdtdc-images/bdtdc-source.png'); ?>" alt="bangladesh means business" />
                </td>
        ...
        <table>
            <tbody><tr>
                    ...
                    <!-- <div class="easy-text"> <a target="_blank" class="easy-more" href="http://wholesaler.BuyerSeller.asia/?spm=a2700.7848340.1998823020.8.GSAW3i">Try ›</a></div> -->
                            ...
                            <td style="width: 50%; padding-left: 0;">
                    <img style="height:324px;width:100%"  src="<?php echo asset('assets/fontend/bdtdc-images/whole-sale.png'); ?>" alt="bangladesh means business" />
                </td>
                        </tr>
        </tbody></table>
    </div>
...
<div class="module" data-spm="2508361"><div class="tb-module common-faq">
	...
	<div class="" style="background:#fff;">
                    <div class="col-sm-4 col-md-4 col-lg-4" style="border-right: 1px solid #ddd;">
                        ...
                        <img class="sourc-img" src="<?php echo e(URL::to('assets/fontend/bdtdc-images/hero1.jpg')); ?>" alt="contact-byuer">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4" style="border-right: 1px solid #ddd;">
                        <img class="sourc-img" src="<?php echo e(URL::to('assets/fontend/bdtdc-images/hero2.jpg')); ?>" alt="contact-gold-member">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4" style="border-right: 0 none;">
                        <img class="sourc-img" src="<?php echo e(URL::to('assets/fontend/bdtdc-images/hero3.jpg')); ?>" alt="contact-gold-member">
