        ...
        <div class="container">
            ...
            <div class="col-sm-1 col-md-1"></div>
                ...
                <div class="col-sm-11" style="padding-left: 14%; padding-bottom: 7%; padding-top: 5%;">
                    <a href="<?php echo e(URL::to('email/verification_by_key',$rand_key)); ?>" style="margin-top: 5%; min-height: 30px; border-radius: 5px; background: rgb(25, 70, 111) none repeat scroll 0% 0%; color: rgb(255, 255, 255); font-size: 20px; padding: 2% 5%; text-decoration: none;" >Verify Your Email</a>
                </div>
                <div class="col-sm-11">
                    <p style="width: 60%;line-height: 30px;font-size: 18px;font-family: sans-serif;letter-spacing: initial;white-space: pre-line;font-weight: 800;color: #999;">
                       ...
                       <a href="<?php echo e(URL::to('email/verification_by_key-mobile',$rand_key)); ?>">
                           email/verification_by_key-mobile/<?php echo e($rand_key); ?>
