...
<div class="row query_box" style="padding:0;padding: 0 2%;border:1px solid #ddd;">
   <div class="buy-supplier-cont-masg" style="margin: 0 -2%;">
      ...
      <?php
        ...
        ?>
      <p class="" style="font-weight:bold;font-size:14px;color:#666;padding:1%;padding-left:2%;text-align:center;"> <i class="fa fa-user-md"></i> <?php echo $supp_name; ?> | <a href="<?php echo URL::to('Home'); ?>/<?php echo e($comp_name); ?>/<?php echo e($products->supplier_product->sup_companies->id); ?>"><?php echo $comp_name; ?></a></p>
      <?php else: ?>
      <p class="well text-center" style="font-weight:bold;font-size:14px;color:#666;padding:1%;padding-left:2.5%;"> <i class="fa fa-user-md"></i> <?php echo e((isset($user)) ? $user->first_name . " " . $user->last_name : ""); ?> </p>
      <?php endif; ?>
   </div>
   <div class="">
   ...
   <form action="" class="form query_form" method="post" enctype="multipart/form-data">
      ...
      <div class="" style="width:100%; border-bottom:1px solid #ddd;">
         ...
         <div class="" style="padding-left:0;">
            <table style="border:1px solid #A5A5A5" class="table">
               ...
               <tr>
                  <td style="width:50%;">
                     <a href="<?php echo e(URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\. -]/', ' ', $products->product_name->name).'='.mt_rand(100000000, 999999999).$products->id,null)); ?>" target="_blank">
                        <?php if($products->product_image_new): ?>
                        <img style="width:70px;height:75px" src="<?php echo e(URL::to(''.$products->product_image_new->image,null)); ?>" alt="" class="img-thumbnail">
                        <?php else: ?>
                        <img style="width:70px;height:75px" src="<?php echo e(URL::to('uploads/no-image.jpg','')); ?>" alt="" class="img-thumbnail">
                        <?php endif; ?>
                        <span class="btn btn-link" style="color:#666; height:65px;font-size:14px; line height:22px;padding:1%;padding-top:3%;"><?php echo e(substr($products->product_name->name,0,37)); ?>...</span></a>
                  </td>
                  ...
                  <td style="width:15%;">
                     ...
                     <select name="unit_id" style="height:30px; width:100%; background-color:#fff; border:1px solid #ddd;">
                        <?php $__currentLoopData = $BdtdcProductUnit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productunit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($productunit->id); ?>" <?php if($productunit->id == $products->unit_type_id){echo 'selected';}else{} ?>><?php echo e($productunit->name); ?></option>
      ...
      <div style="margin-bottom: 2%;border-bottom:1px solid #ddd;" class="">
         <h4>Message</h4>
         <p class="msag-top" stytle="padding-right:10px;"><img src="<?php echo asset('assets/fontend/bdtdc-images/poly-face.png'); ?>" alt="" /> Tips on getting accurate quotes from suppliers. Please include the following in your inquiry : Order quantity; Special requests if any</p>
         ...
         <div class="">
            ...
            <div id="upload" class="">
               <div>
                  ...
                  <input type="file" class="file_up" id="attachment_1" name="attachment_1" style="display:none" value="<?php echo e(Input::old('attachment_1')); ?>" />
               ...
               <div>
                  <a class="btn btn-xs text-success upfile"><i class="fa fa-plus" style="padding-right:5px;font-size:12px; font-weight:normal;"></i>Upload product image</a>
                  <input type="file" class="file_up" id="attachment_2" name="attachment_2" style="display:none" value="<?php echo e(Input::old('attachment_2')); ?>" />
                  <span class="file_name" style="color:#333;font-size:15px;">None</span>
               </div>
               <img style="width:173px;margin:10px;margin-left:24px;" class="attachment_2" src="#" alt="your image" />
               <div>
                  <a class="btn btn-xs text-success upfile"><i class="fa fa-plus" style="padding-right:5px;font-size:12px; font-weight:normal;"></i>Upload product image</a>
                  <input type="file" class="file_up" id="attachment_3" name="attachment_3" style="display:none" value="<?php echo e(Input::old('attachment_3')); ?>" />
                  <span class="file_name" style="color:#333;font-size:15px;">None</span>
               </div>
      ...
      <div class="">
         <p style="padding-top:4%;width:100%;"><label><span><input type="checkbox"></span> Recommend matching suppliers if this supplier doesn’t contact me on Message Center within 24 hours.</label></p>
         <p style="padding-bottom:4%;width:100%;"><label><span><input type="checkbox" value="ag" name="agreementSupplier"></span> I agree to share my Business Card to the supplier.</label></p>
      </div>
      <div class="">
   ...
   <div class="modal fade" id="loginModal" role="dialog">
      <div class="modal-dialog">
         <div class="modal-content" style="box-shadow: 2px 5px 8px rgba(0,0,0,.25);">
            <form role="form" class="login_form" method="POST" action="<?php echo e(URL::route('sessions.store')); ?>">
               ...
               <div class="modal-header" style="padding-top: 5px; padding-bottom: 0;">
                  ...
                  <ul class="nav nav-tabs" style="border-bottom: 0 none; margin-bottom: 1px;">
                     ...
                     <li><a href="<?php echo e(URL::to('join',null)); ?>" target="_blank">Join Buyerseller.asia</a></li>
                  </ul>
