<?php $__env->startSection('page_css'); ?>
  ...
  <div class="row">
  			<div class="col-sm-12 col-md-12 col-lg-12">
		              ...
		              <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('bdtdc_policies_rules')); ?>" class="top-path-li-a"><span itemprop="name">Rules Center</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
		              <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('displaying-prohibited')); ?>" class="top-path-li-a"><span itemprop="name">Enforcement Actions for Displaying Prohibited</span></a></li>
	            ...
	            <div class="col-sm-12 padding_0">
	                ...
	                <div>
	                  ...
	                  <div>
	                  		...
	                  		<ul class="ul-des">
	                  			<li>
	                  				<span class="ul-des-li-span">1.</span>Denied things: all things banned by the laws of Hong Kong and the People's Republic of China, and under worldwide laws, together with any things banned as per BuyerSeller.Asia's strategies.<br>
