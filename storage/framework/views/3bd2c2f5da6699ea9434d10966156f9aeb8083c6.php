...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12" itemscope itemtype="http://schema.org/BreadcrumbList">
                    <ul class="top-path" style="padding-bottom: 8px;">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a  itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a"> <span itemprop="name">Customer Service</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a  itemprop="item" href="<?php echo e(URL::to('ServiceChannel/pages/submit_a_dispute','39')); ?>" class="top-path-li-a"> <span itemprop="name">Submit a Dispute</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a   itemprop="item" href="<?php echo e(URL::to('submit_report',null)); ?>" class="top-path-li-a"> <span itemprop="name">Report</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<div class="row" id="home_b" style="padding-top: 2%;padding-bottom: 2%;">
  <?php if(count($errors) > 0): ?>
        ...
        <?php endif; ?>
            ...
            <?php endif; ?>
      <?php echo Form::open(['route'=>'submit.report.store']); ?>
      ...
      <div class="col-sm-2" style="padding-left:8%;padding-right:0px;">
         <?php echo Form::label('product url :',null,['class'=>'asd']); ?>
      ...
      <div class="col-sm-12">
         ...
         <?php echo Form::label('Upload Evidence :'); ?>
...
<div class="row" id="home_b" style="padding-top: 2%;padding-bottom: 2%;">
            <div class="col-sm-12"> 
                <p style="padding-left:8%;">Your Email :<span> <?php echo e($user->email); ?></span></p>
                 <p style="padding-left:8%;">Your Phone : <span> <?php echo e($user->customers?$user->customers->telephone:''); ?></span></p>
                  <!-- <p style="padding-left:15.5%;font-size:11px;"> 	
                        ...
                        <p ><input type="checkbox" value="Adult Products and Services, Pornographic Images" name="reason" >
                         Upon submitting this complaint, I agree to:<a href="<?php echo e(URL::to('Policies_Rules',null)); ?>">Agreement on Use of Complaint Center</a></p>
