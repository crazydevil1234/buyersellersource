  ...
  <div class="row">
  			<div class="col-sm-12 col-md-12 col-lg-12">
  					<ul class="top-path" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
  						<li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a">Home <i class="fa fa-angle-right top-path-icon"></i></a></li>
  						...
  						<li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="<?php echo e(URL::to('buying-request')); ?>" class="top-path-li-a">Buying Request Posting Rules<i class="fa fa-angle-right top-path-icon"></i></a></li>
  					</ul>
  			</div>
