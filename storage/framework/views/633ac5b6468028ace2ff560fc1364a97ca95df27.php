	...
	<div class="container" style="background:#fff; width:100%;">
					...
					<div class="col-sm-12" style="text-align:left;width: 100%;padding: 15px 0;z-index:20;position: static;left: auto;top: auto;display: block;bottom: auto;">
							<ul>
								<li style="font-size: 13px;color: #425166;">
									<span style="padding-right:5px;"><img style=""   src="<?php echo asset('assets/fontend/images/step-1.png'); ?>" alt="step1" /></span>Submit detailed Buying Request..
								</li>
								<li style="font-size: 13px;color: #425166;">
									<span style="padding-right:5px;"><img  src="<?php echo asset('assets/fontend/images/step-2.png'); ?>" alt="step2" /></span>Check for quotations.......	
								</li>
								<li style="font-size: 13px;color: #425166;">
										 <span style="padding-right:5px;"><img  src="<?php echo asset('assets/fontend/images/step-3.png'); ?>" alt="step3" /></span>Build your deal online.....
								</li>
							</ul>
						</div>
					</div>
			<div class="row">
					<div class="col-xs-12" style="padding-left: 40px;">
              		...
              		<div><button type="submit" class="btn btn-primary join" style="border-radius: 5px !important; padding: 12px 19px;"><a href="<?php echo URL::to('get-quotations'); ?>" style="color:#fff;">Submit Quotation</a></button></div>
              			</div>
					</div>
					<div class="col-xs-12">
						<img style="width: 100%;" class="burer-quet_m img-responsive" src="<?php echo asset('assets/gold/get-queation.jpg'); ?>">
					</div>
			</div> 
			<div class="row">
					<div class="col-xs-12">
						<img style="width: 100%;"  class="burer-quet_m img-responsive" style="float:left;" src="<?php echo asset('assets/gold/dashboad.jpg'); ?>">
					</div>
					<div class="col-xs-12">
			...
			<div class="row">
					...
					<div class="col-xs-12">
						<img style="width: 100%;"  class="burer-quet img-responsive" src="<?php echo asset('assets/gold/get-queation.jpg'); ?>">
					</div>
			</div>
</div>
</section>
