<div class="col-sm-2">
	<div class="side-bdtdc-menu">
			<ul style="padding-left: 0;">
				<li><a itemprop="url"   href="<?php echo e(URL::to('tradeshow',null)); ?>" class="frIco event" target="_blank"><p>Events</p></a></li>
				...
				<li><a itemprop="url"    href="#understand-email" class="frIco sosial-con"><p>Social Media</p></a></li>
	...
	<div class="sideSocial">
		<ul style="padding: 0; display: block; overflow: hidden;">
			...
			<li><a itemprop="url" href="https://g.page/buyer-seller-asia?gm" class="frIco icoSG" target="_blank"></a></li>
