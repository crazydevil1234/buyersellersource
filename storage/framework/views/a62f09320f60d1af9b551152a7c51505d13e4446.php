	...
	<link property='stylesheet' href="<?php echo asset('css/sell-on/bdsource-for-suppliers.css'); ?>" rel="stylesheet">
									...
									<?php if($categorys): ?>					
										...
										<?php if($c->inq_products_category): ?>
							        		<li class="cat-list-product-li" style="color:black;padding-left: 22px;">
							        			...
							        			<a itemprop="url" href="<?php echo e(URL::to('product-sourcing/details', $c->inq_products_category->bdtdcCategory->id)); ?>">
							        			<?php echo e($c->inq_products_category->bdtdcCategory->name); ?>
    ...
    border-bottom-left-radius: 0 !important;" class="btn btn-primary btn-lg pull-left inquiry_search" value="Search">Search</button>				
			...
			<?php $__currentLoopData = $source; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="col-sm-12 source" style="margin-bottom:1%;margin-top:1%; min-height: 145px;background-color: rgb(255, 255, 255) !important;">
				  ...
				  <a itemprop="url" href="<?php echo e(URL::to('product-sourcing/view',$s->id )); ?>">
					<p style="padding-top: 2%;font-size:18px;font-weight:400;color: #1686CC;">
						<?php if($s->bdtdc_product): ?>
							<?php if(isset($s->bdtdc_product->product_name)): ?>
							<?php echo e(substr($s->bdtdc_product->product_name->name,0,60)); ?>

							<?php else: ?>
							<?php endif; ?>
						<?php else: ?>
							<?php echo e(substr($s->inquery_title,0,60)); ?>
					...
					<div class="col-sm-2 col-xs-6 padding_0" style="">
						...
						<img   itemprop="image" style="height: 52px;width: 79px;" src="<?php echo e(URL::to(''.$s->inq_products_images->image,null)); ?>" alt="">

						<?php elseif($s->inq_docs_one): ?>
							<img   itemprop="image" style="height: 52px;width: 79px;" src="<?php echo e(URL::to('buying-request-docs',(isset($s->inq_docs_one->docs))?$s->inq_docs_one->docs:'no-image.jpg',null)); ?>" alt="">
						<?php else: ?>
						<img   itemprop="image" style="height: 52px;width: 79px;" src="<?php echo e(URL::to('uploads/no-image.jpg')); ?>" alt="">
						<?php endif; ?>
					</div>
					...
					<div class="col-sm-4 col-xs-12 padding_0">
							...
							<div style="float:left;">
							<?php if($s->sender_company): ?>
								<?php if($s->sender_company->country): ?>
									<div>
									  <img  itemprop="image" style="height:20px;width:32px; float:left;" src="<?php echo e(asset('assets/global/img/flags/'.strtolower($s->sender_company->country->iso_code_2).'.png')); ?>" 
									   alt="<?php echo e($s->sender_company->country->name ?? 'bangladesh'); ?>">
									    <div style="float:left; padding-left:8%;">
										<?php if($s->bdtdc_product): ?>
											<?php echo e($s->bdtdc_product->brandname ?? ''); ?>
								...
								<p style="color: #999;font: inherit;  padding-top:7%;">
									<?php echo e(date('Y-m-d', strtotime($s->updated_at))); ?>
						...
						<div class="col-sm-3 col-md-3" style="">
					          ...
					          <a target="_blank" href="<?php echo e(URL::to('product-sourcing/view',$s->id )); ?>" class="btn btn-default" style="color:#fff !important;background:rgb(25, 68, 111) none repeat scroll 0% 0%;border:0 none;border-radius:5px !important;">Quote Now</a>
			...
			<?php echo $source->render(); ?>


			<div class="col-sm-12 source" style="margin-top:2%;background-color:#fff !important;">
				<p style="padding-top: 4%;font-size: 27px;color: #999; text-align:center;">How does BuyerSeller work? <a itemprop="url" href="<?php echo e(URL::to('source')); ?>" style="font-size: 15px;">Learn More</a></p>
				<div class="col-sm-12" style="margin-top: 2%;margin-bottom: 2%;text-align: center;">
					<img  itemprop="image" style="" src="<?php echo asset('assets/buyer-security/sourcing_buyer.png'); ?>" alt="sourcing buyer" />
				</div>
			</div>
		</div>							
