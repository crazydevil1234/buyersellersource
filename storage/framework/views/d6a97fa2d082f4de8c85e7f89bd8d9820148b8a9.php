...
<img alt="logo" style="width:100%;height:auto" itemprop="logo" class="loggg" src="<?php echo e(asset('assets/logo.png')); ?>" />
</a>
...
<li><a style="padding-left:0" itemprop="url" href="<?php echo e(URL::to('online-marketplace',null)); ?>">Shop by Category</a></li>
...
<a itemprop="url" title="get quote" href="<?php echo e(URL::to('get-quotations',null)); ?>"><span style=""><img itemprop="image" style="padding-left:7%;padding-right:5px;margin-top:-8px;height:52px" class="img-responsive" src="<?php echo asset('assets/gold/Get-Quotation-dash.png'); ?>" alt="Get Quotation home" /></span></a>
</div>
</div>
</div>
</div>
...
?>
<li class="dropdown" style="z-index:999!important">
<a style="text-align:right;padding-right:16px" itemprop="url" href="#">Welcome back<br><span title=""></span> <?php echo e(Sentinel::getUser()->first_name); ?> <span id="all_notification" style="margin-left:5px"><i data-count="<?php echo e($all_notifications); ?>" class="glyphicon notification-icon"></i></span>
...
<?php endif; ?>
<li title="" class="pusher_notification_1"><a itemprop="url" href="<?php echo e(URL::to('default/message?inq_sub_menu=New Inquiries',null)); ?>">New Inquiry <span style="margin-left:5px"><i data-count="<?php echo e($inquiry_notifications); ?>" class="glyphicon notification-icon"></i></span>
</a>
</li>
<li title="" class="pusher_notification_2"><a itemprop="url" href="<?php echo e(URL::to('Mybuying-Request?status=0&unread=true&search=&d=0',null)); ?>">New Quote <span style="margin-left:5px"><i data-count="<?php echo e($quote_notifications); ?>" class="glyphicon notification-icon"></i></span>
</a>
</li>
