...
<link property='stylesheet' href="<?php echo asset('css/border-protection.css'); ?>" rel="stylesheet">
<link property='stylesheet' href="<?php echo asset('assets/fontend/css/select2.min.css'); ?>" rel="stylesheet">
...
<div class="row">
   <div class="col-sm-12 col-md-12 col-lg-12">
      <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
         ...
         <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('ServiceChannel/pages/for_new_user',38)); ?>" class="top-path-li-a"><span itemprop="name">For Buyers</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<div class="row padding_0" style="background-color: #fff; padding-bottom: 5%; margin-bottom: 20px;">
   ...
   <div class="col-sm-12 col-md-12">
      <div class="trade-buy-box">
         <h3 class="td-hed"><img itemprop="image" style="height:30px;" src="<?php echo asset('assets/gold/Buyer-protect.jpg'); ?>" alt="buyer protect"> Buyer Protection - Get Full Protection for Your Order. <span style="font-size: 13px;padding-left:4%;font-weight: normal;cursor: pointer;"><a href="<?php echo e(URL::to('BuyerChannel/pages/trade_assurance',5)); ?>">Learn More ></a></span> <i class="fa fa-times" aria-hidden="true" id="trade-close" style=" font-size: 24px !important;font-weight: normal;color: #CCC;float: right;display: block; cursor: pointer;line-height: 24px;"></i></h3>
         <ul style="padding:0;">
            ...
            <li class="potection-list">
               ...
               <p style="width: 100%; font-size: 16px; float: left;text-align:left; padding-left: 6%; color: #000;"><img itemprop="image" class="" style="height: 26px; width: 26px; float: left;" src="<?php echo asset('assets/gold/get_protection.png'); ?>" alt="get protection"><span style="padding-left: 10px;">Get full protection</span></p>
            ...
            <li>
               <p style="margin-top: 4%;"><a href="<?php echo e(URL::to('BuyerChannel/pages/trade_assurance',5)); ?>" style="padding-left: 16px; color: #1686CC; padding-left: 5%; padding-top: 10px;">Buyer Protection ></a></p>
            </li>
         </ul>
      </div>
   ...
   <div class="col-sm-12 col-md-12">
      ...
      <div class="member-email-box">
         ...
         <a class="btn btn-default btn-sm" style="margin-top:4%;display:none;" href="<?php echo e(URL::to('order-protect',null)); ?>" id="change_email">Change</a>
      </div>
   </div>
   <div class="col-sm-12 col-md-12">
