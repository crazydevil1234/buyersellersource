...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="<?php echo e(URL::to('BuyerChannel/pages/meet_suppliers',13)); ?>" class="top-path-li-a" itemprop="url">Meet Suppliers<i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<div class="row padding_0" style="margin-bottom: 20px;">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 padding_0" style="background: #fff;">
            ...
            <a itemprop="url" href="<?php echo e(URL::to('apply-sourceing-meeting',null)); ?>"><span class="btn btn-primary" style="padding-top:10px;border-radius: 5px !important; text-align:center;">Apply to meet suppliers</span></a>
        </div>
		</div>
	<div class="col-sm-12 col-md-12 col-lg-12 padding_0" style="background: #fff;">
