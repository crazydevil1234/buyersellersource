	...
	<div class="row padding_0">
		...
		<div class="col-sm-12">
				<img class="img-responsive" src="<?php echo asset('assets/images/WOMAN.png'); ?>" alt="WOMAN">
		</div>
		<diV class="col-sm-12 padding_0" style="padding-top:20px; background-color: #fff; padding-bottom: 3%;">
			<div class="col-sm-2">
				...
				<a href="http://aboutus.bdtdc.com/en/#home"><p style="background:#BBB;font-size:18px;padding-left: 7px;color:#fff!important;font-weight: bold;">About Bdtdc</p></a>
				<a href="http://aboutus.bdtdc.com/en/#home"><p style="background:#BBB;font-size:18px;padding-left: 7px;color:#fff!important;font-weight: bold;margin-top: -8px;">Contact Us</p></a>
			</div>
			<div class="col-sm-7">
