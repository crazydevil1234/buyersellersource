           ...
           <?php $__currentLoopData = $product_categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <ul    class="pull-left bazar-list" itemscope itemtype="http://data-vocabulary.org/Product">
                <li class="" data-id="market-<?php echo $category['parent_id']; ?>">
                    <a href="#" rel="category" itemprop="url">
                        <span itemprop="name" style="color:#666;display: inline-block;padding: 0px 15px 0px 0;text-align: right; font-size:12px;"> <?php echo e($category->pro_parent_cat->name); ?></span>  </a>
            ...
            <div style="padding-top:0px" class="col-lg-offset-12 col-md-offset-12 col-sm-offset-12 cacostos util-clearfix" id="market-<?php echo $category['parent_id']; ?>">
                <ul class="cacostos-list" itemscope itemtype="http://data-vocabulary.org/Product">
                   ...
                   <span itemprop="name" style="color:#666;font-weight:700;line-height:20px;margin-bottom:10px"> <?php echo e($category->pro_parent_cat->name); ?> </span>
                        <div style="margin-top:10px" class="ditio-cacostos">
                            ...
                            <?php $__currentLoopData = $category->pro_parent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <?php if($cat->column==1): ?>
	                              <a itemprop="url" href="<?php echo e(URL::to('wholesale/category/product',$cat['id'])); ?>">
	                                   <span itemprop="name" style="color:#666;"><?php echo e($cat->name); ?></span>
	                              </a>
                              <?php endif; ?>
                 ...
                 <ul class="cacostos-list" style="margin-top:30px">
                    <li>
                        ...
                        <div class="ditio-cacostos" itemscope itemtype="http://data-vocabulary.org/Product">
                             ...
                             <?php $__currentLoopData = $category->pro_parent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($cat->column==2): ?>
                              <a rel="category" itemprop="url" href="<?php echo e(URL::to('wholesale/category/product',$cat['id'])); ?>">
                                  <span itemprop="name" style="color:#666;"><?php echo e($cat->name); ?></span>
                              </a>
                              <?php endif; ?>
            ...
            <div class="pull-left" style="padding-left: 1.3%;;padding-right: 8%;padding-top: 6%;font-weight: 600; width: 99%;margin: 1px;height: 30px;">
                    ...
                    <a href="<?php echo e(URL::to('online-marketplace',null)); ?>">
  ...
  <div class="col-xs-12 col-sm-9 padding_0 wholesale-slider" style="padding-top: 1px;">
			...
			<section id="slider"><!--slider-->
						...
						<div class="carousel-inner" itemscope itemtype="http://schema.org/ImageObject">
							...
							<div class="item active">
								...
								<div class="col-sm-12 padding_0" style="margin-left:0px;">
									<img  itemprop="contentUrl"  style="height:320px;width: 100%; overflow: hidden;" src="<?php echo e(asset('assets/gold/automotive-electronics.jpg')); ?>" class="girl img-responsive" alt="automotive electronics" />
								</div>
							...
							<div class="item">
								...
								<div class="col-sm-12 padding_0" style="margin-left:0px;">
									<img itemprop="contentUrl"  style="height:320px;width: 100%; overflow: hidden;" src="<?php echo e(asset('assets/gold/jewelry-watches.jpg')); ?>" class="girl img-responsive" alt="jewelry watches" />
              ...
              <div class="item">
                ...
                <div class="col-sm-12 padding_0" style="margin-left:0px;">
                  <img itemprop="contentUrl"  style="height:320px;width: 100%; overflow: hidden;" src="<?php echo e(asset('assets/gold/product-exibit.jpg')); ?>" class="girl img-responsive" alt="jewelry watches" />
							...
							<div class="item">
								...
								<div class="col-sm-12 padding_0" style="margin-left:0px;">
									<img  style="height:320px;width: 100%; overflow: hidden;" src="<?php echo e(asset('assets/gold/lighting-products.jpg')); ?>" class="girl img-responsive" alt="lighting products" />
							...
							<div class="item">
								...
								<div class="col-sm-12 padding_0" style="margin-left:0px;">
									<img  style="height:320px;width: 100%; overflow: hidden;" src="<?php echo e(asset('assets/gold/warehousing-services.jpg')); ?>" class="girl img-responsive" alt="warehousing services" />
