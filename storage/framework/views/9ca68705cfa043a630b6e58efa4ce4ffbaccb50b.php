...
<form action="<?php echo e(URL::to('postBuyRequest',null)); ?>" class="form-horizontal"  enctype="multipart/form-data" method="post">
<div class="col-xs-12">
  ...
  <div class="col-xs-12" style="margin-top: 25px;">
    <div class="form-group">
      ...
      <div>
        <input type="text" class="form-control" id="product-name" name="product_name" value="<?php echo e($Inquiry_name); ?>" required="required">
      </div>
    </div>
  </div>
<div class="col-xs-12" style="margin-top: 25px;">
    <div class="form-group">
      ...
      <label class="control-label col-xs-4 padding_0" for="pwd">Quantity</label>
        ...
        <div class="col-xs-4">          
        <input name="quantity" data-ng-model="yourName" value="<?php echo e($quotations->quantity); ?>" style="width:80%;" required="required" style="text-align: center; height: 35px !important;">
      </div> 
      <div class="col-xs-4" style="padding-right: 15px;">          
       <select name="unit" style="background: #fff; border:1px solid #ddd;text-align: center; height: 35px;">
            <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($unit->id); ?>" <?php if($quotations->unit_id == $unit->id){echo 'selected';} ?>>
  ...
  <div class="col-xs-12" style="margin-top: 25px;">
      <div class="form-group">
         <div class="" style="padding: 15px 0px;">
            <img style="max-width: 136px; max-height: 136px;"   src="<?php echo e($inquiry_image); ?>" alt=""/>
        </div>
        <div class="">
        ...
        <div class="">
         <p style="float: left; font-size:14px; font-weight:normal; padding-top:10px; clear: both;"><input type="checkbox" checked required> I agree to share my <span style="color: #23527C;">Business Card</span> with quoted suppliers.</p>
          <div class="ppp-des" style="font-size:14px; font-weight:600;margin-left: 0;padding-left: 0;">
            <span style="color: #1DC11D;line-height:18px;padding-left:0;"><?php echo e(count($suppliers)); ?></span> Suppliers can give quotations</div>
