<?php $__env->startSection('page_css'); ?>
	...
	<div class="row" style="padding-bottom: 8px">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('ServiceChannel/pages/for_buyer',35)); ?>" class="top-path-li-a"> <span itemprop="name" style="color: #333;">Help Center</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('SupplierChannel/pages/learning_center', 33)); ?>" class="top-path-li-a"> <span itemprop="name" style="color: #333;">Learning Center </span><i class="fa fa-angle-right top-path-icon"></i></a></li>
	...
	<h1 style="padding-left: 15px; text-align:center;">How can I join BuyerSeller.Asia
</h1>
		<div class="col-sm-12 col-md-12 col-lg" style="padding: 15px;">
		    ...
		    <div class="col-sm-8 col-md-8 padding_0">
						...
						<img class="user-join-learn img-responsive" src="<?php echo asset('assets/fontend/images/join-user.jpg'); ?>">
			</div>
			<div class="col-sm-4 col-md-4 padding_0">
                   ...
                   <div class="col-sm-12 col-md-12 padding_0">
                      <div class="col-sm-4 padding_0">
				         ...
				         <div class="col-sm-8">
				            <p class="p-learn" style="text-align:left;"><a itemprop="url"  href="<?php echo e(URL::to('how-to-join-bdtdc')); ?>" target="_blank">How to join BuyerSeller</a><br></p>
		...
		<div class="col-sm-12 col-md-12 col-lg" style="padding: 15px;background: #eaeaea;">
		  <div class="col-sm-8 col-md-8 padding_0">
						<img class="user-join-learn img-responsive" src="<?php echo asset('assets/fontend/images/join-required.jpg'); ?>">
					</div>
			<div class="col-sm-4 col-md-4">
						<div class="guide-cont">
							...
							<div class="col-sm-12 col-md-12 padding_0">
				         	...
				         	<div class="col-sm-8">
				            	<p class="p-learn" style="text-align:left;"><a itemprop="url"  href="<?php echo e(URL::to('buying-request')); ?>">Selling Opportunities with Buying Requests </a><br></p>
		...
		<div class="col-sm-12 col-md-12 col-lg" style="padding: 15px;">
		  <div class="col-sm-8 col-md-8 padding_0">
						<img class="user-join-learn img-responsive" src="<?php echo asset('assets/fontend/images/join-get-message.jpg'); ?>">
					</div>
			<div class="col-sm-4 col-md-4">
						<div class="guide-cont">
		...
		<div class="col-sm-12 col-md-12 col-lg" style="padding: 15px;background: #eaeaea;">
		  <div class="col-sm-8 col-md-8 padding_0">
						<img class="user-join-learn img-responsive" src="<?php echo asset('assets/fontend/images/join-user-security.jpg'); ?>">
					</div>
			<div class="col-sm-4 col-md-4">
						<div class="guide-cont">
                      ...
                      <div class="col-sm-4 padding_0">
				         ...
				         <div class="col-sm-8">
				             <p class="p-learn" style="text-align:left;"><a itemprop="url"  href="<?php echo e(URL::to('Quality/posting-for-grab')); ?>" target="_blank">High Quality Posting</a><br></p>
          					 <p class="cont-right-learn">Product information quality is one of the factors influencing product ranking. Making high quality products can help you get more exposure from potential buyers.</p>
            <h4 class="p-video-second"><a itemprop="url"  href="#">video | Text>></a></h4>
					</div>
                   </div>
		...
		<div class="col-sm-12 col-md-12 col-lg" style="padding: 15px;">
		  <div class="col-sm-8 col-md-8 padding_0">
						<img class="user-join-learn img-responsive" src="<?php echo asset('assets/fontend/images/join-user-company-info.jpg'); ?>">
					</div>
			<div class="col-sm-4 col-md-4">
						<div class="guide-cont">
                      ...
                      <div class="col-sm-4 padding_0">
		                    <div class="learn-image">
		                   <img itemprop="image" src="<?php echo asset('assets/fontend/images/how-to-buy-product-bdtdc.jpg'); ?>" alt="">
		                    </div>
		                </div>
				         <div class="col-sm-8">
				             <p class="p-learn"><a itemprop="url"  href="<?php echo e(URL::to('how-to-buy-from-bdtdc')); ?>" target="_blank">How to buy product from BuyerSeller <img itemprop="image" src="<?php echo asset('assets/fontend/bdtdc-images/l-new.gif'); ?>" alt=""></a><br>
		...
		<div class="col-sm-12 col-md-12 col-lg" style="padding: 15px;background: #eaeaea;">
		  <div class="col-sm-8 col-md-8 padding_0">
						<img class="user-join-learn img-responsive" src="<?php echo asset('assets/fontend/images/join-user-success.jpg'); ?>">
					</div>
			<div class="col-sm-4 col-md-4">
						<div class="guide-cont">
                      ...
                      <div class="col-sm-4 padding_0">
				         ...
				         <div class="col-sm-8">
				            <p class="p-learn" style="text-align:left;"><a itemprop="url"  href="<?php echo e(URL::to('Buyer/Training')); ?>" target="_blank">Understanding the Buyers </a></p>
