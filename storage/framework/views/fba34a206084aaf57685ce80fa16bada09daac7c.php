...
<div class="container">
  <div class="row">
	...
	<div class="italic" style="font-style: italic;margin-left:30px;padding-right:30px; display: block;">The email address stated above is applicable to complaints and questions regarding ethical issues connected to BuyerSeller team members. Any enquiries or concerns associated with our services and general business operation should be sent to the right communication channel of the appropriate business unit for instance and quick response. For the relevant contact information of our businesses and affiliated entities, kindly refer to the <a itemprop="url" href="<?php echo e(URL::to('FooterPage/pages/Contact_Us/20')); ?>">Customer Service Contacts</a> page.</div>
</div>
<?php $__env->stopSection(); ?>
