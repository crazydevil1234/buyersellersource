    <?php $__env->startSection('page_css'); ?>
      <link property='stylesheet' href="<?php echo asset('css/for-suppliers/marketing-website.css'); ?>" rel="stylesheet">
  ...
  <div class="row" style="margin-bottom: 8px">
      ...
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a" ><span itemprop="name">Home</span> <i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('ServiceChannel/pages/for_buyer',35)); ?>" class="top-path-li-a"><span itemprop="name">Help Center</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
      <li class="top-path-li" itemprop="itemListElement" itemscope
	...
	<div class="row " style="background:#ffffff; margin-bottom:28px;border-bottom: 1px solid rgba(0,0,0,.1);padding-bottom:5%;">
            <div class="col-sm-12 padding_0" style="/*background:#91431E;*/">
                     <img itemprop="image" style="width:100%; max-height:400px;" src="<?php echo asset('assets/fontend/images/marketing-site.jpg'); ?>" alt="marketing banner" />
            </div>
                               ...
                               <h3 class="market-title-h1" >Supplier Services</h3>
                                  <ul class="market-ul">
                                      <li class="market-ul-li">
                                           <a itemprop="url" href="<?php echo e(URL::to('SupplierChannel/pages/list_exhibit_sell',23)); ?>">List, Exhibit and sell</a>
                                      </li>
                                      <li class="market-ul-li">
                                          <a itemprop="url" href="<?php echo e(URL::to('SupplierChannel/pages/marketing_website',24)); ?>">Marketing Website</a>
                                      </li>
                                      <li class="market-ul-li">
                                          <a itemprop="url" href="<?php echo e(URL::to('SupplierChannel/pages/suppliers_memebership',30)); ?>">Suppliers Membership</a>
                                      </li>
                                      <li class="market-ul-li">
                                          <a itemprop="url" href="<?php echo e(URL::to('SupplierChannel/pages/verified_supplier',32)); ?>">Verified Supplier</a>
                                      </li>
                                      <li class="market-ul-li">
                                          <a itemprop="url" href="<?php echo e(URL::to('SupplierChannel/pages/learning_center',33)); ?>">Learning Center</a>
                                      </li>
                                      <li class="market-ul-li">
                                          <a itemprop="url" href="<?php echo e(URL::to('SupplierChannel/pages/training_center',34)); ?>">Training Center</a>
                                      </li>
                                  </ul>     
                            </div>
                            <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <ul class="market-ul">
                                               <li class="market-ul-li">
                                                     <a itemprop="url" href="<?php echo e(URL::to('BuyerChannel/pages/why_bdtdc',6)); ?>">Why BuyerSeller</a>
                                                </li>
                                                <li class="market-ul-li">
                                                    <a itemprop="url" href="<?php echo e(URL::to('BuyerChannel/pages/sustainable_manufacturing',7)); ?>">Sustainable Manufacturing</a>
                                                </li>
                                                <li class="market-ul-li">
                                                    <a itemprop="url" href="<?php echo e(URL::to('BuyerChannel/pages/meet_suppliers',13)); ?>"> Meet Suppliers</a>
                                                </li>
                                               
                                                <li class="market-ul-li">
                                                    <a itemprop="url" href="<?php echo e(URL::to('BuyerChannel/pages/accredited_suppliers',16)); ?>">Accredited Suppliers</a>
                                                </li>
                                                <li class="market-ul-li">
                                                    <a itemprop="url" href="<?php echo e(URL::to('BuyerChannel/pages/business_identity',17)); ?>">Business Identity</a>
                                                </li>
                                             </ul>
                                 </div>
                                  <div class="col-sm-6">
                                       <ul class="market-ul">
                                                  ...
                                                  <li class="market-ul-li">
                                                      <a itemprop="url" href="<?php echo e(URL::to('BuyerChannel/pages/inspection_service',19)); ?>">Inspection Service</a>
                                                  </li>
                                                
                                                  <li class="market-ul-li">
                                                      <a itemprop="url" href="<?php echo e(URL::to('BuyerChannel/pages/trade_answers',22)); ?>">Trade Answers</a>
                                                   </li>
                                          </ul>
                                  </div>
                        </div>
            ...
            <div class="col-sm-12" style="margin-top:28px;">
                    ...
                    <div class="col-sm-4">            
                       <div class="row">
                                  <div class="col-sm-12" style="margin-bottom:6%;">
                                          <div class="row">
                                              <div class="col-sm-4">
                                                <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/images/marketing-2.jpg'); ?>" alt="marketing banner" />
                                            </div>
                                            <div class="col-sm-8">
                                  ...
                                  <div class="col-sm-12" style="margin-bottom:6%;">
                                        <div class="row">
                                          <div class="col-sm-4">
                                                <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/images/marketing-3.jpg'); ?>" alt="marketing banner" />
                                            </div>
                                            <div class="col-sm-8">
                                  ...
                                  <div class="col-sm-12" style="margin-bottom:6%;">
                                          <div class="row">
                                              <div class="col-sm-4">
                                                <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/images/marketing-6.jpg'); ?>" alt="marketing banner" />
                                            </div>
                                            <div class="col-sm-8">
                                  ...
                                  <div class="col-sm-12" style="margin-bottom:6%;">
                                          <div class="row">
                                              <div class="col-sm-4">
                                                <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/images/marketing-4.jpg'); ?>" alt="marketing banner" />
                                            </div>
                                  ...
                                  <div class="col-sm-12" style="margin-bottom:6%;">
                                         <div class="row">
                                            <div class="col-sm-4">
                                                <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/images/marketing-5.jpg'); ?>" alt="marketing banner" />
                                            </div>
                                            <div class="col-sm-8">
                    ...
                    <div class="col-sm-3">
                        <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/img/marketing-team.jpg'); ?>" alt="marketing banner" />
                        <p class="market-p" style="font-size: 12px; padding-left: 5%;">We'd like to hear from you.</p>
                      
                    
                        <div class="right1" style="margin-top: 15px;">
                         <p class="cont-tit" style="padding: 0 12px; line-height: 20px;"><a href="<?php echo e(URL::to('selected-suppliers/Bangladesh',18)); ?>"> Bangladesh suppliers</a></p>
                        <p class="cont-tit" style="padding: 0 12px; line-height: 20px;">
                        <a href="<?php echo e(URL::to('selected-suppliers/China',44)); ?>"> China suppliers</a></p>
                        <p class="cont-tit" style="padding: 0 12px; line-height: 20px;"><a href="<?php echo e(URL::to('selected-suppliers/Taiwan',206)); ?>"> Taiwan suppliers</a></p>
                        <p class="cont-tit" style="padding: 0 12px; line-height: 20px;"><a href="<?php echo e(URL::to('selected-suppliers/India',99)); ?>"> India </a></p>
                        <p class="cont-tit" style="padding: 0 12px; line-height: 20px;"><a href="<?php echo e(URL::to('selected-suppliers/South Korea',113)); ?>"> South Korea</a></p>
                        <p class="cont-tit" style="padding: 0 12px; line-height: 20px;"><a href="<?php echo e(URL::to('selected-suppliers/Japan',107)); ?>"> Japan </a></p>
                        <p class="cont-tit" style="padding: 0 12px; line-height: 20px;"><a href="<?php echo e(URL::to('selected-suppliers/Thailand',209)); ?>"> Thailand </a></p>
                        <ul class="contact-ul">
