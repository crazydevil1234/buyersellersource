...
<div class="row" style="margin-top:2%;">
		        	...
		        	<ul class="nav nav-tabs">
				  	...
				  	<div class="tab-content">
					    ...
					    <div id="trade" class="tab-pane fade in active">
					    	<?php echo Form::open(['route'=>'trade.answers']); ?>
	...
	<div class="col-sm-12"  style="margin-top:2%;">
		<div class="col-sm-1">
						<?php if($trade->user): ?>
                             <img itemprop="image" style="width:100%;padding-top:5%" src="<?php echo e(asset('uploads/'.$trade->user->profile_picture)); ?>" alt="" />
                                <?php else: ?>
                                <img itemprop="image" style="width:100%;padding-top:5%" src="<?php echo asset('assets/default-avatar.png'); ?>" alt="" />
                             <?php endif; ?>
		...
		<div class="col-sm-2" style="margin-top:4px ;">
				...
				<?php if($trade->user): ?>
				<h5><strong> <?php echo e($trade->user->first_name); ?> <?php echo e($trade->user->last_name); ?></strong></h5>
				<p>asked <span style="color: #999;"><?php 
                                                               
                                                                $DeferenceInDays = Carbon::parse($trade->created_at)->diffForHumans(Carbon::now());
                                                                ?> 
                                                                <?php echo e($DeferenceInDays); ?></span></p>
    ...
    z-index: 10;width: 100%">View 
	    	...
	    	<?php endif; ?>
				Answer(s) below
					...
					<?php if($trade1): ?>
						<?php $__currentLoopData = $trade1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="col-md-12 ">
						<div class="col-md-1">
						<?php if($data->user): ?>
                             <img itemprop="image" style="width:100%;padding-top:5%" src="<?php echo e(asset('uploads/'.$data->user->profile_picture)); ?>" alt="" />
                                <?php else: ?>
                                <img itemprop="image" style="width:100%;padding-top:5%" src="<?php echo asset('assets/default-avatar.png'); ?>" alt="" />
                             <?php endif; ?>

						</div>
					<div class="col-md-3" > <h5><strong><?php echo e($data->user->first_name ?? ''); ?></strong> </h5> <span style="color: #999;"><?php 
                                                               
                                                                $DeferenceInDays = Carbon::parse($data->created_at)->diffForHumans(Carbon::now());
                                                                ?> 
                                                                <?php echo e($DeferenceInDays); ?></span>
                    </div>
                </div>
				...
				<div class="col-sm-12" style="margin-left: -3%;margin-top:2%;">
					<?php if(Session::has('msg_succ')): ?>
                        <div id="successMessage" class="alert alert-success text-center">
                            ...
                            <p><?php echo e(Session::get('msg_succ')); ?></p>
                        </div>
                    <?php endif; ?>
				
				</div>

				<?php echo Form::open(['route'=>'trade.answers.success']); ?>
				...
				<div class="col-sm-12" style="margin-top:2%;margin-left: -1%;background-color: #EDF4F9;">  
					...
					<div class="col-sm-10" style="margin-left: -6%;margin-top: 3%;margin-bottom: 2%;width: 89%;">
						<h4><strong> Add a public comment</strong> </h4>
					 	...
					 	<input type="hidden" name="question_id" value="<?php echo e($trade->id ?? ''); ?>">
		...
		<div class="col-sm-3">
			...
			<div class="col-sm-12" style="margin-top:2%;">
				<img style="height:129px;width:100;" src="<?php echo asset('assets/trade_answers.jpg'); ?>" alt="" />
			</div>
		</div>
	</div>
