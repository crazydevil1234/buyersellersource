    ...
    <link property='stylesheet' href="<?php echo asset('css/for-buyers/verified-suppliers.css'); ?>" rel="stylesheet">
...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;">
                        ...
                        <li class="top-path-li"><a href="<?php echo e(URL::to('FooterPage/pages/Help_Center',19)); ?>" class="top-path-li-a">Help Center<i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li"><a href="<?php echo e(URL::to('security-list',null)); ?>" class="top-path-li-a">Safety & Security<i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li"><a href="<?php echo e(URL::to('BuyerChannel/pages/accredited_suppliers',16)); ?>" class="top-path-li-a">Verification Services<i class="fa fa-angle-right top-path-icon"></i></a></li>
                    </ul>
            </div>
  ...
  <div class="row padding_0" style="background-color:#fff!important;margin-bottom:25px;">
    <div class="col-sm-12">
        ...
        <ul class="nav nav-pills nav-stacked" style=" margin-top: 35px;">
          ...
          <li><a href="<?php echo e(URL::to('FooterPage/pages/Secure_Payment',37)); ?>" style="color: #747474;font-size: 14px; padding: 5px 15px;">More Payment Methods</a></li>

          <li style="font-size: 16px;font-weight: bold;height: 20px;margin: 7px 0;">Quality Assurance</li>

          <li><a href="<?php echo e(URL::to('BuyerChannel/pages/inspection_service',19)); ?>" style="color: #747474;font-size: 14px; padding: 5px 15px;">Inspection service</a></li>

          <li style="font-size: 16px;font-weight: bold;height: 20px;margin: 7px 0;">Fraud & Dispute</li>

          <li><a href="<?php echo e(URL::to('ServiceChannel/pages/submit_a_dispute',39)); ?>" style="color: #747474;font-size: 14px; padding: 5px 15px;">Fraud & Dispute Rules</a></li>
        </ul>
            ...
            <div class="col-sm-12 padding_0" style="margin-top:15%;">
                ...
                <p><a href="<?php echo e(URL::to('FooterPage/pages/Secure_Payment',37)); ?>" style="color: #747474;font-size: 14px;">More Payment Methods</a></p>
            </div>
            <div class="col-sm-12 padding_0" style="margin-top:15%;">
                <p style="font-size: 18px;font-weight: bold;height: 20px;margin-bottom: 14%;">Quality Assurance</p>
                <p><a href="<?php echo e(URL::to('FooterPage/pages/Inspection_Service',39)); ?>" style="color: #747474;font-size: 14px;">Inspection service</a></p>
            </div>
            <div class="col-sm-12 padding_0" style="margin-top:15%;">
                <p style="font-size: 18px;font-weight: bold;height: 20px;margin-bottom: 14%;">Fraud & Dispute</p>
                <p><a href="<?php echo e(URL::to('ServiceChannel/pages/submit_a_dispute',39)); ?>" style="color: #747474;font-size: 14px;">Fraud & Dispute Rules</a></p> 
            </div> -->
        </div>
        <div class="col-sm-9">
...
recorded that is available to be sold by merchants.
            ...
            <div class="col-sm-12" style="border: 1px solid #e6e6e6;">
                <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 20px;padding-top:20px;">
                    <img style="height:45px;width:7%;" src="<?php echo asset('assets/gold/A&V-Check.png'); ?>" alt="Check" />
                    A&V Check
                </p>
...
Checked.
            ...
            <div class="col-sm-12" style="border: 1px solid #e6e6e6;border-top:none;">
                <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 20px;padding-top:20px;">
                    <img style="    height: 45px;width: 7%;" src="<?php echo asset('assets/helpcenter/Hand-Shake-Icon.png'); ?>" alt="Onsite Check" />
                    Onsite Check
                </p>
                <p style="font: inherit;color: #666666;font-size: 12px;line-height: 18px;margin-bottom: 0;padding top:30px;padding-left:20px;padding-bottom:20px;line-height:25px;">
...
lawful status and other associated data are then affirmed by a third-party verification agency.  
            ...
            <div class="col-sm-12" style="border: 1px solid #e6e6e6;border-top:none;margin-bottom:5%;">
                <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 20px;padding-top:20px;">
                    <img style=" height: 42px;width: 6%;" src="<?php echo asset('assets/gold/assecedv.jpg'); ?>" alt="Assessed Supplier" />
                   Assessed Supplier
                </p>
                <p style="font: inherit;color: #666666;font-size: 12px;line-height: 18px;margin-bottom: 0;padding top:30px;padding-left:20px;padding-bottom:20px;line-height:25px;">
                ...
                <table class="table table-bordered" style="padding-left:40px;">
                                  ...
                                  <tr>
                                    <td class="col-md-4" style="border:1px solid rgba(0,0,0,.1)!important;padding-bottom:9px;padding-left:0px;">
                                        <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 9%;padding-top:20px;">
                                            <img style="    height: 42px;width: 20%;" src="<?php echo asset('assets/gold/A&V-Check.png'); ?>" alt="A&V Check" />
                                            A&V Check
                                        </p>
                                    </td>
                                  ...
                                  <tr>
                                    <td class="col-md-4" style="border:1px solid rgba(0,0,0,.1)!important;padding-bottom:25px;padding-left:1%;">
                                       <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 20px;padding-top:20px;">
                                            <img style="height: 45px;width: 20%;" src="<?php echo asset('assets/helpcenter/Hand-Shake-Icon.png'); ?>" alt="" />
                                            Onsite Check
                                       </p>
                                                </td>
                                   ...
                                   <tr>
                                    <td class="col-md-4" style="border:1px solid rgba(0,0,0,.1)!important;padding-bottom:25px;padding-left:1%;">
                                        <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 20px;padding-top:20px;">
                                            <img style="height: 42px;width:17%;" src="<?php echo asset('assets/gold/assecedv.jpg'); ?>" alt="Onsite Check" />
                                            Assessed Supplier
                                        </p>
                                    </td>
                                    <td class="col-md-4" style="border:1px solid rgba(0,0,0,.1)!important;padding-bottom:21px;padding-left:21px;">
...
<div class="row ">
      ...
      <div class="col-md-12 button_padding text-center">
        <a itemprop="url" href="<?php echo e(URL::to('SupplierChannel/pages/suppliers_memebership','23')); ?>" class="btn btn-primary center-block btn-join">Verify</a>
      </div>
                                  ...
                                  <tr>
                                      ...
                                      <th class="col-sm-2" style=" height:10%;border:1px solid rgba(0,0,0,.1)!important;padding-bottom:9px;padding-left:0px;">
                                          <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 27%;padding-top:20px;">
                                            <img style="height: 35px;width: 35%;" src="<?php echo asset('assets/gold/A&V-Check.png'); ?>" alt="A&V Check" />
                                            A&V Check
                                          </p>
                                      </th>
                                      <th class="col-sm-2" style=" height:10%;border:1px solid rgba(0,0,0,.1)!important;padding-bottom:9px;padding-left:0px;">
                                          <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 22%;padding-top:20px;">
                                            <img style="height: 35px;width: 35%;" src="<?php echo asset('assets/helpcenter/Hand-Shake-Icon.png'); ?>" alt="Onsite Check" />
                                            Onsite Check
                                          </p>
                                      </th>
                                      <th class="col-sm-3" style=" height:10%;border:1px solid rgba(0,0,0,.1)!important;padding-bottom:9px;padding-left:0px;">
                                          <p style="font-size: 18px;line-height: 18px;position: relative;padding-left: 22%;padding-top:20px;">
                                            <img style="height: 32px;width: 25%;" src="<?php echo asset('assets/gold/assecedv.jpg'); ?>" alt="Assessed Supplier" />
                                            Assessed Supplier
                                          </p>
                                      </th>
                                  </tr>
