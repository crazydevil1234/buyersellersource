		 ...
		 <div  id="signbdtdc1" class="tab-pane fade in active">
			<div class="col-xs-12">
				<div style="padding: 60px 0;width: 100%;overflow: hidden;background: #fff; height: 500px;">
					<?php echo Form::open(['route' => 'ServiceLoginPost']); ?>
					...
					<input type="hidden" name="continue" value="<?php echo e($return_url); ?>">
					    ...
					    <button type="submit" class="btn btn  btn-lg btn-default" style="width: 100%; margin-top: 30px;background: #FF6A00;"><span style="color: #fff; font-size: 14px;"><a itemprop="url" href="<?php echo e(URL::to('forgot_password',null)); ?>" id="forget-password" style="color:#fff !important;">FORGOT PASSWORD ?</a></span></button>
				   <?php echo Form::close(); ?>
...
<div id="join-bdtdc1" class="tab-pane fade"> 
	<div class="col-xs-12">
        <div style="padding: 60px 0;width: 100%;background: #fff;">
            ...
            <form action="<?php echo e(URL::to('mobile-registration/store',null)); ?>" method="post" class="form-horizontal form-row-seperated user_registration_form">
              ...
              <div class="form-group" style="position: relative;">
                ...
                <select class="select_count_m" name="country" style="position: absolute;top: 10px;right: 30px">
                  ...
                  <option value="<?php echo e($data->id); ?>" name="country" style="text-align: left; margin-right: 20px;"><?php echo e($data->name); ?></option>
              ...
              <div class="form-group" style="position: relative;">
               ...
               <div class="form-group" style="position: relative;">
                ...
                <div class="form-group" style="position: relative;">
                    ...
                    <a href="<?php echo URL::to('ServiceLogin'); ?>" class="btn btn-primary login_link_btn" style="    font-size: 10px;padding-left: 1%;height: 23px; padding-top: 1%;width: 31%;">Click here to login</a>
                    </div>
