...
<!-- <div id="item_sha" class="row">
      <p style="padding-left:10px;">  Since February 2nd, for any complaints occurred on Bdtdcexpress please <a itemprop="url"  href="<?php echo e(URL::to('submit_report')); ?>"> click here</a>  to submit. 
      </p>      
</div> -->
<br>
<div id="item_sha" class="row" style="padding:20px 0;">
        ...
        <div id="footer-shadow" class="col-md-4">
              ...
              <br>
              <a itemprop="url"  href="<?php echo e(URL::to('submit_report',null)); ?>" class="btn btn-primary" style="border-radius: 4px !important;">Report</a>
