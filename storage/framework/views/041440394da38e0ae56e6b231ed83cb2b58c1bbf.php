...
<div class="row" style="padding-bottom: 13px">
            ...
            <ul class="top-path" itemscope itemtype="http://schema.org/BreadcrumbList">
              ...
              <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('SupplierChannel/pages/training_center',34)); ?>" class="top-path-li-a"><span itemprop="name">Training Center</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
              <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('online/Buy_selleing')); ?>" class="top-path-li-a"><span itemprop="name">Why Buy and sell Online</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
					...
					<div class="col-sm-3 col-md-3 col-lg-3">
								<ul class="col-sm-12" style="padding-left:15px; padding-top: 25px;">
					                <li class="policy-list" style="">
					                  <a  itemprop="url" href="<?php echo e(URL::to('Buyer/Training')); ?>" class="policy-list-a">Understand International Buyers</a>
					                </li>
					                <li class="policy-list" style="">
					                  <a  itemprop="url" href="<?php echo e(URL::to('online/Buy_selleing')); ?>" target="_blank" class="policy-list-a">Why Buy & Sell Online</a>
					                </li>
					                <li class="policy-list"  style="">
					                  <a itemprop="url" href="<?php echo e(URL::to('supplemental/service')); ?>" target="_blank" class="policy-list-a">
					                  Setting Company Profile</a>
					                </li>
					                 <li class="policy-list"  style="">
					                  <a  itemprop="url" href="<?php echo e(URL::to('buying-request')); ?>" target="_blank" class="policy-list-a">
