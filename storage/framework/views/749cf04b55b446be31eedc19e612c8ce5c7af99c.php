    ...
    <link property='stylesheet' href="<?php echo asset('css/about-us/entrepreneur-day.css'); ?>" rel="stylesheet">
    <link property='stylesheet' href="<?php echo asset('css/about-us/about-page.css'); ?>" rel="stylesheet">
		...
		<div class="row">
			<div id="footer-shadow" class="col-md-6">
					...
					<div class="col-md-12" style="text-align: center;">
						...
						<div class="col-md-7" style=" padding-right: 0px"><img itemprop="image" class="img-responsive" src="<?php echo asset('assets/fontend/bdtdc-images/kazi_ahamed.jpg'); ?>" alt="Kazi Ahamed" />
							</div>
...
<p style="font-size: 16px;font-weight: 600;">center for<br> entrepreneurial<br> leadership</p>
			...
			<div class="col-md-6">
			<img itemprop="image" style="border-radius: 2% !important;margin-left: 15%; margin-top: 10%; padding-bottom:10px; text-align: center;" class="img-responsive img-circle" src="<?php echo asset('assets/fontend/img/kazi.jpg'); ?>" alt="Kazi Ahamed" />
			</div>
		</div>
</div>
