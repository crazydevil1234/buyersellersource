   ...
   <div class="row">
      ...
      <div  style="height:
         ...
         <div class="col-md-1" style="padding-left: 1%; padding-top: 3.5%;">
            <?php if(empty($template_setting_data)): ?>
               <img class="header_logo_img img-responsive col-md-4 pull-right" style="height:55px;width:80px;margin-top:20px;" src=""/>
            <?php else: ?>
               <?php if($header_logo_title_id == 1 || $header_logo_title_id == 3): ?>
                  <img class="header_logo_img" style="height:55px;width:80px;margin-top:20px;" src="" class="img-responsive  col-md-4 pull-right" />
               <?php else: ?>
                  ''
               <?php endif; ?>
            <?php endif; ?>
