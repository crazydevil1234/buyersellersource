...
<div class="row">
   <div class="col-sm-12 col-md-12 col-lg-12">
      <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
         ...
         <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('BuyerChannel/pages/meet_suppliers',13)); ?>" class="top-path-li-a"><span itemprop="name">Meet Suppliers</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<div class="row padding_0" style="margin-bottom: 20px;padding-bottom: 5%; background-color: #fff;">
   <div class="col-sm-12 col-md-12 col-lg-12 padding_0" style="padding-top: 10px">
      <!--  <img  style="width: 100%;" src="<?php echo asset('assets/fontend/bdtdc-images/product-cat.png'); ?>" alt="" /> -->
      <div class="col-sm-2 col-xs-4"><img style="width: 100%;height:150px;border-radius:50% !important;" src="<?php echo asset('assets/fontend/imgsss/cat-knitwear.jpg'); ?>" alt="cat knitwear" />
         <p style="font-size: 14px;color: #333;font-weight: bold;text-align:center;">Knitwear</p>
      </div>
      <div class="col-sm-2 col-xs-4">
         <img itemprop="image" style="width: 100%;height:150px; border-radius:50% !important;" src="<?php echo asset('assets/fontend/imgsss/cat-fabrics.jpg'); ?>" alt="cat fabrics" />
         <p style="font-size: 14px;color: #333;font-weight: bold;text-align:center;">Cat fabrics</p>
      </div>
      <div class="col-sm-2 col-xs-4">
         <img itemprop="image" style="width: 100%;height:150px;border-radius:50% !important;" src="<?php echo asset('assets/fontend/imgsss/cat-childrens.jpg'); ?>" alt="cat childrens" />
         <p style="font-size: 14px;color: #333;font-weight: bold;text-align:center;">Childrens Wears</p>
      </div>
      <div class="col-sm-2 col-xs-4">
         <img itemprop="image" style="width: 100%; height:150px;border-radius:50% !important; " src="<?php echo asset('assets/fontend/imgsss/cat-textiles.jpg'); ?>" alt="cat textiles" />
         <p style="font-size: 14px;color: #333;font-weight: bold;text-align:center;">Textiles</p>
      </div>
      <div class="col-sm-2 col-xs-4">
         <img itemprop="image" style="width: 100%;height:150px;border-radius:50% !important;" src="<?php echo asset('assets/fontend/imgsss/cat-trimmings.jpg'); ?>" alt="cat trimmings" />
         <p style="font-size: 14px;color: #333;font-weight: bold;text-align:center;">Trimmings and<br> Accories</p>
      </div>
      <div class="col-sm-2 col-xs-4">
         <img itemprop="image" style="width: 100%;height:150px;border-radius:50% !important;" src="<?php echo asset('assets/fontend/imgsss/cat-man-womens.jpg'); ?>" alt="cat man womens" />
   ...
   <div class="col-sm-12 col-md-12 col-lg-12 padding_0" style="background: #fff;">
      <div style="padding: 5% 0; margin:0 auto; text-align:center;">
         <div class="btn btn-primary" style="padding-top:10px;border-radius: 5px !important; text-align:center;"><a href="<?php echo e(URL::to('apply-sourceing-meeting',null)); ?>" style="text-decoration:none; color:#fff;">Apply to meet suppliers</a></div>
      </div>
   </div>
   <div class="col-sm-12 col-md-12 col-lg-12 padding_0" style="background: #fff;">
         ...
         <div class="carousel-inner" role="listbox">
            <div class="item active">
               <div class="col-sm-12 col-md-12 col-lg-12" style="padding-top: 7px;">
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Bag.jpg'); ?>" alt="bd source" />
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Bicycle.jpg'); ?>" alt="bd source" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Clothes.jpg'); ?>" alt="bd source" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Cotton.jpg'); ?>" alt="bd source" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
            ...
            <div class="item">
               <div class="col-sm-12 col-md-12 col-lg-12" style="padding-top: 7px;">
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-It.jpg'); ?>" alt="bd source" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Jints.jpg'); ?>" alt="bd source" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Jute.jpg'); ?>" alt="bd source" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Knit-or-crochet-fabric.jpg'); ?>" alt="bd source" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
            ...
            <div class="item">
               <div class="col-sm-12 col-md-12 col-lg-12" style="padding-top: 7px;">
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Leather.jpg'); ?>" alt="apperal Bangla" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Shoe.jpg'); ?>" alt="leather" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/source-Womens-T-shirt.jpg'); ?>" alt="fibre" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
                  ...
                  <div class="col-sm-3 col-md-3 col-lg-3">
                     <img itemprop="image" class="souc-img-list" src="<?php echo asset('assets/fontend/imgsss/textile.jpg'); ?>" alt="textile" />
                     <span class="visit-link">
                        <a href="#" style="text-decoration: none;color: #255E98;">
                           Source from Bangladesh, Visit BuyerSeller.Asia at The
                        </a>
