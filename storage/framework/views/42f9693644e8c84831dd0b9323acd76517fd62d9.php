    ...
    <link property='stylesheet' href="<?php echo asset('css/about-us/research.css'); ?>" rel="stylesheet">
    ...
    <div class="row">
        <div class="col-md-12 padding_0" style="padding-bottom: 1%">
            ...
            <li style="float: left;" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="url" href="<?php echo e(URL::to('about-us',null)); ?>" style="color: #000"> About us &nbsp;</a></li>
    ...
    <div class="row padding_0">
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner" role="listbox">
                                    ...
                                    <img itemprop="image" title="flooding in bangladesh" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/flooding-in-bangladesh.jpg'); ?>" alt="flooding in bangladesh" />
                              </div>

                              <div class="item">
                                    <img itemprop="image" title="hills in bangladesh" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/hills-in-bangladesh.jpg'); ?>" alt="hills in bangladesh" />
                              </div>
                                  
                              <div class="item">
                                   <img itemprop="image" title="rainfall bangladesh" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/rainfall-bangladesh.jpg'); ?>" alt="rainfall bangladesh" />
                              </div>

                              <div class="item">
                                   <img itemprop="image" title="sundarban tour" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/sundarban-tour.jpg'); ?>" alt="sundarban tour" />
                              </div>
                              <div class="item">
                                   <img itemprop="image" title="sylhet tea garden" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/sylhet-tea-garden.jpg'); ?>" alt="sylhet tea garden" />
                              </div>
                              <div class="item">
                                   <img itemprop="image" title="bangladesh population" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/bangladesh-population.jpg'); ?>" alt="bangladesh population" />
                              </div>
                              <div class="item">
                                   <img itemprop="image" title="fishing in bangladesh" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/fishing-in-bangladesh.jpg'); ?>" alt="fishing in bangladesh" />
                              </div>
                              <div class="item">
                                   <img itemprop="image" title="mahasthangarh" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/mahasthangarh.jpg'); ?>" alt="mahasthangarh" />
                              </div>
                              <div class="item">
                                   <img itemprop="image" title="water lily pond" style="height:390px;width:100%;" src="<?php echo asset('assets/fontend/img/water-lily-pond.jpg'); ?>" alt="water lily pond" />
                              </div>
                              </div>             
                 </div>
          </div>
            ...
            <div class="" style="border:1px solid #E7E7E7;padding-bottom: 15px; margin-bottom: 20px;">
                  ...
                  <div class="tab-content">
                      ...
                      <div id="menu1" class="tab-pane fade" style="padding: 0px 15px;">
                              ...
                              <p><a itemprop="url" href="http://www.kazakhembus.com/content/kazakhstan-partner-us-eurasia" target="_blank" class="reach-anchor-right">4. Kazakhstan: a Modern Silk Road Partner</a></p>
                      </div>     
                  </div>
            </div>
          </div>
      	...
      	<div class="row padding_0" style="background-color:#fff! important;margin-top:20px; margin-bottom: 20px;padding-bottom: 3%;">
                        ...
                        <div class="col-sm-8" style="border:1px solid #E7E7E7;border-right:0 none;margin-bottom:20px;">
                              <div class="row" style="padding: 15px;border-bottom:1px solid #E7E7E7;">
                                    <div class="col-sm-4">
                                          <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/demo/invest.png'); ?>" alt="bangladesh garments" />
                                    </div>
...
The North American nation is satisfied with ...
                              ...
                              <div class="row" style="padding: 15px;border-bottom:1px solid #E7E7E7;">
                                    <div class="col-sm-4">
                                          <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/demo/gmbd.png'); ?>" alt="bgarments invest" />
                                    </div>
                                    <div class="col-sm-8" style="padding-bottom: 25px;">
