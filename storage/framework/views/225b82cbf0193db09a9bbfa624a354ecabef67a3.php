	...
	<div class="row">
		...
		<div class="col-sm-12">
				<img class="img-responsive" src="<?php echo asset('assets/images/WOMAN.png'); ?>">
		</div>
		<diV class="col-sm-12 padding_0" style="padding-top:20px; background-color: #fff; padding-bottom: 3%;">
			<div class="col-sm-2">
				...
				<div class="list-group">
				 <a href="<?php echo e(URL::to('web-developer/laravel')); ?>"> <button type="button" class="list-group-item" style="font-size: 100%;color: #000;font-weight:bold;">Web Developer (php laravel & Angular JS)</button></a>
				  <a href="<?php echo e(URL::to('marketing/executive')); ?>"><button type="button" class="list-group-item" style="font-size: 100%;color: #000;font-weight:bold;">Marketing Executive</button></a>
				...
				<a href="<?php echo e(URL::to('about-us')); ?>"><p style="background:#BBB;font-size:18px;padding-left: 7px;color:#fff!important;font-weight: bold;">About Bdtdc</p></a>
				<a href="<?php echo e(URL::to('about-us')); ?>"><p style="background:#BBB;font-size:18px;padding-left: 7px;color:#fff!important;font-weight: bold;margin-top: -8px;">Contact Us</p></a>
			</div>
			<div class="col-sm-7">
