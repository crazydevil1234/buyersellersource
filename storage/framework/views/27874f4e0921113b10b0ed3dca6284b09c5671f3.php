            ...
            <div class="col-md-6 padding_0;">
                <div class="panel panel-default" style="border: 0 none; background-color: #F5F5F5;">
                    ...
                    <div style="width: 600px; height: 20px; display: block;">
                        ...
                        <?php echo Form::open(array('url'=>'reset_password','method'=>'get')); ?>
                        ...
                        <fieldset style="margin-top: 15%;">
                            ...
                            <div style="max-width: 530px; display: block; height: auto; padding: 20px 5px;">
                                ...
                                <select class="form-control" id="sel1">
                                    <?php $__currentLoopData = $user_email; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div style="max-width: 530px; display: block; height: auto; padding: 20px 5px;">
                                ...
                                <div class="form-group" style="width: 200px; float: left;  padding-left: 15px;">
                                           <?php echo Form::text('token', null, ['placeholder' => '10 digit', 'class' => 'form-control', 'required' => 'required']); ?>
