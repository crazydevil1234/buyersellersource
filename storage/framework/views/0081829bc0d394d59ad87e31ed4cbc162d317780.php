	...
	<div class="row">
		<div class="col-md-12 padding_0" style="padding-bottom: 1%">
			...
			<li style="float: left" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="<?php echo e(URL::to('/',null)); ?>" style="color: #000"> Home &nbsp;</a></li>
	...
	<div class="row sus-wrapper" style="border-bottom: 1px solid #999;margin-top:25px;">
		<div class="col-md-3 col-xs-6">
				<div class="coll">
						<div class="sidebar">
							<img class="sidebar-img" src="<?php echo asset('assets/helpcenter/company-logo-.jpg'); ?>" alt="green peace">
						</div>
						<div class="mm">
						<div class="contact">
						...
						<div class="sidebar" style="margin-top: 20px;">
							...
							<img class="sidebar-img" style="height:100px;" src="<?php echo asset('assets/fontend/bdtdc-images/fullsize_distr.png'); ?>" alt="trade answer">
							</a>
						</div>
				</div>
		</div>
...
<div class="row padding_0" style="background: #fff; padding-bottom: 5%; margin-bottom: 20px; border-bottom: 1px solid #ddd;">
	...
	<div class="col-sm-3 col-xs-8" style="text-align: center;">
					...
					<img   class="sus-img-inst" src="<?php echo asset('assets/helpcenter/company-logo-vr-1.png'); ?>" alt="trade answer">
...
<div class="col-sm-3 col-xs-8" style="text-align: center;">
	<a target="_blank" href="http://web.unep.org/climatechange/cop21/">
			<img   class="sus-img-inst" src="<?php echo asset('assets/helpcenter/company-logo-vr-11.jpg'); ?>" alt="trade answer">
	<p style="text-align:center;">COP21/CMP11</p>
						</a>
	</div>
	<div class="col-sm-3 col-xs-8" style="text-align: center;">
			<a target="_blank" href="http://www.unep.org/greeneconomy/">
			<img  class="sus-img-inst" src="<?php echo asset('assets/helpcenter/company-logo-vr-2.jpg'); ?>" alt="trade answer">
			<p style="text-align:center;">Green Economy</p>
		</a>
	</div>
<div class="col-sm-3 col-xs-8" style="text-align: center;">
		<a target="_blank" href="https://www.ctc-n.org/">
			<img  class="sus-img-inst" src="<?php echo asset('assets/helpcenter/company-logo-vr-3.png'); ?>" alt="trade answer">
		<p style="text-align:center;">CTCN</p>
		</a>
</div>
<div class="col-sm-3 col-xs-8" style="text-align: center;">
	<a target="_blank" href="http://uneplive.unep.org/">
		<img  class="sus-img-inst" src="<?php echo asset('assets/helpcenter/company-logo-vr-4.png'); ?>" alt="trade answer">
