	...
	<div class="row" style="margin-bottom: 15px">
		...
		<!-- <div class="col-sm-12" style="border: 1px solid #DDD;margin-top:30px;">
			...
			<div class="col-sm-4" style="padding-bottom:30px;">
				<div class="col-sm-12">
					<div class="col-sm-6">
						<img itemprop="image" style="height:152px;width:125px;" src="<?php echo asset('assets/buyer-security/avoid-phishing.jpg'); ?>" alt="avoid phishing" />
					</div>
			...
			<div class="col-sm-4" style="padding-bottom:30px;">
				<div class="col-sm-12">
					<div class="col-sm-6">
						<img itemprop="image" style="height:152px;width:125px;" src="<?php echo asset('assets/buyer-security/Inspection-Service.jpg'); ?>" alt="Inspection Service" />
					</div>
					<div class="col-sm-6">
			...
			<div class="col-sm-4" style="padding-bottom:30px;">
				<div class="col-sm-12">
					<div class="col-sm-6">
						<img itemprop="image" style="height:152px;width:125px;" src="<?php echo asset('assets/gold/Buyer-protect.jpg'); ?>" alt="bdtdc Buyer Protection" />
					</div>
					<div class="col-sm-6">
