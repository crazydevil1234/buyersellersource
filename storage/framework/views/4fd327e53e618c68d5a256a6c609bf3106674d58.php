 			...
 			<div class="col-sm-12 col-md-12 col-lg-12">
 						<div class="col-sm-3">
 							<ul class="col-sm-12" style="padding-left:15px; padding-top: 25px;">
					                ...
					                <li class="policy-list" >
					                  <a itemprop="url"  href="<?php echo e(URL::to('online/Buy_selleing')); ?>"  class="policy-list-a">Why Buy & Sell Online</a>
					                </li>
					                <li class="policy-list"  >
					                  <a href="<?php echo e(URL::to('supplemental/service')); ?>"  class="policy-list-a" target="_blank">
					                  Setting Company Profile</a>
					                </li>
					                 <li class="policy-list"  >
					                  <a itemprop="url" href="<?php echo e(URL::to('improve/product-ranking')); ?>"  class="policy-list-a">
