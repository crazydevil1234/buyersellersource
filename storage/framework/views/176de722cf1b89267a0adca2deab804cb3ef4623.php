	...
	<?php $__env->startSection('content'); ?>
	 ...
	 <div class="row" style="margin-bottom: 8px">
      ...
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a" ><span itemprop="name">Home</span> <i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('about-us')); ?>" class="top-path-li-a"><span itemprop="name">About BuyerSeller</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
      <li class="top-path-li" itemprop="itemListElement" itemscope
...
<div class="row padding_0" style="background-color: #fff; padding-bottom: 3%;">
	...
	<!-- <div class="filter-body" style="background-color: #fff;">
							<ul id="format-filterlist" class="filter-list">
								...
								<li class="" ><a itemprop="url" href="<?php echo e(URL::to('how-to/business-bangladesh')); ?>" style="color:#666;">Setting Up Business in Bangladesh</a> </li>
								<li class=" filter-specified" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('promoting/bangladesh')); ?>">SME Finance</a> </li>
								<li class="" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('how-to/business-bangladesh')); ?>">Import / Export Procedures of Bangladesh</a> </li>
								<li class="" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('BuyerChannel/pages/trade_intelligence,20')); ?>">Trade Regulations </a></li>
								<li class="" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('how-to/business-bangladesh')); ?>">Bangladesh Import Tariffs</a></li>	
								<li class="" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('tradeshow')); ?>">Support and Consultation Centre for SMEs (SUCCESS)</a></li>
								<li class="" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('bdtdc/sme-center')); ?>">BDTDC SME Centre </a></li>
								<li class="" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('start/programe')); ?>">BDTDC SME Start-up Programme</a> </li>	
								<li class="" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('business/advisory')); ?>">Business Advisory</a> </li>	
								<li class="" ><a itemprop="url" style="color:#666;" href="<?php echo e(URL::to('research')); ?>">Business Tools </a></li>	
	...
	<div class="col-sm-9" style="margin-top: 15px;">
			...
			<div class="col-sm-12 col-md-12">
					 <img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/bdtdc-images/img_startup_support.jpg'); ?>" alt="Bangladesh means business">
