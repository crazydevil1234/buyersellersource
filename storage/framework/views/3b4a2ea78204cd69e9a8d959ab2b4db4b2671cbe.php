...
<div class="container">
   ...
   <div class="row" style="    padding-top: 12px;">
      <div class="col-sm-10 padding_0">
         <div class="col-md-12 padding_0" style="padding-bottom: 1%">
            <ul style="margin-left: -2%" itemscope itemtype="http://schema.org/BreadcrumbList">
               ...
               <li style="float: left" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                  <a itemprop="url" href="<?php echo e(URL::to('dashboard/product')); ?>" style="color: #333;font-weight: normal;font-size: 15px;">
               ...
               <li style="float: left" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                  <a itemprop="url" href="<?php echo e(URL::to('supplier/product_create')); ?>" style="color: #000;font-size: 15px;"> <i class="fa fa-angle-right"></i> <span itemprop="name"><b>Add new product </b></span> <i class="fa fa-angle-right"></i>
                  </a>
      ...
      <div class="col-sm-2 padding_0 text-right" style="">
         <a href="<?php echo e(URL::to('dashboard/product')); ?>" class="goBack"><span>Go Back</span></a>
      </div>
   ...
   <div class="row" style="">
    ...
    ?>
         ...
         <?php echo Form::open(array('url' => 'supplier/product_create', 'method' => 'post', 'enctype'=>'multipart/form-data', 'accept-charset'=>'UTF-8', 'class'=>'form-horizontal form-row-seperated product_info_form')); ?>
            ...
            <div id="product_details_tab_content" class="">
               ...
               <div class="row margin_top1">
                  ...
                  <div class="col-md-4">
                     ...
                     <input style="height:27px;padding-bottom:1%;font-size:12px" type="text" name="product_name" validation="validated_false" class="form-control validate" placeholder="Product Name" value="<?php echo e(old('product_name')); ?>" min="3" max="1000" minlength="3" maxlength="1000" required>
               ...
               <div class="row margin_top1 limited_offer_div" style="display: none;">
                  ...
                  <div class="col-md-7">
                     <table class="table">
                        <tr>
                           ...
                           <td>
                              <div class="input-group" style="width:150px;">
                                 <input validation="validated_false" class="form-control check_number" style="height:27px;padding-bottom:1%;font-size:12px;width:150px;" type="text" value="<?php echo e(old('percentage')); ?>" name="percentage" aria-describedby="percentage-addon">
                        ...
                        <tr>
                           <td>From: </td>
                           <td><input class="form-control span2" id="dpd1" style="height:27px;padding-bottom:1%;font-size:12px;width:150px;" type="text" name="offer_from" placeholder="yyyy-mm-dd" value="<?php echo e(old('offer_from')); ?>"></td>
                           <td>To: </td>
                           <td><input class="form-control span2" id="dpd2" style="height:27px;padding-bottom:1%;font-size:12px;width:150px;" type="text" name="offer_to" placeholder="yyyy-mm-dd" value="<?php echo e(old('offer_to')); ?>"></td>
                           <!-- <td>
				      							<div class="col-xs-3 validation_status">
						                            <i class="fa fa-check-square btn btn-sm btn-success hidden_icon validated_true"></i>
						                            <i class="fa fa-exclamation-triangle btn btn-sm btn-danger hidden_icon validated_false"></i>
                           ...
                           <tr>
                              ...
                              <td style="padding-left: 0">
                                 ...
                                 <select name="parent_category" class="form-control" style="height:29px;padding-bottom:0%;padding-top:0px;font-size:12px" required>
                                    ...
                                    <?php $__currentLoopData = \App\Model\BdtdcCategory::where('parent_id',0)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($v->id); ?>"><?php echo e(trim($v->name)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
               ...
               <div class="row margin_top1">
                  ...
                  <div class="col-md-4">
                     <textarea class="form-control maxlength-handler validate" validation="validated_false" name="product_meta_keywords" min="2" max="200" minlength="2" maxlength="200" required><?php echo e(old('product_meta_keywords')); ?></textarea>
               ...
               <div class="row margin_top1">
                  ...
                  <div class="col-md-4">
                     <textarea class="form-control maxlength-handler validate" validation="validated_false" name="product_meta_tag" min="2" max="200" minlength="2" maxlength="200" required><?php echo e(old('product_meta_tag')); ?></textarea>
               ...
               <div class="row margin_top1">
                  ...
                  <div class="col-md-4">
                     <input style="height:27px;padding-bottom:1%;font-size:12px" type="text" name="product_model" validation="validated_false" class="form-control validate" min="2" max="200" minlength="2" maxlength="200" required value="<?php echo e(old('product_model')); ?>">
               ...
               <div class="row margin_top1">
                  ...
                  <div class="col-md-4">
                     <input style="height:27px;padding-bottom:1%;font-size:12px" type="text" name="brand_name" validation="validated_false" class="form-control validate" min="2" max="200" minlength="2" maxlength="200" required value="<?php echo e(old('brand_name')); ?>">
               ...
               <div class="row margin_top1">
                  ...
                  <div class="col-md-4">
                     <select name="country" class="form-control validate validate_place_origin" style="height:29px;padding-bottom:1%;padding-top:0px;font-size:12px;" validation="validated_false">
                        ...
                        <?php $__currentLoopData = \App\Model\BdtdcCountry::get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($bc->id); ?>" <?php if(old('country') == $bc->id){echo 'selected';} ?>><?php echo e(trim($bc->name)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </select>
                  ...
                  <div class="col-md-8" style="padding-top: 1%;">
                     <table class="table">
                        <tbody class="copied_template">
                           <tr>
                              <td>Name:</td>
                              <td><input style="height: 27px; padding-bottom: 5%; font-size: 12px; margin-left: -70px; width: 255px; padding-left: 55px;" type="text" name="product_att_name[]" class="form-control" min="1" max="200" minlength="1" maxlength="200"></td>
                              <td>Value:</td>
                              <td><input style="height: 27px; padding-bottom: 5%; font-size: 12px; margin-left: -70px; width: 215px; padding-left: 55px;" type="text" name="product_att_value[]" class="form-control" min="2" max="200" minlength="2" maxlength="200"></td>
                           ...
                           <tr>
                              ...
                              <td>
                                 <select style="height:28px;padding-bottom:1%;font-size:12px;padding-top:0%;width:100px;" class="form-control" name="unit_type" id="">
                                    ...
                                    <option value="<?php echo $u->id; ?>" <?php if(old('unit_type') == $u->id){echo "selected";} ?>><?php echo $u->name; ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                              </td>
                           </tr>
                     ...
                     <table class="table FOB_base" style="display: none;">
                        <tbody>
                           <tr>
                              <td>Currency: </td>
                              <td>
                                 <select name="currencies" value="<?php echo e(old('currencies')); ?>">
                              ...
                              <td>
                                 <input style="height:27px;padding-bottom:1%;font-size:12px;width:100px;" type="text" name="currency_from" class="form-control check_number" placeholder="Price From" min="0" max="999999999" minlength="0" maxlength="999999999" value="<?php echo e(old('currency_from')); ?>">
                              </td>
                              <td style="text-align:center;">-</td>
                              <td>
                                 <input style="height:27px;padding-bottom:1%;font-size:12px;width:100px;" type="text" name="currency_to" class="form-control check_number" placeholder="Price To" min="0" max="999999999" minlength="0" maxlength="999999999" value="<?php echo e(old('currency_to')); ?>">
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td>
                                 <select style="height:28px;padding-bottom:1%;font-size:12px;padding-top:0%;width:100px;" class="form-control" name="unit_type_FOB" id="">
                                    <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo $u->id; ?>" <?php if(old('unit_type_FOB') == $u->id){echo "selected";} ?>><?php echo $u->name; ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                              </td>
                           </tr>
                           ...
                           <tr>
                              <td>MOQ: <span></span></td>
                              <td><input style="height:27px;padding-bottom:1%;font-size:12px;width:150px;" type="text" name="product_MOQ_FOB" class="form-control" min="1" max="999999999" minlength="1" maxlength="999999999" value="<?php echo e(old('product_MOQ_FOB')); ?>"></td>
                              <!-- <td>
			      							<div class="col-xs-3 validation_status">
					                            <i class="fa fa-check-square btn btn-sm btn-success hidden_icon validated_true"></i>
					                            <i class="fa fa-exclamation-triangle btn btn-sm btn-danger hidden_icon validated_false"></i>
                           ...
                           <tr>
                              ...
                              <td><input style="height:27px;padding-bottom:1%;font-size:12px;width:150px;" type="text" name="discounted_price" class="form-control check_number" min="0" max="999999999" minlength="2" maxlength="999999999" value="<?php echo e(old('discounted_price')); ?>"></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
                  ...
                  <div class="col-md-9">
                     ...
                     <table class="table">
                        <tr>
                           ...
                           <td><input validation="validated_false" class="form-control validate check_integer" min="0" max="400" minlength="0" maxlength="400" required style="height:27px;padding-bottom:2%;font-size:12px;" type="text" name="processing_time" value="<?php echo e(old('processing_time')); ?>" placeholder="Enter in day">
                        ...
                        <tr>
                           ...
                           <td><input validation="validated_false" class="form-control validate" style="height:27px;padding-bottom:2%;font-size:12px;" type="text" name="port" min="1" max="200" minlength="1" maxlength="200" required value="<?php echo e(old('port')); ?>" placeholder="Type nearest port">
                        ...
                        <tr>
                           ...
                           <td><input validation="validated_false" class="form-control validate check_integer" min="0" max="999999999" minlength="0" maxlength="999999999" required style="height:27px;padding-bottom:2%;font-size:12px;" type="text" name="supply_ability" value="<?php echo e(old('supply_ability')); ?>">
                           ...
                           <tr>
                              ...
                              <td>
                                 <select style="height:28px;padding-bottom:1%;font-size:12px;padding-top:0%" class="form-control" name="product_groups" id="">
                                    <?php $__currentLoopData = $product_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo $u->id; ?>" <?php if(old('product_groups') == $u->id){echo "selected";} ?>><?php echo $u->name; ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                     ...
                     <div class="form-control height-auto">
                        <ul class="list-unstyled">
                           <li>
                              ...
                              <div id="others_area" style="display:none;border: 1px solid rgb(23, 175, 186);padding: 10px;"><input type="text" name="others_payment" placeholder="Other Payments Method" class="form-control" style="height:30px;font-size:12px;margin-bottom: 1%" min="1" max="200" minlength="1" maxlength="200" value="<?php echo e(old('others_payment')); ?>">
                              </div>
                              <!-- <div class="col-md-8">
				      					<input type="text" name="add_group_name[]" placeholder="Group Name" class="form-control" style="height:30px;font-size:12px;margin-bottom: 1%">
				      					<a href="" class="btn btn-success btn-sm product_group_submit_btn" >Save</a>
               ...
               <div class="row margin_top1">
                  ...
                  <div class="col-md-7">
                     <textarea class="form-control maxlength-handler validate" validation="validated_false" name="packages_delivery" min="2" max="1000" minlength="2" maxlength="1000" required><?php echo e(old('packages_delivery')); ?></textarea>
               ...
               <div class="row margin_top1" style="margin-top: 30px;">
                  ...
                  <div class="col-md-10">
                     <textarea id="editor" class="form-control product_desc" validation="validated_false" name="product_description" min="2" max="9999999" minlength="2" maxlength="9999999" required><?php echo e(old('product_description')); ?></textarea>
               ...
               <div class="row margin_top1" style="margin-top: 30px;">
                  ...
                  <div class="col-md-10">
                     <div style=""><label><input type="checkbox" name="terms_condition" value="terms" checked> I accept with the <a target="_blank" href="<?php echo e(URL::to('product_listing_policy',null)); ?>">terms and conditions.</a>
         ...
         <div class="col-xs-12 bg-info" style="padding:1%;text-align: center;">
            ...
            <a class="btn btn-primary btn-lg btn-join" href="<?php echo URL::to('dashboard/product'); ?>">Cancel</a>
         </div>
         ...
         <div style="z-index: 0;margin: 0px; background-color: #fff; width: 100%" class="box">
            ...
            <div style="padding-left:4px;width:100%;padding-top:2px;padding-bottom:30px">
               ...
               <ul style="    padding-left: 10px;" class="">
                  ...
                  <!-- <li class="navigation-menu-list-li"><a itemprop="url"  href="<?php echo e(URL::to('account-settings',null)); ?>" class="navigation-menu-list-li-a">Account Settings</a></li> -->

                  <div style="border-bottom: 1px solid rgba(204, 204, 204, 0.62)">
                     <h4 style="text-align: left;padding-left: 5px">For Buyer</h4>
                  </div>

                  <li class="navigation-menu-list-li" style="padding: 5px;"><a itemprop="url" href="<?php echo e(URL::to('ServiceChannel/pages/for_buyer',35)); ?>" class="navigation-menu-list-li-a">Help Center for Buyers</a></li>
                  <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($page->prefix == 'BuyerChannel' ): ?>


                  <li class="navigation-menu-list-li" style="padding: 5px;"><a itemprop="url" href="<?php echo e(URL::to($page->prefix.'/pages/'.$page->sort_name,$page->id)); ?>" class="navigation-menu-list-li-a"><?php echo e($page->name); ?></a></li>
         ...
         <div style="width: 100%;z-index: 9;margin: 0px;background-color: #fff;margin-top: 5%" class="box">
            ...
            <div style="padding-left:4px;width:100%;padding-top:2px;padding-bottom:30px">
               ...
               <ul style="    padding-left: 10px;" class="">
                  ...
                  <li class="navigation-menu-list-li" style="padding: 5px;"><a itemprop="url" href="<?php echo e(URL::to('ServiceChannel/pages/for_buyer',35)); ?>" class="navigation-menu-list-li-a">Help Center for Suppliers</a></li>
                  <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($page->prefix == 'SupplierChannel' ): ?>
                  <li class="navigation-menu-list-li" style="    padding: 5px;"><a itemprop="url" href="<?php echo e(URL::to($page->prefix.'/pages/'.$page->sort_name,$page->id)); ?>" class="navigation-menu-list-li-a"><?php echo e($page->name); ?></a></li>
                  <?php endif; ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	...
	(function() {
	   ...
	   $(document).on({
	      click: function(e) {
	         ...
	         data_template = '<tr>\
	                                        <td>Name:</td>\
	                                        <td><input style="height:27px;padding-bottom:1%;font-size:12px" type="text" name="product_att_name[]" class="form-control" min="1" max="200" minlength="1" maxlength="200"></td>\
	                                        <td>Value:</td>\
	                                        <td><input style="height:27px;padding-bottom:1%;font-size:12px" type="text" name="product_att_value[]" class="form-control" min="2" max="200" minlength="2" maxlength="200"></td>\
