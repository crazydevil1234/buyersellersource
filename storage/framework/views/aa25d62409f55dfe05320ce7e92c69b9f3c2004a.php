 ...
 <?php $__env->startSection('page_css'); ?>
   <link property='stylesheet' href="<?php echo asset('assets/fontend/css/jquery-te-1.4.0.css'); ?>" rel="stylesheet">
     <link property='stylesheet' href="<?php echo asset('css/jquery-ui.css'); ?>" rel="stylesheet">
 ...
 <?php $__env->stopSection(); ?>
	...
	<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"> <a itemprop="url" href="<?php echo e($_SERVER['REQUEST_URI']); ?>" class="top-path-li-a"> <span itemprop="name" style="color:#333;">Edit Qutations</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
					...
					<div class="category-tab"><!--category-tab-->
						...
						<div class="tab-content">
							<div class="tab-pane active in" id="details" >
								<form action="<?php echo URL::to('mysource/edit-add',$id); ?>" method="post" class="get_qutations" enctype="multipart/form-data">
									...
									<!-- <p class="form-title" itemprop="name">Complete Your Buying Request</p>  -->
								         <div class="row">
											    ...
											    <span class="ui2-form-required">*</span>
                                                    ...
                                                    <input style="height: 45px; text-align: left;padding-left: 15px;"   name="product_name"  type="text" class="form-control product productview query-input" placeholder="Key words of products you are looking for" required value="<?php echo e(old('product_name',$quotations->inquery_title)); ?>">
                                                ...
                                                <div class="row">
                                                   <div align="right" class="col-sm-3 padding_0 pp-quet">
                                                    ...
                                                    <div class="col-sm-3">
                                                    <input name="quantity" style="height:45px;margin-top: 0px;" type="text" class="form-control quantity productview check_integer" placeholder="Estimated Order Quantity" required value="<?php echo e(old('quantity',$quotations->quantity)); ?>">
                                                    <p class="validation_status" style="font-size:10px;"></p>
                                                    </div>
                                                    
                                                     <div class="col-sm-3" style="padding-bottom:30px"> 
                                                        
                                                        <select name="unit" style="margin-top: 0px;height: 45px;background-color:#fff!important;border: 1px solid #DDD;" class=" form-control productview" value="<?php echo e(old('unit',$quotations->unit_id)); ?>">
                                                ...
                                                <div class="row">
                                                      ...
                                                      <div class="col-sm-9" style="padding-bottom:30px" > 
                                                    <textarea style="height: 100px;" class="form-control" name="details" ><?php echo e(old('details',$quotations->message)); ?></textarea>
													...
													<div class="img_delete_area" style="padding: 0;margin-top: 10px;">
														...
														<div style="position: relative;padding: 0;height:80px;width:80px;display: inline-block;margin-right: 10px;">
															<img style="height:80px;width:80px;" src="<?php echo asset('buying-request-docs/'.$docs->docs); ?>" alt="<?php echo e(substr($quotations->inquery_title,30)); ?>" />
															<i data-did="<?php echo e($docs->id); ?>" title="delete" class="fa fa-times delete_img" aria-hidden="true"></i>
														</div>
                                                  ...
                                                  <!--  <div class="row">
                                                   ...
                                                   <div class="col-md-12 padding_0">
                                                   	...
                                                   	<select style="height:45px;" name="fob" class="form-control" value="<?php echo e(old('fob',$quotations->payment_type)); ?>">
  ...
  <option value="DDU">DDU</option>
                                                   	...
                                                   	<div class="col-sm-3">
                                                   		 ...
                                                   		 <input style="height:45px;" type="text" name="unit_price" class="form-control check_number" placeholder="preferred unit price" value="<?php echo e(old('unit_price',$quotations->pre_unit_price)); ?>">
                                                   	</div>
                                                   	<div class="col-sm-3" style="padding-right: 23px;">
                                                   		
                                           		   <select style="height:45px;" name="currency" class="form-control" value="<?php echo e(old('currency',$quotations->currency)); ?>">
                                                   ...
                                                   <div class="col-sm-9 padding_0">
                                                   	<div style="margin-top:15px;" class="col-md-12 padding_0">
                                                   		<div style="padding-left:20px;" class="col-sm-6">
                                                   			<input style="height:45px;" type="text" name="port" class="form-control" placeholder="Destination Port" value="<?php echo e(old('port',$quotations->destination_port)); ?>">
                                                   		</div>
                                                   		<div style="padding-right:23px;" class="col-sm-6">
                                                   			<select style="height:45px;" name="payment_terms" class="form-control" value="<?php echo e(old('payment_terms',$quotations->payment_terms)); ?>">
  ...
  <option value="L/C">L/C</option>
										...
										<option value="Escrow">Escrow</option>
                                                   ...
                                                   <div class="col-sm-9 padding_0">
                                                    ...
                                                    <div style="margin-top:15px;" class="col-md-12 padding_0">
                                                      <div style="padding-left:20px;" class="col-sm-6">
                                                        <input style="height:45px;" type="text" name="expire_date" class="form-control expire_date" placeholder="Valid till (yyyy/mm/dd)" value="<?php echo e(Input::old('expire_date',date('Y/m/d',strtotime($quotations->expire_date)))); ?>">
                                                      </div>
  ...
  <option value="DDU">DDU</option>
										  ...
										  <label style="padding-top: 3px"><input type="checkbox" class="agreement" name="agreement" checked value="<?php echo e(Input::old('agreement')); ?>">
									    ...
									    <div  align="center" class="checkbox" style="padding-left: 0px;margin-left: 40px;" >
										  <label style="padding-top: 3px"><input type="checkbox" class="rules" name="rules" checked value="<?php echo e(Input::old('rules')); ?>">
										  I have read, understood and agreed to obey the buying request posting rules.
                                                ...
                                                <div style="padding-left:30px; padding-top: 5%; padding-bottom:5%;" align="center" class="col-sm-8">
                                                    ...
                                                    <a href="<?php echo e(URL::to('mysource/inq',$id)); ?>" class="btn btn-warning" style="border-radius: 5px !important; padding: 12px 19px;">Cancel</a>
                                                </div>
...
<script type="text/javascript">
        ...
        $('.expire_date').datepicker({
          ...
          /*minDate: "+2d",*/
            ...
            $('[name="unit"]').val('<?php echo e(old("unit",$quotations->unit_id)); ?>');
            $('[name="fob"]').val('<?php echo e(old("fob",$quotations->payment_type)); ?>');
            $('[name="currency"]').val('<?php echo e(old("currency",$quotations->currency)); ?>');
            $('[name="payment_terms"]').val('<?php echo e(old("currency",$quotations->payment_terms)); ?>');
