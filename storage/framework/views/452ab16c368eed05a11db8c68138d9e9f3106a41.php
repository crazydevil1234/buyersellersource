<?php $__env->startSection('page_css'); ?>
  ...
  <div class="row" style="padding-bottom: 8px">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        <li class="top-path-li" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('/')); ?>" class="top-path-li-a"> <span itemprop="name" style="color: #333;">Home </span><i class="fa fa-angle-right top-path-icon"></i></a></li>
  ...
  <div class="row padding_0" style="background:#ffffff; margin-bottom:28px;padding-bottom:5%;border-bottom: 1px solid rgba(0,0,0,.1);">
      ...
      <div class="col-sm-1">
  		...
  		<div class="col-sm-10">
  			<img itemprop="image" class="img-responsive" style="max-height:650px;" src="<?php echo asset('assets/fontend/images/user-signin.jpg'); ?>" alt="global shipping services" />
  		</div>
      <div class="col-sm-1">
  ...
  <div class="col-sm-12 col-md-12" style="margin-top:28px;">
  			<div class="col-sm-8">
  				<img itemprop="image" class="user-buy-product-learn img-responsive" src="<?php echo asset('assets/fontend/images/user-sign-form.jpg'); ?>" alt="global shipping services" />
  			</div>
  			<div class="col-sm-4">
  ...
  <div class="col-sm-12 col-md-12" style="margin-top:28px;">
  			<div class="col-sm-8">
  				<img itemprop="image" class="user-buy-product-learn img-responsive" src="<?php echo asset('assets/fontend/images/user-product-search.jpg'); ?>" alt="global shipping services" />
  			</div>
  			<div class="col-sm-4">
  ...
  <div class="col-sm-12 col-md-12" style="margin-top:28px;">
  			<div class="col-sm-8">
  				<img itemprop="image" class="user-buy-product-learn img-responsive" src="<?php echo asset('assets/fontend/images/user-contact-supplier.jpg'); ?>" alt="global shipping services" />
  			</div>
  	...
  	<div class="col-sm-12 col-md-12" style="margin-top:28px;">
  			<div class="col-sm-8">
  				<img itemprop="image" class="user-buy-product-learn img-responsive" src="<?php echo asset('assets/fontend/images/user-send-request.jpg'); ?>" alt="global shipping services" />
  			</div>
  			<div class="col-sm-4 col-md-4">
  					<div class="guide-cont">
  					<span class="fa fa-circle" aria-hidden="true" style="font-size:13px; color:#666;"></span>
  	...
  	<div class="col-sm-12 col-md-12" style="margin-top:28px;">
  			<div class="col-sm-8">
  				<img itemprop="image" class="user-buy-product-learn img-responsive" src="<?php echo asset('assets/fontend/images/user-message-duration.jpg'); ?>" alt="global shipping services" />
  			</div>
  			<div class="col-sm-4 col-md-4">
  					<div class="guide-cont">
  					<span class="fa fa-circle" aria-hidden="true" style="font-size:13px; color:#666;"></span>
  	...
  	<div class="col-sm-12 col-md-12" style="margin-top:28px;">
  			<div class="col-sm-8">
  				<img itemprop="image" class="user-buy-product-learn img-responsive" src="<?php echo asset('assets/fontend/images/user-send-query.jpg'); ?>" alt="global shipping services" />
  			</div>
  			<div class="col-sm-4 col-md-4">
  					<div class="guide-cont">
  					<span class="fa fa-circle" aria-hidden="true" style="font-size:13px; color:#666;"></span>
