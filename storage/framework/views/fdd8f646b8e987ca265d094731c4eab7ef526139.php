	...
	<link property='stylesheet' href="<?php echo asset('css/trade-services/business-identity.css'); ?>" rel="stylesheet">
	...
	<div class="row" style="padding-top: 1%;">
        <div class="col-lg-12 col-md-12 padding_0">
            ...
            <li style="float: left">
              <a itemprop="url" href="<?php echo e(URL::to('/ServiceChannel/pages/for_buyer',35)); ?>" style="color: #000">
              Help Center
              </a> <i class="fa fa-angle-right"></i> 
            </li>
       ...
       <button class="goBack" onclick="goBack()" style="padding: 0; float: right;"><span>Go Back</span></button>
		...
		<div class="row header_cont_color" style="">
			<img itemprop="image" class="img-responsive header_img_fix" src="<?php echo asset('assets/helpcenter/business-finder.jpg'); ?>" alt="business finder" />
		</div>
...
responses. </p>
		...
		<div  class="row item_sha">
			...
			<div class="col-md-2 button_padding">
				<a itemprop="url" href="<?php echo e(URL::to('company/dashboard',null)); ?>" class="btn btn-primary center-block btn-join">Verify</a>
			</div>
			<div class="col-md-5"></div>
		</div>
		...
		<div class="row item_sha">
				...
				<div class="row padding-bottom">
						...
						<div class="col-sm-12">
							<div class="col-md-2 col-sm-2">
								 <img itemprop="image" style="height:13%;width:120%;" class="img-circle" src="<?php echo asset('assets/fontend/img/kazi.jpg'); ?>" alt="Kazi Ahmed" /> 
							</div>
							<div class="col-sm-4">
			...
			<div class="col-md-4 col-sm-4" style="padding-bottom:30px;">
				...
				<!-- <a itemprop="url" href="<?php echo e(URL::to('FooterPage/pages/Help_Center',19)); ?>" style="padding-left:78%;text-decoration: none;color: #1686cc;font-size: 13px;"> -->
				<!-- 	Learn More
				</a> -->
			</div>
		</div>
		...
		<div class="row" style="margin-bottom:5%;padding-top:20px;margin-bottom: 0%; padding: 2%;">
				<p>Any questions, <a itemprop="url" href="<?php echo e(URL::to('FooterPage/pages/Contact_Us',20)); ?>">please contact us</a></p>
		</div>
	</div>
   <?php $__env->stopSection(); ?>
