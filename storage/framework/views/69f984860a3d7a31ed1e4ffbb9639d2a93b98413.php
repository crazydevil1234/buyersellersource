<?php $__env->startSection('page_css'); ?>
  <link property='stylesheet' href="<?php echo asset('assets/fontend/bdtdccss/bangladesh-business-style.css'); ?>" rel="stylesheet">
...
<?php $__env->startSection('content'); ?>
 <div class="row" style="margin-bottom: 8px">
      ...
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a" ><span itemprop="name">Home</span> <i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('SupplierChannel/pages/learning_center',33)); ?>" class="top-path-li-a"><span itemprop="name">Learning Center</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
      <li class="top-path-li" itemprop="itemListElement" itemscope
...
<div class="row" style="background-color: #fff; margin-top: 1px; padding-top: 5px;">
       <ul class="nav nav-tabs" aria-label="Navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
          ...
          <li class="active"><a itemprop="url"  style="" href="<?php echo URL::to('success/stories',null); ?>">Success Stories</a></li>
       </ul>
</div>
<div class="row padding_0" style="background-color: #fff;">
 
          <div class="col-md-3 col-xs-6" style="padding: 0;">
          <a href="<?php echo e(URL::to('Home/Green-Field',1559)); ?>" target="_blank">
           <img itemprop="image" class="succ-man"  src="<?php echo asset('assets/fontend/bdtdc-images/hero1.jpg'); ?>" alt="traing1">
           </a>
        ...
        <div class="col-md-3 col-xs-6"  style="padding: 0;">
        <a href="<?php echo e(URL::to('Home/Raid-International',1379)); ?>" target="_blank">
           <img itemprop="image" class="succ-man"  src="<?php echo asset('assets/fontend/bdtdc-images/hero2.jpg'); ?>" alt="traing1"></a>
              <div class="sss-stories">
        ...
        <div class="col-md-3 col-xs-6"  style="padding: 0;">
        <a href="<?php echo e(URL::to('Home/Supplyhouse',1461)); ?>" target="_blank">
            <img itemprop="image" class="succ-man"  src="<?php echo asset('assets/fontend/bdtdc-images/hero3.jpg'); ?>" alt="traing1"></a>
              <div class="sss-stories">
     ...
     <div class="col-md-3 col-xs-6"  style="padding: 0;">
           <img itemprop="image" class="succ-man"  src="<?php echo asset('assets/fontend/bdtdc-images/hero4.jpg'); ?>" alt="traing1">
              <div class="sss-stories">
...
<div class="row padding_0" style="background-color: #fff; padding-bottom: 8%;">
    ...
    <div class="col-md-12 col-sm-12 tab-pane fade in active" id="gold-supplier"> 
      <div class="col-sm-12 col-md-12">
            <div class="col-md-1">
            <img itemprop="image" class="stroris-man" src="<?php echo asset('assets/fontend/bdtdc-images/shamol.jpg'); ?>" alt="traing1">
      </div>
       <div class="col-md-8">
...
Mr. Shamal states that they are currently doing extraordinary business because of BuyerSeller.asia. "We get a great deal of inquiries from all around the globe, comprising the USA, Canada, Australia etc.," he stated. "A number of these inquiries have been changed into genuine orders, and a numerous of them are currently under negotiation. BuyerSeller is truly the key to our success!” </span></p>
          ...
          <div class="col-md-3">
             <div class="desh">
                    ...
                    <p><span style="padding-right: 12px;">Bangladesh</span><img itemprop="image"  src="<?php echo asset('assets/fontend/bdtdc-images/flag-Bangladesh.gif'); ?>" alt="traing1"></p>
  ...
  <div class="col-sm-12 col-md-12">
            ...
            <img itemprop="image" class="stroris-man" src="<?php echo asset('assets/fontend/bdtdc-images/Virendra.jpg'); ?>" alt="traing1">
      </div>
...
<div class="col-sm-12 col-md-12tab-pane fade" id="gold-buyer">
       <div class="col-sm-12 col-md-12">
              <div class="col-md-1 col-sm-1">
            <img itemprop="image" class="stroris-man" src="<?php echo asset('assets/fontend/bdtdc-images/stories-man2.jpg'); ?>" alt="traing1">
      </div>
       <div class="col-md-8 col-sm-8">
