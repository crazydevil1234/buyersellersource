    ...
    <link property='stylesheet' href="<?php echo asset('css/for-buyers/inspection-services.css'); ?>" rel="stylesheet">
	...
	<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('FooterPage/pages/Help_Center',19)); ?>" class="top-path-li-a"><span itemprop="name">Help Center</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('FooterPage/pages/Inspection_Service',39)); ?>" class="top-path-li-a"><span itemprop="name">Payment Inspection Service</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
		...
		<div class="row header_cont_color">
			<img itemprop="image" class="img-responsive header_img_fix" src="<?php echo asset('assets/gold/trusted-trade.jpg'); ?>" alt="trusted trade" />
		</div>
		<br><br>
		<div  class="row font_awesome_manual_size margin_top item_sha">
			<div class="col-sm-4 col-md-4">
				<div class="col-sm-2 col-xs-2 col-md-2">
					<div><img style="padding-top: 22px; float: right;" src="<?php echo e(asset('assets/gold/Verified-Inspectors.png')); ?>" alt="Verified Inspectors"> </div>
				</div>
			...
			<div class="col-sm-4 col-md-4">
				<div class="col-sm-2 col-xs-2 col-md-2">
					<div><img style="padding-top: 22px; float: right;" src="<?php echo e(asset('assets/gold/Secure-Payment.png')); ?>" alt="Verified Inspectors"> </div>
				</div>
...
insist tasteful receipt of the survey report </p>
			...
			<div class="col-sm-4 col-md-4">
				<div class="col-sm-2 col-xs-2 col-md-2">
					<div><img style="padding-top: 22px; float: right;" src="<?php echo e(asset('assets/gold/Moderate-organization.png')); ?>" alt="Verified Inspectors"> </div>
				</div>
				<div class="col-sm-10 col-xs-10 col-md-10">
...
<a itemprop="url" href="<?php echo e(URL::to('/',null)); ?>">BuyerSeller.Asia.</a> The assessor will visit the gathering and/or working ports anywhere
...
random investigation; 4. Container loading inspection; 5. Factory audit.
          ...
          <?php $__currentLoopData = $parent_cat_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <p><a itemprop="url" href="<?php echo e(URL::to('faq-detail',$data->id)); ?>" style="text-decoration: none;color: #333;font-size: 14px;"><?php echo e($data->name); ?></a></p>
		...
		<div class="row" style="margin-top:28px; background-color: #fff; margin-bottom: 28px; padding-top: 30px;">
			...
			<div class="col-sm-12" style="background-color:#fff; padding-bottom: 28px;">
					 ...
					 <table class="table table-bordered" style="border: 1px solid #ddd !important">
						    ...
						    <tbody>
						      <tr style="border-bottom: 1px solid #ddd !important;">
						        <td><img style="max-width: 200px;" src="<?php echo e(asset('assets/fontend/imgsss/inspect.png')); ?>" alt="inspection"></td>
						       ...
						       <tr style="border-bottom: 1px solid #ddd !important;">
						        <td><img style="max-width: 200px;" src="<?php echo e(asset('assets/fontend/imgsss/intertek.png')); ?>" alt="inspection"></td>
						       ...
						       <tr style="border-bottom: 1px solid #ddd !important;">
						        <td><img style="max-width: 200px;" src="<?php echo e(asset('assets/fontend/imgsss/modern-testing.png')); ?>" alt="inspection"></td>
						       ...
						       <tr style="border-bottom: 1px solid #ddd !important;">
						        <td><img style="max-width: 200px; max-height: 130px;" src="<?php echo e(asset('assets/fontend/imgsss/south-asia.jpg')); ?>" alt="inspection"></td>
						       ...
						       <tr style="border-bottom: 1px solid #ddd !important;">
						        <td><img style="max-width: 200px;" src="<?php echo e(asset('assets/fontend/imgsss/baruea.png')); ?>" alt="inspection"></td>
