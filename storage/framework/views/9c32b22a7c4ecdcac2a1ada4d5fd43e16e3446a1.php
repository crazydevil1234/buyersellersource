    ...
    <link property='stylesheet' href="<?php echo asset('css/contact-us.css'); ?>" rel="stylesheet">
...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="url"   href="<?php echo e(URL::to('help-center')); ?>" class="top-path-li-a">Help Center<i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="url"   href="<?php echo e(URL::to('contact_message_form')); ?>" class="top-path-li-a">Contact Us<i class="fa fa-angle-right top-path-icon"></i></a></li>
        ...
        <div class="col-sm-12">
                <div class="col-md-5 col-sm-5 col-lg-5">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                            <img itemprop="image" style="display: block;max-height: 100px; padding-bottom: 2%; width: 130px;"  src="<?php echo asset('assets/fontend/bdtdc-images/contact-customer-service.png'); ?>" alt="contact customer service" />
                         </div>
...
<div class="col-md-12 padding_0"> 
    <div class="col-sm-4 padding_0">
        <div class="col-sm-12" style="border-top: 1px solid #e7e7e7;border: 1px solid #e7e7e7;padding-right:20px;padding-bottom:5%;">
            <div class="col-sm-3" style="padding-top:11%;padding-bottom:5%;">
                <img itemprop="image" style="height:50px;width:50px;" src="<?php echo asset('assets/service/contact-call.png'); ?>" alt="contact call" />
            </div>
    ...
    <div class="col-sm-4 padding_0">
            ...
            <div class="col-sm-2">
                <img itemprop="image" style="height:50px;width:50px;" src="<?php echo asset('assets/service/submit-dispute.png'); ?>" alt="submit dispute" />
            </div>
            <div class="col-sm-10" style="padding-bottom:6%;">
                <a itemprop="url"   href="<?php echo e(URL::to('ServiceChannel/pages/submit_a_dispute/39')); ?>" class="btn btn-default" style="margin-top: 5%; margin-left: 10%;color: #8F8F91;" >Submit a Dispute</a>
