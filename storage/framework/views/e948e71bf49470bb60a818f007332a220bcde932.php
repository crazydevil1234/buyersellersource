<?php $__env->startSection('page_css'); ?>
    <link property='stylesheet' href="<?php echo asset('assets/fontend/bdtdccss/whole-sale-category-product.css'); ?>" rel="stylesheet">
    <link property='stylesheet' href="<?php echo asset('assets/fontend/bdtdccss/m-category.css'); ?>" rel="stylesheet">
...
<div class="col-sm-12" style="margin-top:20px;">
    <div class="col-sm-6">
       <p><a href="<?php echo e(URL::to('/',null)); ?> ">Home </a> <i class="fa fa-angle-double-right"></i> Easy Sourcing</p>
        
    </div>
    <div class="col-sm-6">
        <a href="<?php echo e(URL::to('Sourcing/Requests/info',null)); ?>" style="float:right;color: #246bb3;font-size: 14px;font: 12px/1.5 Arial,sans-serif;font-weight: bold;">
        I am Supplier</a>
    </div>
</div>
<div class="col-sm-12" id="buyer">
    ...
    <div class="col-sm-12" style="margin-top:5.5%;">
        ...
        <div class="col-sm-7">
            <a href="<?php echo e(URL::to('get-quotations',null)); ?>" target="_blank" type="button" class="btn btn-danger" style="height:47px;border-radius:5px!important;font-size:18px;color:#fff!important;margin-top: 0.4%;">Post Sourcing Request Now</a>
        </div>
    </div>
    ...
    <div class="col-sm-12" style="margin-top:3%;padding-bottom: 2%">
        <div class="category-tab"><!--category-tab-->
                ...
                <ul class="nav nav-tab nav-pills trade-show-ul " style="background:none;border-bottom: 1px solid #dae2ed;">
                    ...
                    <?php $__currentLoopData = $chunked_cat_array[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="tab-pane fade active in" id="forbuyer">
                <div class="col-sm-12 padding_0 replace_area">
                    <div style="text-align:center;margin-top:50px;margin-bottom:50px;">
                        <img src="<?php echo asset('assets/images/circle_preloader.gif'); ?>" alt="Loading..." />
                    </div>
                </div>
            </div>
        </div>
