...
<div class="container">
  <div class="row">
	...
	<img width="100%" src="<?php echo asset('assets/fontend/bdtdc-images/under-construct.png'); ?>" class="img-responsive" alt="">
</div>
					<?php else: ?>
<div class="row padding_0">
	...
	<div class="col-sm-8 col-md-8 col-lg-8 padding_0" style="border-right: 2px dotted #e5e5e5;">
            ...
            <ol class="carousel-indicators">
	         ...
	         <div class="carousel-inner" role="listbox">
                <div class="item">
                 <img style="max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/banner02.jpg'); ?>" alt="">
                </div>
            
                <div class="item">
                  <img style="max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/logistic-image222.jpg'); ?>" alt="">
                </div>
            
                <div class="item active">
                  <img style="max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/logistic-image444.jpg'); ?>" alt="">
                </div>
            
                <div class="item">
                  <img style="max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/team2.jpg'); ?>" alt="">
                </div>
            </div>
