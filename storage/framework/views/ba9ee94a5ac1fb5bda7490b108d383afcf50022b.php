...
<html lang="en">
   <head>
      ...
      <title><?php echo e($title ?? 'BuyerSeller'); ?>  </title>
      ...
      <!-- // -->
      <link href="<?php echo asset('assets/fontend/bootstrap.min.css'); ?>" media="all" rel="stylesheet" type="text/css" />
      <link href="<?php echo asset('assets/fontend/bootstrap-theme.min.css'); ?>" media="all" rel="stylesheet" type="text/css" />
      <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css" rel="stylesheet">
      <!-- ANIMATE CSS -->
      <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/fontend/css/animate.css')); ?>" media="screen" data-name="skins">
      <!-- HOVER CSS -->
      <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/fontend/css/hover-min.css')); ?>" media="screen" data-name="skins">
      <!--SWEET ALERT -->
      <link rel="stylesheet" href="<?php echo e(URL::asset('assets/fontend/css/sweetalert.css')); ?>" type='text/css'/>
      <link href="<?php echo asset('assets/fontend/topbar/css/bootstrap-dropdownhover.min.css'); ?>" media="all" rel="stylesheet" type="text/css" />
      <!--TEXT EDITOR CSS -->
      <link rel="stylesheet" href="<?php echo e(URL::asset('assets/fontend/css/jquery-te-1.4.0.css')); ?>" type='text/css'/>
      <!--SLICK CSS -->
      <link href="<?php echo asset('assets/fontend/css/slick.css'); ?>" rel="stylesheet">
      <link href="<?php echo asset('assets/fontend/css/slick-theme.css'); ?>" rel="stylesheet">
      <!---CUSTOM STYLE FOR THIS SITE;-->
      <link href="<?php echo asset('assets/fontend/css/custom_template_style.css'); ?>" rel="stylesheet">
      <link href="<?php echo asset('assets/dashboard/css/main.css'); ?>" rel="stylesheet">
      <link href="<?php echo asset('assets/fontend/bdtdccss/company-template-design.css'); ?>" rel="stylesheet">
      <link href="<?php echo asset('assets/fontend/bdtdccss/trade-template.css'); ?>" rel="stylesheet">
   ...
   <body style="background-color: #fff !important">
      <!---HEADER SECTION -->
      <div class="container">
         <input type="hidden" name="profile_id" value="<?php echo e(Route::current()->parameters()['profile_id']); ?>" />
         <div class="row" style="background-color: #fff;padding-bottom: 1%">
            <div class="col-md-12 padding_0">
               <div class="bdtdc-logo col-sm-2" itemscope itemtype="http://schema.org/Organization" style="margin-top: 5px;  float: left;">
                  ...
                  <img alt="logo" style=" width: 100%; height: auto;margin-top: 32px;" itemprop="logo" class="loggg" src="<?php echo e(asset('assets/logo.png')); ?>" />
                  </a>
               </div>
                  ...
                  <div class="col-sm-12" style="padding: 0">
                     ...
                     <div aria-label="Navigation" itemscope itemtype="http://schema.org/SiteNavigationElement" class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse pull-right m-nvr-inn" itemscope itemtype="http://schema.org/SiteNavigationElement">
                           <li><a style="padding-left: 0px;" itemprop="url" href="<?php echo e(URL::to('online-marketplace',null)); ?>">Shop by Category</a></li>
                           <li class="dropdown" style="z-index: 999 !important;">
                              ...
                              <ul style="float: left" role="menu" class="sub-menu">
                                 ...
                                 <li><a itemprop="url" href="<?php echo e(URL::to($page->prefix.'/pages/'.$page->sort_name,$page->id)); ?>" class="prefix_url"><?php echo e($page->name); ?></a></li>
                                 <?php endif; ?> 
                           ...
                           <li class="dropdown" style="z-index: 999 !important;">
                              ...
                              <ul role="menu" class="sub-menu" itemscope itemtype="http://schema.org/SiteNavigationElement">
                                 <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <?php if($page->prefix == 'ServiceChannel' ): ?>
                                 <li><a itemprop="url" href="<?php echo e(URL::to($page->prefix.'/pages/'.$page->sort_name,$page->id)); ?>" class="prefix_url"><?php echo e($page->name); ?></a></li>
                                 <?php endif; ?>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </ul>
                           </li>
                           <li><a style="margin-right:-1%" target="_blank" class="pull-right" href="<?php echo e(URL::to('about-us',null)); ?>">About BuyerSeller</a></li>
                        </ul>
                     </div>
                  </div>
                     ...
                     <div itemprop="potentialAction" itemscope itemtype="http://schema.org/SearchAction" style="" class="col-xs-12 padding_0">
                        <div class="col-xs-12" style="padding-right:0px;padding-left: 0px; padding-bottom:10px;">
                           <div class="col-lg-12" style="padding:0px">
                              <form class="form" method="post" action="<?php echo URL::to('search-product',null); ?>">
                                 <?php echo csrf_field(); ?>
                        ...
                        <div class="col-xs-12" style="padding-right:0px;padding-left: 0px; padding-bottom:10px;">
                           <div class="col-lg-12" style="padding:0px">
                              <form class="form" method="post" action="<?php echo URL::to('search-product',null); ?>">
                                 ...
                                 <input itemprop="url" type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                 <div class="input-group input-group-lg" style="border: 1px solid #255E98;border-radius: 0px !important;">
                                    <span class="input-group-btn hide_dropdown" style="    width: 130px;
                                       border: 0;
                                       border: 1px solid #255E98;
               ...
               <div class="col-md-3 col-sm-3 col-xs-3 padding_0" style="float: right;">
                  <div aria-label="Navigation" itemscope itemtype="http://schema.org/SiteNavigationElement" class="mainmenu pull-right padding_0">
                     <ul style="float: right; text-align:right;margin: 0px" class="nav navbar-nav collapse navbar-collapse padding_0" itemscope itemtype="http://schema.org/SiteNavigationElement">
                        <li class="dropdown" style="z-index: 999 !important;">
                           ...
                           <ul role="menu" class="sub-menu submenu2" itemscope itemtype="http://schema.org/SiteNavigationElement">
                              ...
                              <?php endif; ?>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <li ><a class="btn" href="http://support.buyerseller.asia/create-ticket"> Contact for any query </a> </li>
                           </ul>
                        </li>
                     ...
                     <ul style="float: right; text-align:right;margin: 0px" class="nav navbar-nav collapse navbar-collapse padding_0" itemscope itemtype="http://schema.org/SiteNavigationElement">
                        ...
                        ?>
                        <li class="dropdown" style="z-index: 999 !important;">
                           <a style="text-align: right;padding-right: 16px" itemprop="url" href="#">Welcome back<br><span id="total_notification" title=""></span> <?php echo e(Sentinel::getUser()->first_name); ?> <span id="all_notification" style="margin-left: 5px;"><i data-count="<?php echo e($all_notifications); ?>" class="glyphicon notification-icon"></i></span>
                           ...
                           <ul role="menu" class="sub-menu submenu2" style="background-color: #fff;top: 100%" itemscope itemtype="http://schema.org/SiteNavigationElement">
                              ...
                              <?php endif; ?>
                              <li title="" class="pusher_notification_1"><a itemprop="url" href="<?php echo e(URL::to('default','message')); ?>">New Inquiry <span style="margin-left: 5px;"><i data-count="<?php echo e($inquiry_notifications); ?>" class="glyphicon notification-icon"></i></span>
                                 <?php if(Sentinel::check()): ?>
                                 <span title="" id="total_new_inquiry"></span>
                                 <?php endif; ?>
                                 </a>
                              </li>
                              <li title="" class="pusher_notification_2"><a itemprop="url" href="<?php echo e(URL::to('Mybuying-Request')); ?>">New Quote <span style="margin-left: 5px;"><i data-count="<?php echo e($quote_notifications); ?>" class="glyphicon notification-icon"></i></span>
                                 <?php if(Sentinel::check()): ?>
                                 <?php endif; ?>
                                 </a>
                              </li>
                              <li style=" margin-left: 0%;" class="pusher_notification_3"><a itemprop="url" href="<?php echo e(URL::to('order-list',null)); ?>" class="join_btn"><i class="fa fa-users" aria-hidden="true"></i> Order <span style="margin-left: 5px;"><i data-count="<?php echo e($order_notifications); ?>" class="glyphicon notification-icon"></i></span>
                              ...
                              <li style="margin-bottom: 10px" class="navigation-menu-list-li"><a itemprop="url" href="<?php echo e(URL::to('list/view/requested/sample')); ?>" class="navigation-menu-list-li-a">Manage Sample Requests</a></li>
                              <li class="sub-split" style="background-color: #fff;   border-top: 1px solid #ddd;
                              ...
                              <li class="navigation-menu-list-li"><a itemprop="url" target="_blank" href="<?php echo e(URL::to('dashboard','product')); ?>" class="navigation-menu-list-li-a">Display New Products</a></li>
                              ...
                              <li style="background-color: #fff;   border-top: 1px solid #ddd;
                                 ...
                                 list-style: none outside none;padding-top: 5px;line-height: 22px;color: #333;font-weight: 700;white-space: nowrap;box-shadow: none" class="btn" href="<?php echo e(URL::to('logout',null)); ?>"> Logout </a> </li>
                              <?php endif; ?>
                              <?php else: ?>
      ...
      <?php echo $__env->make('fontend.template.header_information', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
               ...
               <div class="col-md-10" style="padding: 0px;border-top: 1px solid rgba(0,0,0,0.1);">
                  <div class="col-md-12" style="padding: 0px">
                     <div class="col-sm-5" style="margin-top: 3px;padding: 0">Free App
                        <img style="width:93px;height:30px;opacity:1; margin-left: 10px;" src="<?php echo asset('assets/helpcenter/android-app2.png'); ?>" alt="android-app2" />
                        <img style="width:103px;height:30px;opacity:1" src="<?php echo asset('assets/helpcenter/apple-app.png'); ?>" alt="apple-app" />
                     </div>
                     ...
                     <div class="col-md-3" style="padding: 0;">
                        <form action="<?php echo URL::to('subscript/change-email'); ?>">
                           <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                  ...
                  <div class="col-sm-12">
                     <ul style="padding-bottom: 2%;">
                        <li  style="float:left;padding: 1%;">
                           <a target="_blank" style="color:#000" href="<?php echo e(URL::to('Bdsource-home-page',null)); ?>">BdSource</a>
                        </li>
                        <li style="float:left;padding: 1%;">
                           <a target="_blank" style="color:#000"  href="<?php echo e(URL::to('wholesale',null)); ?>">Wholesaler</a>
                        </li>
                        <li style="float:left;padding: 1%;">
                           <a target="_blank" style="color:#000" href="<?php echo e(URL::to('bangladesh-garments',null)); ?>">Bangladesh Garments</a>
                        </li>
                        <li style="float:left;padding: 1%;">
                           <a target="_blank" style="color:#000" href="<?php echo e(URL::to('bangladesh-suppliers',null)); ?>">Bangladesh Suppliers</a>
                        </li>
                        <li style="float:left;padding: 1%;">
                           <a target="_blank" style="color:#000" href="<?php echo e(URL::to('online-marketplace',null)); ?>">Shop by Category</a>
                        </li>
                     </ul>
                  </div>
                  <br><br>
                  <div style="padding-bottom:8%;color: #696763;" class="row">
                     <div style="text-align:center;margin-left:auto; margin-right:auto;"> 
                        <a style="color:#696763" href="<?php echo e(URL::to('contact')); ?>"> Contact Us </a>
                        <a target="_blank" style="color:#696763" href="<?php echo e(URL::to('product_listing_policy',null)); ?>">Product Listing Policy</a> 
                        <a target="_blank" style="color:#696763" href="<?php echo e(URL::to('Intellectual',null)); ?>"> Intellectual Property Policy and Infringement Claims</a>
                        <a target="_blank" style="color:#696763" href="<?php echo e(URL::to('Policies_Rules',null)); ?>">Privacy Policy</a> 
                        <a target="_blank" style="color:#696763" href="<?php echo e(URL::to('terms_use',null)); ?>">Terms of Use</a>
                     </div>
      ...
      <script type="text/javascript" src="<?php echo asset('assets/fontend/js/jquery.cycle.all.js'); ?>"></script>
