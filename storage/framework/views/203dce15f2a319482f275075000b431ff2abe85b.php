...
<link property='stylesheet' href="<?php echo asset('css/single-product-details.css'); ?>" rel="stylesheet">
<style type="text/css">
...
<?php $__env->startSection('extra_stylesheet'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<div class="row" style="padding-top:1%;padding-bottom:0%">
   <input type="hidden" class="meta_keyword_manual" value="<?php echo e($products->product_name->meta_keyword); ?>">
   <div class="col-md-12 padding_0" style="padding-bottom: 1%">
      <ul style="margin-left: -2%" itemscope itemtype="http://schema.org/BreadcrumbList">
         ...
         <li style="float: left"  itemprop="itemListElement" itemscope
            itemtype="http://schema.org/ListItem">
            <a itemprop="url" href="<?php echo e(URL::to($parent_id->slug,$parent_id->id)); ?>" style="color: #000"> 
            <span itemprop="name"><?php echo e($parent_id->name); ?> &nbsp;
            </span> </a>
            <meta itemprop="position" content="2" />
         </li>
         <li style="float: left" itemprop="itemListElement" itemscope
            itemtype="http://schema.org/ListItem">
            <a itemprop="url" href="<?php echo e(URL::to(strtolower(preg_replace('/[^A-Za-z0-9\.-]/','',preg_replace('/[^A-Za-z0-9\.,&-]/','-',($products->bdtdcProductToCategory->bdtdcCategory?$products->bdtdcProductToCategory->bdtdcCategory->name:'not available')))).'-products/0',$products->bdtdcProductToCategory->category_id)); ?>" style="color: #000"> <i class="fa fa-angle-right"></i> <span itemprop="name"><?php echo e($products->bdtdcProductToCategory->bdtdcCategory?$products->bdtdcProductToCategory->bdtdcCategory->name:'not available'); ?></span> <i class="fa fa-angle-right"></i>
            </a>
      ...
      <div class="product-details" style="margin-bottom:0;">
         ...
         <div class="col-sm-5 col-md-4 col-lg-4 col-xs-12">
            <ul id="etalage" style="width: 100%!important;">
               <li style="width: 100%!important;">
                  ...
                  <img itemprop="image"  class="etalage_thumb_image" src="<?php echo e(URL::to(''.$products->product_image_new->image,null)); ?>" alt="<?php echo e($products->product_name->name); ?>" />
                  <img itemprop="image"  class="etalage_source_image" src="<?php echo e(URL::to(''.$products->product_image_new->image,null)); ?>" alt="<?php echo e($products->product_name->name); ?>" />
                  <?php else: ?>
                  not found
                  <?php endif; ?>
                  </a>
               ...
               <li>
                  <img itemprop="image"  class="etalage_thumb_image" src="<?php echo e(URL::to(''.$image->image,null)); ?>" alt="<?php echo e($products->product_name->name); ?>" />
                  <img itemprop="image"  class="etalage_source_image" src="<?php echo e(URL::to(''.$image->image,null)); ?>" alt="<?php echo e($products->product_name->name); ?>" />
               </li>
         ...
         <div style="float: left;"  class="col-sm-4 col-md-5 col-lg-5 pro-detl col-xs-12 ">
            <div class="product-information">
               <!--/product-information-->
               <h1 style="font-size: 20px; margin-top: 0;" itemprop="name"><?php echo e($products->product_name->name); ?></h1>
               <?php if($products->product_prices && $products->product_prices->product_FOB && trim($products->product_prices->product_FOB) != '' && trim($products->product_prices->product_FOB) != '0' && $products->product_prices->product_FOB != null && trim($products->product_prices->product_FOB) != 'NA' && trim($products->product_prices->product_FOB) != 'N/A' && trim($products->product_prices->product_FOB) != '-'): ?>
               ...
               <div style="margin-bottom: 4px;margin-top: 18px;color:#696763;" class="summary" itemprop="offers" itemscope itemtype="http://schema.org/AggregateOffer">
                  FOB Price :
                  <div style="margin-top: -25px;margin-bottom:0px;padding-left:0px;" itemprop="priceCurrency" content="USD"><span class="pro_details_pad"><span style="margin-bottom:0px;padding-left: 91px"> US $</span>
                     <?php if($products->product_prices != null): ?> 
                     <?php if($products->product_prices->product_FOB != null): ?>
                     <?php echo e($products->product_prices->product_FOB); ?>

                     <?php else: ?>
                     <?php endif; ?>
                     <?php endif; ?> / <?php echo e($products->ProductUnit->name); ?></span>
                  </div>
               </div>
               <?php endif; ?>
               ...
               <div   class="summary">Min.Order Quantity: <span itemprop="orderQuantity" style="padding-left:26px" class="pro_details_pad" >    <?php echo e($products->product_prices->product_MOQ); ?> <?php echo e($products->ProductUnit->name); ?></span></div>
               <?php endif; ?>
               <?php endif; ?>
               <?php else: ?>       
               <div style="margin-bottom: 4px;margin-top: 18px;color:#696763;" class="summary" itemprop="offers" itemscope itemtype="http://schema.org/AggregateOffer">
                  FOB Price :        
                  <div style="margin-bottom:0px;padding-left:0px;" itemprop="priceCurrency" content="USD"><span class="pro_details_pad"><a style="margin-left: 18px;" href="#" data-product_id="<?php echo e($products->id); ?>" data-supplier_id="<?php echo e($products->supplier_product->supplier_id); ?>" class="contact_supplier">Get Price</a></span></div>
               </div>
               <?php endif; ?>
               ...
               <div  itemscope itemtype="http://schema.org/OrderItem" class="summary">Supply Ability: <span itemprop="orderQuantity" class="pro_details_pad" style="padding-left: 57px;" ><?php echo e($products->logistic_info->supply_ability); ?>  <?php echo e($products->ProductUnit->name); ?> Per month</span></div>
               <?php endif; ?>
               <?php if(trim($products->logistic_info->port) != '' && trim($products->logistic_info->port) != '0' && $products->logistic_info->port != null): ?>
               <div itemscope itemtype="https://schema.org/DeliveryMethod" class="summary"><span itemprop="name" style="margin-bottom: 0px;margin-top: 0px;">Port:</span><span style="padding-left:120px" class="pro_details_pad"><?php echo e($products->logistic_info->port); ?></span></div>
               <?php endif; ?>
               <?php endif; ?>
               <?php if(trim($products->payment_method) != '' && trim($products->payment_method) != '0' && $products->payment_method != null): ?>
               <div itemscope itemtype="http://schema.org/PaymentMethod" class="summary"><span style="margin-bottom: 0px;margin-top: 0px;" itemprop="name">Payment Terms:</span><span style="padding-left: 52px;" class="pro_details_pad" ><?php echo e(preg_replace('/[.,]/', ', ',$products->payment_method)); ?></span></div>
               <?php endif; ?>
               <div itemscope itemtype="http://schema.org/PaymentMethod" class="summary"><span style="margin-bottom: 0px;margin-top: 0px;" itemprop="name"> Lead Time:</span><span style="padding-left: 82px;" class="pro_details_pad" > <strong>
                  <?php if($products->logistic_info): ?>
                     <?php echo e($products->logistic_info->processing_time ?? ''); ?> 
                  <?php endif; ?>
               ...
               <ul style="padding:4% 0px 0%;display: inline-block;">
                  ...
                  <?php if($products->bdtdcProductToCategory->supp_pro_company): ?>
                  <?php if($products->bdtdcProductToCategory->supp_pro_company->users): ?>
                  <?php if($products->bdtdcProductToCategory->supp_pro_company->users->vacation_mode == 1): ?>
                  <?php
                  $user_active = true
                  ?>
                  <?php endif; ?>
               ...
               <div style="padding-top: 9px;padding-left: 0px">
                  Share to: 
                  <a style="display: inline-block; padding-left: 7px;" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e($actual_link); ?>" ><i class="fa fa-facebook"></i></a>
                  <a href="https://twitter.com/intent/tweet?source=<?php echo e($actual_link); ?>&text=<?php echo e($buy_title); ?>:<?php echo e($actual_link); ?>" target="_blank" title="Tweet"><i class="fa fa-twitter"></i></a>
                  <a href="https://plus.google.com/share?url=<?php echo e($actual_link); ?>" target="_blank" title="Share on Google+"><i class="fa fa-google-plus"></i></a>
                  <a href="http://pinterest.com/pin/create/button/?url=<?php echo e($actual_link); ?>&media=<?php echo e(URL::to(($products->product_image_new?$products->product_image_new->image:'uploads/no_image.jpg'),null)); ?>&description=<?php echo e($buy_title); ?>" target="_blank" title="Pin it"><i class="fa fa-pinterest"></i></a>
               ...
               <?php else: ?>
               <div style="margin: 0px; margin-left:10px;">
                  <h4 class="heading"><a itemprop="url" style="padding-left:10px; font-size: 14px" data-product_id="<?php echo e($products->id); ?>" data-supplier_id="<?php echo e($products->supplier_product->supplier_id); ?>" class="contact_supplier" href=""><i class="fa fa-envelope fa-3x"></i>Message me</a></h4>
               </div>
               <?php endif; ?>
               <div style="margin-right: 28px;">
                  <?php if(Sentinel::getUser()): ?>
                  <?php if(Sentinel::inRole('admins')): ?>
                  <a target="_blank" href="<?php echo e(URL::to('admin/make-me-login-redirect/'.$products->supplier_product->supplier_id.'?redirect=supplier/product_edit/'.$products->id)); ?>" class="btn btn-warning">Edit</a> <button data-product_id="<?php echo e($products->id); ?>" target="_blank" class="btn btn-danger delete_product">Delete</button>
                  <?php endif; ?>
                  <?php endif; ?>
               </div>
               <div class="m-trade-assurance f-icon new-trade-assurance" style="margin-right: 28px;">
                  <h4 class="heading">
                     ...
                     <img itemprop="image" style="    height: 25px;
                        width: 26px;" src="<?php echo e(asset('bdtdc-product-image/home-page/Buyer-protection-home.png')); ?>" alt="Buyer protection">
                     <a style="font-size: 14px" href="<?php echo e(URL::to('BuyerChannel/pages/trade_assurance/5')); ?>"> Buyer Protection:
                     </a>
                     </span>
                  </h4>
                  <div class="list">
                     <ul style="padding-left: 0; line-height: 30px;">
                        <li style="font-size: 12px">
                           <img itemprop="image"  style="height:30px; border-radius: 50px !important;padding-right: 5px" src="<?php echo e(asset('assets/aboutus/img/connecting_people.png')); ?>" alt=" Buyer Protection" />Product Quality Protection
                        </li>
                        <li style="font-size: 12px"> 
                           <img itemprop="image"  style="height:30px; border-radius: 50px !important;padding-right: 5px" src="<?php echo e(asset('assets/aboutus/img/connecting_people.png')); ?>" alt=" Buyer Protection"/>On-time Shipment Protection
                        </li>
                        <li style="font-size: 12px">    
                           <img itemprop="image"  style="height:30px; border-radius: 50px !important;padding-right: 5px" src="<?php echo e(asset('assets/aboutus/img/connecting_people.png')); ?>" alt=" Buyer Protection" />Payment Protection
                        </li>
                     </ul>
                  </div>
               </div>
               ...
               <div style="" class="col-xs-12 padding_0">
                  <div class="col-sm-10 padding_0">
                     <p class="heading_sup">
                        ...
                        <?php echo e($products->bdtdcProductToCategory->supp_pro_company_name->name); ?>

                        </a> 
                        </span>                                                                                 
                        <?php else: ?>
                        <a itemprop="url" target="_blank" href="<?php echo e(URL::to('Home/'.preg_replace('/[^A-Za-z0-9\-]/', '-','name not available').'/'.$products->bdtdcProductToCategory->company_id)); ?>">
                     ...
                     <p itemprop="foundingLocation" class="summary">
                        <?php if($products->bdtdcProductToCategory): ?>
                        <?php if($products->bdtdcProductToCategory->cat_country): ?>
                        <?php echo e($products->bdtdcProductToCategory->cat_country->name); ?>
                        ...
                        <?php if($products->supplier_product->suppliers): ?>
                        <?php if($products->supplier_product->suppliers->business_types): ?>
                        <?php echo e($products->supplier_product->suppliers->business_types->name); ?>
                     ...
                     <p itemprop="foundingLocation" class="summary" style="border-top: 1px solid #ddd;
                        ...
                        <a style="white-space: nowrap;" itemprop="url" target="_blank" href="<?php if($products->bdtdcProductToCategory): ?>
                           ...
                           <?php else: ?>
                           <?php echo e(URL::to('contact/'.preg_replace('/[^A-Za-z0-9\-]/', '-','name not available'),$products->bdtdcProductToCategory->company_id)); ?>
                     ...
                     <div  class="summary">
                        Verified Information: <span> <a style="white-space: nowrap;" target="_blank" href="<?php if($products->bdtdcProductToCategory): ?>
                           ...
                           <?php else: ?>
                           <?php echo e(URL::to('industrial-certification/'.preg_replace('/[^A-Za-z0-9\-]/', '-','name not available'),$products->bdtdcProductToCategory->company_id)); ?>

                           <?php endif; ?>
                           <?php endif; ?>"> View Details</a></span><br>
                     </div>
                  ...
                  <div class="col-sm-9 padding_0">
                     <h5 class="heading">
                        ...
                        <img itemprop="image" style="    height: 29px;
                           width: 28px;" src="<?php echo e(asset('bdtdc-product-image/home-page/Buyer-protection-home.png')); ?>" alt="Buyer protection">
                        Buyer Protection
                        </a>
                     </h5>
                  </div>
   ...
   <div class="col-md-12 col-sm-12" style="padding-left: 0px" data-spy="scroll" data-target="#navbar-example1">
      <div class="col-md-9 col-sm-9" style="padding-left: 0px">
                  ...
                  <div id="pdetails" class="col-sm-12" style="padding-left: 25px;">
                     <div class="col-sm-4" style="padding: 10px 0;">
                        <div class="col-sm-12" style="padding:0;">
                           ...
                           <div class="col-sm-7" style="padding:0;">
                              <div class="ellipsis " title="<?php echo e($products->supplier_product->sup_companies->country->name); ?>">
                                 <?php echo e($products->supplier_product->sup_companies->country->name); ?>
                     ...
                     <div class="col-sm-4" style="padding: 10px 0;">
                        <div class="col-sm-12" style="padding:0;">
                           ...
                           <div class="col-sm-7" style="padding:0;">
                              <div  class="ellipsis " title="<?php echo e($products->brandname); ?>"><?php echo e($products->brandname); ?>
                     ...
                     <div class="col-sm-4" style="padding: 10px 0;">
                        <div class="col-sm-12" style="padding:0;">
                           ...
                           <div class="col-sm-7" style="padding:0;">
                              <div  class="ellipsis " title="<?php echo e($products->model); ?>">
                                 <?php echo e($products->model); ?>
                     ...
                     ?>
                     <?php if($products): ?>
                     <?php if($products->product_attribute && count($products->product_attribute)>0): ?>
                     <?php $__currentLoopData = $products->product_attribute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <?php if($single_attr->bdtdcAttribute): ?>
                     <?php if(trim($single_attr->bdtdcAttribute->name)!= '' && trim($single_attr->bdtdcAttribute->value)!= ''): ?>
                     <?php if(!in_array($single_attr->bdtdcAttribute->name,$attr_exits)): ?>
                     <div class="col-sm-4" style="padding: 10px 0;">
                        <div class="col-sm-12" style="padding:0;">
                           <div class="col-sm-5" style="padding:0;"><span class="summary"><?php echo e($single_attr->bdtdcAttribute->name); ?>: </span></div>
                           <div class="col-sm-7" style="padding:0;"><span style="padding: 0px;" class=""><?php echo e($single_attr->bdtdcAttribute->value); ?></span></div>
                        </div>
                     </div>
                     <?php 
                  ...
                  <div class="col-sm-12">
                     ...
                     <div style="padding:12px;width:100%; overflow: hidden;" class="box">
                        ...
                        <div id="pimages" style="padding-top: 0px; float: none; clear: none; margin-bottom: 20px">
                           ...
                           <div>
                              <?php if(count($products->proimages_new) > 0): ?>
                              <?php $__currentLoopData = $products->proimages_new; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div  style="max-width: 800px; margin: 0 auto;">
                                 <img itemprop="image"  style="width:70%; padding: 10px 0;" src="<?php echo e(URL::to(''.$image->image,null)); ?>" alt=" Buyer Protection"/>
                              </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php endif; ?>
                           </div>
                        ...
                        <div id="pcer">
                           ...
                           <div >
                              <?php if($products->bdtdcProductToCategory): ?>
                              <?php if($products->bdtdcProductToCategory->supplier_main_certificates): ?>
                              <?php if(count($products->bdtdcProductToCategory->supplier_main_certificates) > 0): ?>
                              <?php $__currentLoopData = $products->bdtdcProductToCategory->supplier_main_certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="">
                                 <img itemprop="image"  style="width:70%" src="<?php echo e(URL::to('uploads',$c_image->image)); ?>" alt="<?php echo e($products->product_name); ?>" />
                              </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php endif; ?>
                              <?php endif; ?>
                              <?php if($products->bdtdcProductToCategory->supplier_honor_certificates): ?>
                              <?php if(count($products->bdtdcProductToCategory->supplier_honor_certificates) > 0): ?>
                              <?php $__currentLoopData = $products->bdtdcProductToCategory->supplier_honor_certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="">
                                 <img itemprop="image"  style="width:70%" src="<?php echo e(URL::to('uploads',$h_image->image)); ?>" alt="<?php echo e($products->product_name); ?>"/>
                              </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php endif; ?>
                              <?php endif; ?>
                              <?php if($products->bdtdcProductToCategory->supplier_patents): ?>
                              <?php if(count($products->bdtdcProductToCategory->supplier_patents) > 0): ?>
                              <?php $__currentLoopData = $products->bdtdcProductToCategory->supplier_patents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="">
                                 <img itemprop="image"  style="width:70%" src="<?php echo e(URL::to('uploads',$p_image->image)); ?>" alt="<?php echo e($products->product_name); ?>"/>
                              </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php endif; ?>
                              <?php endif; ?>
                              <?php if($products->bdtdcProductToCategory->supplier_trademarks): ?>
                              <?php if(count($products->bdtdcProductToCategory->supplier_trademarks) > 0): ?>
                              <?php $__currentLoopData = $products->bdtdcProductToCategory->supplier_trademarks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="">
                                 <img itemprop="image"  style="width:70%" src="<?php echo e(URL::to('uploads',$t_image->image)); ?>" alt="<?php echo e($products->product_name); ?>" />
                              </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php endif; ?>
                              <?php endif; ?>
                        ...
                        <div id="pfaq">
                           ...
                           <div >
                              <?php if($products->supplier_product): ?>
                              <?php if($products->supplier_product->sup_companies): ?>     
                              <?php if($products->supplier_product->sup_companies->name_string): ?>        
                              <?php echo $products->supplier_product->sup_companies->name_string->faq; ?>
                        ...
                        <div id="pservice">
                           ...
                           <div >
                              <div><?php echo $products->delivery; ?> </div>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="tab-pane fade" id="companyprofile" >
                  ...
                  <div class="col-sm-12" style="">
                     ...
                     <div id="pbasic" class="box box-first" style="padding: 12px;float: none;margin: 0; margin-bottom: 2%; ">
                        ...
                        <?php if($products->supplier_product->sup_companies): ?>
                        <?php if($products->supplier_product->sup_companies->name_string): ?>
                        <?php echo e($products->supplier_product->sup_companies->name_string->description); ?>

                        <a itemprop="url" class="dot-app-cp" data-dot="d_type=view_more" rel="nofollow" href="<?php echo e(URL::to(preg_replace('/[^A-Za-z0-9\-]/', '-',$products->supplier_product->sup_companies->name_string->name).'/company-overview/'.$products->supplier_product->sup_companies->id)); ?>">View detail</a>
                        <?php endif; ?>
                        <?php endif; ?>
                        <?php endif; ?>
                        <br>
                        ...
                        <div class="view-swv" itemprop="manufacturer" itemscope itemtype="http://schema.org/Organization">
                           ...
                           Verified Supplier-<?php echo e($products->supplier_product->sup_companies->name_string->name); ?>
                        ...
                        <table itemprop="manufacturer" itemscope itemtype="http://schema.org/Organization" class="table" style="margin-bottom: 0;">
                           <tbody>
                              <tr>
                                 ...
                                 <td itemprop="areaServed"><?php if($products->supplier_product): ?>
                                    <?php if($products->supplier_product->suppliers): ?>
                                    <?php if($products->supplier_product->suppliers->business_types): ?>
                                    <?php echo e($products->supplier_product->suppliers->business_types->name); ?>
                              ...
                              <tr>
                                 ...
                                 <td itemprop="hasOfferCatalog">
                                    <?php if($products->supplier_product): ?>
                                    <?php if($products->supplier_product->sup_main_products): ?>
                                    <?php echo e($products->supplier_product->sup_main_products->product_name_1); ?>,
                                    <?php echo e($products->supplier_product->sup_main_products->product_name_2); ?>,
                                    <?php echo e($products->supplier_product->sup_main_products->product_name_3); ?>
                           ...
                           <table itemprop="manufacturer" itemscope itemtype="http://schema.org/Organization" class="table" style="margin-bottom: 0;">
                              <tbody>
                                 <tr>
                                    ...
                                    <?php if($products->bdtdcProductToCategory): ?>
                                    <?php if($products->bdtdcProductToCategory->bdtdc_main_market): ?>
                                    <td itemprop="areaServed"><?php $__currentLoopData = $products->bdtdcProductToCategory->bdtdc_main_market; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <?php echo e($data->company_main_market?$data->company_main_market->name:''); ?><br>  
                                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </td>
                                    <?php endif; ?>
                                    <?php endif; ?>
                                 ...
                                 <tr>
                                    ...
                                    <td itemprop="hasPOS">
                                       <?php if($products->bdtdcProductToCategory): ?>
                                       <?php echo e($products->bdtdcProductToCategory?($products->bdtdcProductToCategory->tradeinfo?($products->bdtdcProductToCategory->tradeinfo->BdtdcFormValue?$products->bdtdcProductToCategory->tradeinfo->BdtdcFormValue->value:''):''):''); ?> &nbsp;
                                       <?php endif; ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td itemprop="hasPOS"><?php echo e($products->bdtdcProductToCategory?($products->bdtdcProductToCategory->tradeinfo?($products->bdtdcProductToCategory->tradeinfo->form_export_percentage?$products->bdtdcProductToCategory->tradeinfo->form_export_percentage->value:''):''):''); ?> &nbsp;</td>
                                 </tr>
                                 <tr>
                                    <td class="trust"></td>
                                 </tr>
                        ...
                        <div class="table-responsive" style="padding-left: 15px;">
                           <table style="border-left:1px solid #E8E8E8;border-top:1px solid #E8E8E8;padding:1%;border-bottom:1px solid #E8E8E8" class="table capability_table">
                              ...
                              <tbody>
                                 <?php if($products->bdtdcProductToCategory): ?>
                                 <?php if($products->bdtdcProductToCategory->bdtdc_main_market): ?>
                                 <?php $__currentLoopData = $products->bdtdcProductToCategory->bdtdc_main_market; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <tr>
                                    <td style="color:#666"><?php echo e($data->company_main_market?$data->company_main_market->name:''); ?></td>
                                    <td><?php echo e($data->distribution_value); ?>%</td>
                                 </tr>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 <?php endif; ?>
                                 <?php endif; ?>
                        ...
                        <table itemprop="manufacturer" itemscope itemtype="http://schema.org/Organization" class="table" style="margin-bottom: 0;">
                           <tbody>
                              <tr>
                                 ...
                                 <td itemprop="potentialAction"><?php echo e($products->bdtdcProductToCategory?($products->bdtdcProductToCategory->factoryinfo?($products->bdtdcProductToCategory->factoryinfo->form_factory_size?$products->bdtdcProductToCategory->factoryinfo->form_factory_size->value:''):''):''); ?> &nbsp;</td>
                              </tr>
                              <tr>
                                 <td class="trust">    </td>
                                 <td class="summary">Factory Location:</td>
                                 <td itemprop="address"><?php echo e($products->bdtdcProductToCategory?($products->bdtdcProductToCategory->factoryinfo?$products->bdtdcProductToCategory->factoryinfo->factory_location:''):''); ?></td>
                              </tr>
                              <tr>
                                 <td class="trust">    </td>
                                 <td class="summary">No. of Production Lines:</td>
                                 <td itemprop="potentialAction"><?php echo e($products->bdtdcProductToCategory?($products->bdtdcProductToCategory->factoryinfo?$products->bdtdcProductToCategory->factoryinfo->no_of_production_line:''):''); ?> &nbsp;</td>
                              </tr>
                              <tr>
                                 <td class="trust">    </td>
                                 <td class="summary">Number of R&amp;D Staff:</td>
                                 <td itemprop="employee"><?php echo e($products->bdtdcProductToCategory?($products->bdtdcProductToCategory->factoryinfo?($products->bdtdcProductToCategory->factoryinfo->form_rd_staf?$products->bdtdcProductToCategory->factoryinfo->form_rd_staf->value:''):''):''); ?> &nbsp;</td>
                              </tr>
                              <tr>
                                 <td class="trust">    </td>
                                 <td class="summary">Number of QC Staff:</td>
                                 <td itemprop="employee"><?php echo e($products->bdtdcProductToCategory?($products->bdtdcProductToCategory->factoryinfo?($products->bdtdcProductToCategory->factoryinfo->form_qc_staff?$products->bdtdcProductToCategory->factoryinfo->form_qc_staff->value:''):''):''); ?> &nbsp;</td>
                              </tr>
                              <tr>
                                 <td class="trust">    </td>
                                 ...
                                 <td itemprop="url">
                                    <?php if($products->bdtdcProductToCategory): ?>
                                    <?php if($products->bdtdcProductToCategory->factoryinfo): ?>
                                    <?php 
                                    $contact_manufacturing_array = explode(',', $products->bdtdcProductToCategory->factoryinfo->contact_manufacturing)
                                    ?>
                                    <?php $__currentLoopData = $contact_manufacturing_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(trim($single_contact) == 1): ?>
                                    OEM Service Offere &nbsp;
                                    <?php endif; ?>
                                    <?php if(trim($single_contact) == 2): ?>
                                    Design Service Offer &nbsp;
                                    <?php endif; ?>
                                    <?php if(trim($single_contact) == 3): ?>
                                    Buyer Service Offer &nbsp;
                                    <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
         ...
         <div id="pcontact" class="col-sm-12" style="margin-bottom:30px; padding: 0px">
            <form action="<?php echo URL::to('product_details'); ?>" method="post" class="products_details_form" enctype="multipart/form-data">
               <?php echo csrf_field(); ?>

               <div class="row" style="margin-bottom:28px; padding: 0px 30px">
                  <div class="col-sm-12 col-md-12" style="border:1px solid #255E98;">
                     <input type="hidden" name="product_owner_id" value="<?php if($products->supplier_product): ?>
                        <?php if($products->supplier_product->users): ?>
                        <?php echo e($products->supplier_product->users->id); ?>
                     ...
                     <div class="col-sm-12 col-md-12 col-xs-12 padding_0">
                        ...
                        <div class="col-sm-10 col-md-10 col-xs-10 sup-name" style="margin-left: 0;">
                           <?php if($products->supplier_product): ?>
                           <?php if($products->supplier_product->users): ?>
                           <?php echo e($products->supplier_product->users->first_name); ?> <?php echo e($products->supplier_product->users->last_name); ?>
                     ...
                     <div class="col-sm-12  padding_0">
                        ...
                        <div class="col-sm-10 col-md-7" style="padding-top:20px;">
                           <textarea class="productview user_message msg-box" rows="4" style="background-color: rgb(255, 255, 255) !important; font-size: 14px; padding: 10px; width:100%;" name="message" placeholder="Enter your inquiry details such as product name, color, size, MOQ, FOB, etc."><?php echo old('message'); ?></textarea>
                     ...
                     <div class="col-sm-12  padding_0">
                        ...
                        <div class="col-sm-3" style="font-size: 10px;">
                           <input type="number" class="form-control productview qty_int" aria-label="..." name="quantity" placeholder="Enter a number" value="<?php echo old('quantity'); ?>">
                           <p class="validation_status"></p>
                        </div>
                        <div class="col-sm-4" style="margin-left:-14px;font-size: 10px;">
                           <select name="unit_id" style="margin-top: 21px;font-size: 14px; color: #b3b3b3; text-transform: capitalize;background-color:#fff!important;border: 1px solid #DDD;" class="form-control productview" data-value="<?php echo old('unit_id'); ?>">
                     ...
                     <div class="col-sm-12  padding_0" style="margin-top:20px;margin-bottom:3%;">
                        ...
                        <div class="col-sm-10">
                           <p><input type="checkbox" name="check" value="check" style="">
                           ...
                           <br>
                           <button type="submit" class="btn btn-primary join" style="margin-top: 25px;padding-top: 5px;padding-bottom: 5px;font-size: 22px;border-radius: 5px !important;">Send</button>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <div class="col-md-3 col-sm-3">
         ...
         <div style="border:1px solid #ddd;border-radius: 5px !important;">
            ...
            <?php if($products->bdtdcProductToCategory): ?>
            <?php if($products->bdtdcProductToCategory->suppliers_other_products): ?>
            <?php if(count($products->bdtdcProductToCategory->suppliers_other_products)>0): ?>
            <?php $__currentLoopData = $products->bdtdcProductToCategory->suppliers_other_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="border-top:1px solid #ddd;">
               <a itemprop="url" style="text-align: justify;text-justify: inter-word;" href="<?php echo e(URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\.-]/', '-',$single_sp->category_product_name->name).'='.mt_rand(100000000, 999999999).$single_sp->product_id,null)); ?>">
                  <?php if($single_sp->pro_images_new): ?>
                  <div class="text-center" style="padding: 10px;">
                     <img style="width:100%;" class="img-responsive" itemprop="image" src="<?php echo e(URL::to(''.$single_sp->pro_images_new->image,null)); ?>" alt=""/>
                  </div>
                  <?php else: ?>
                  <div class="text-center" style="padding: 10px;">
                     <img style="width:100%;" class="img-responsive" itemprop="image" src="<?php echo e(URL::to('uploads/no_image.jpg',null)); ?>" alt=""/>
                  </div>
                  <?php endif; ?>
                  <p class="text-center" title="<?php echo e($single_sp->category_product_name?$single_sp->category_product_name->name:''); ?>" style="font-size:14px;color:#333333;padding:10px;"><?php echo e(substr($single_sp->category_product_name?$single_sp->category_product_name->name:'', 0, 50)); ?></p>
      ...
      <div style="padding-top: 30px;" class="recommended_items product_slide_area">
         ...
         <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               ...
               <div class="item <?php echo e($item_active==1?'active':''); ?>">
                        ...
                        <div class="single-products">
                           <a itemprop="url" style="text-align: justify;text-justify: inter-word;" href="<?php echo e(URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\.-]/', '-',$single_sp->category_product_name->name).'='.mt_rand(100000000, 999999999).$single_sp->product_id,null)); ?>">
                              <div class="productinfo text-center">
                                 <?php if($single_sp->pro_images_new): ?>
                                 <img itemprop="image" title="<?php echo e($single_sp->category_product_name?$single_sp->category_product_name->name:''); ?>" style="width:100%;height:240px;margin-left:0;border: none;box-shadow:none" src="<?php echo asset(''.$single_sp->pro_images_new->image); ?>" alt="<?php echo e(substr($single_sp->category_product_name?$single_sp->category_product_name->name:'', 0, 50)); ?>" class="img-thumbnail"/>
                                 <?php else: ?>
                                 <img itemprop="image" title="<?php echo e($single_sp->category_product_name->name); ?>" style="width:100%;height:240px;margin-left:0;border: none;box-shadow:none" src="<?php echo e(asset('uploads/no_image.jpg')); ?>" alt="<?php echo e(substr($single_sp->category_product_name?$single_sp->category_product_name->name:'', 0, 50)); ?>" class="img-thumbnail"/>
                                 <?php endif; ?>
                                 <span class="pro_name hot_title" style="text-align: center; height: auto;line-height: 25px; overflow: hidden; font-size: 13px;" itemprop="name"><?php echo e($single_sp->category_product_name?$single_sp->category_product_name->name:'', 0, 30); ?></span>
                                 <?php if($single_sp->cat_pro_price): ?>
                                 <?php if(trim($single_sp->cat_pro_price->product_FOB) != '' && trim($single_sp->cat_pro_price->product_FOB) != '0' && $single_sp->cat_pro_price->product_FOB != null && trim($single_sp->cat_pro_price->product_FOB) != '-' && trim($single_sp->cat_pro_price->product_FOB) != 'NA' && trim($single_sp->cat_pro_price->product_FOB) != 'N/A'): ?>
                                 <p style="font-size:13px;color:#2192D9">FOB <?php echo e(trim($single_sp->cat_pro_price->currency)!=''?$single_sp->cat_pro_price->currency:'USD'); ?> <?php echo e($single_sp->cat_pro_price->product_FOB); ?> / <?php echo e($single_sp->bdtdcProduct?($single_sp->bdtdcProduct->ProductUnit?$single_sp->bdtdcProduct->ProductUnit->name:'pieces'):'pieces'); ?></p>
                                 <?php endif; ?>
                                 <?php endif; ?>
                              </div>
                           </a>
...
<nav class="main-menu">
   <ul>
      <li>
         <a data-product_id="<?php echo e($products->id); ?>" data-supplier_id="<?php echo e($products->supplier_product->supplier_id); ?>" class="contact_supplier">
      ...
      <li class="has-subnav">
         <a href="<?php echo e(URL::to('default','message')); ?>">
      ...
      <li class="has-subnav">
         <a href="<?php echo e(URL::to('get-quotations',null)); ?>">
      ...
      <li>
         <a href="<?php echo e(URL::to('contact',null)); ?>">
...
<script type="text/javascript" src="<?php echo asset('assets/custom.js'); ?>"></script>
