...
<link property='stylesheet' href="<?php echo asset('css/get-quotations.css'); ?>" rel="stylesheet">
...
<div class="row">
   <div class="col-sm-12 col-md-12 col-lg-12">
      <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
         <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"> <a itemprop="url" href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a"> <span itemprop="name" style="color:#333;">Home</span> <i class="fa fa-angle-right top-path-icon"></i></a></li>
         <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"> <a itemprop="url" href="<?php echo e(URL::to('get_qutations')); ?>" class="top-path-li-a"> <span itemprop="name" style="color:#333;">Get Quotations </span><i class="fa fa-angle-right top-path-icon"></i></a></li>
      </ul>
   </div>
</div>
<div class="row  padding_0">
   <div class="">
      <div class="" id="details" class="get_qutations">
         <form action="<?php echo URL::to('get_quotations',null); ?>" method="post" class="get_qutations" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 padding_0">
               ...
               <?php endif; ?>
               <?php if(session()->has('quotation_limit_alert')): ?>
               <div style="padding-left: 316px;margin-bottom: 10px;">
                  <div class="alert-box warning"><i style="color:#ce801f;" class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>Warning: </span><?php echo session()->get('quotation_limit_alert'); ?></div>
               </div>
               <?php endif; ?>
               ...
               <div class="row" style=" padding-right: 100px ">
                  <div class="col-sm-3 padding_0 pp-quet" style="text-align: right;">
                     ...
                     <label class="form-level <?php echo e($errors->has('product_name')?'to-err':''); ?>" for="product">Product Name:</label>
                  </div>
                  <div class="col-sm-9" style="padding-bottom:30px">
                     <input style="height: 45px; text-align: left;padding-left: 15px;" name="product_name" type="text" class="form-control product productview query-input <?php echo e($errors->has('product_name')?'to-err2':''); ?>" placeholder="Key words of products you are looking for" required value="<?php echo e(Input::old('product_name')); ?>">
               ...
               <div class="row" style=" padding-right: 100px ">
                  <div class="col-sm-3 padding_0 pp-quet" style="text-align: right;">
                     <span class="ui2-form-required">*</span>
                     <label class="form-level <?php echo e($errors->has('quantity')?'to-err':''); ?>" for="quantity">Quantity:</label>
                  </div>
                  <div class="col-sm-3">
                     <input name="quantity" style="height:45px;margin-top: 0px;" type="text" class="form-control quantity productview check_integer <?php echo e($errors->has('quantity')?'to-err2':''); ?>" placeholder="Estimated Order Quantity" required value="<?php echo e(Input::old('quantity')); ?>">
                     <p class="validation_status" style="font-size:10px;"></p>
                  </div>

                  <div class="col-sm-3" style="padding-bottom:30px">

                     <select name="unit" style="margin-top: 0px;height: 45px;background-color:#fff!important;border: 1px solid #DDD;" class=" form-control productview  <?php echo e($errors->has('unit')?'to-err2':''); ?>" value="<?php echo e(Input::old('unit')); ?>">
               ...
               <div class="row" style=" padding-right: 100px ">
                  <div class="col-sm-3 padding_0 pp-quet" style="text-align: right;">
                     <span class="ui2-form-required">*</span>
                     <label class="form-level  <?php echo e($errors->has('details')?'to-err':''); ?>" for="details">Details:</label>
                  </div>
                  <div class="col-sm-9" style="padding-bottom:30px">
                     <textarea style="height: 100px;" class="form-control  <?php echo e($errors->has('details')?'to-err2':''); ?>" name="details" placeholder="Dear Sir/Madam, I'm looking for products with the following specifications:"><?php if(Input::old('details') == null || Input::old('details') == ''){echo "";}else{ echo Input::old('details');} ?></textarea>
                  </div>
               </div>
               <div class="row" style=" padding-right: 100px ">
                  <div class="col-sm-3 padding_0 pp-quet" style="text-align: right;">
                  ...
                  <div class="col-sm-9" style="padding-bottom:30px">
                     <!-- <div id="upload" class="col-md-12" style="background:#cecece;padding: 10px;font-size:15px;">
                        <div>
                           ...
                           <input type="file" class="file_up " name="attachment_1" style="display:none" value="<?php echo e(Input::old('attachment_1')); ?>" />
                        ...
                        <div>
                           ...
                           <input type="file" class="file_up" name="attachment_2" style="display:none" value="<?php echo e(Input::old('attachment_2')); ?>" />
                           <span class="file_name" style="color:#333;font-size:15px;">None</span>
                        </div>
                        ...
                        <div>
                           ...
                           <input type="file" class="file_up" name="attachment_3" style="display:none" value="<?php echo e(Input::old('attachment_3')); ?>" />
                           <span class="file_name" style="color:#333;font-size:15px;">None</span>
                        </div>
               ...
               <div id="showe" class="row" style=" padding-right: 100px ">
                  <div class="col-md-12 padding_0">
                     ...
                     <div class="col-sm-3" style="padding-left: 20px; margin-bottom: 10px;">
                        ...
                        <select style="height:45px;" name="fob" class="form-control <?php echo e($errors->has('fob')?'to-err2':''); ?>" value="<?php echo e(Input::old('fob')); ?>">
                     ...
                     <div class="col-sm-3" style="padding-left: 20px; margin-bottom: 10px;">
                        ...
                        <input style="height:45px;" type="text" name="unit_price" class="form-control check_number  <?php echo e($errors->has('unit_price')?'to-err2':''); ?>" placeholder="preferred unit price" value="<?php echo e(Input::old('unit_price')); ?>">
                     </div>
                     <div class="col-sm-3" style="padding-left:20px;">

                        <select style="height:45px;" name="currency" class="form-control  <?php echo e($errors->has('currency')?'to-err2':''); ?>" value="<?php echo e(Input::old('currency')); ?>">
                     ...
                     <div class="col-sm-9 padding_0">
                        <div style="margin-top:15px;" class="col-md-12 padding_0">
                           <div style="padding-left:20px; margin-bottom: 10px;" class="col-sm-6">
                              <input style="height:45px;" type="text" name="port" class="form-control <?php echo e($errors->has('port')?'to-err2':''); ?>" placeholder="Destination Port" value="<?php echo e(Input::old('port')); ?>">
                           </div>
                           <div style="padding-left: 20px;" class="col-sm-6">
                              <select style="height:45px;" name="payment_terms" class="form-control  <?php echo e($errors->has('payment_terms')?'to-err2':''); ?>"" value=" <?php echo e(Input::old('payment_terms')); ?>">
                  ...
                  <div class="col-md-12 padding_0">
                     ...
                     <div class="col-sm-9 padding_0">
                        <div style="" class="col-md-12 padding_0">
                           <div style="margin-top:15px;" class="col-md-12 padding_0">
                              <div style="padding-left:20px;margin-bottom: 10px;" class="col-sm-6">
                                 <input style="height:45px;" type="text" name="expire_date" class="form-control expire_date <?php echo e($errors->has('expire_date')?'to-err2':''); ?>" placeholder="Valid till (yyyy/mm/dd)" value="<?php echo e(Input::old('expire_date')); ?>">
                              </div>
               ...
               <div id="showe2" class="row">
                  ...
                  <div class="col-sm-8" style="padding-left:20px;">
                     ...
                     <div class="checkbox" style="padding-right: 100px; margin-top: 3%;">
                        <label style="padding: 2px;"><input type="checkbox" class="agreement" name="agreement" value="<?php echo e(Input::old('agreement')); ?>">
                           I accept to share my Business Card with the quoted suppliers.
                        </label>
                     </div>

                     <div class="checkbox" style="padding-left: 0px;">
                        <label style="padding: 2px;"><input type="checkbox" class="rules" name="rules" value="<?php echo e(Input::old('rules')); ?>">
                           I have read, understood and agreed to obey the <a target="_blank" href="<?php echo e(URL::to('buying-request')); ?>"> Buying Request Posting Rules</a>.
                        </label>
                     </div>

                     <div style="padding-left:30px; padding-top: 2%; padding-bottom:5%;" class="col-sm-8">
                        <button type="submit" class="btn btn-primary join" style="margin-left: -50px;border-radius: 5px !important; padding: 12px 19px;">Submit Buying Request</button>
                     </div>
