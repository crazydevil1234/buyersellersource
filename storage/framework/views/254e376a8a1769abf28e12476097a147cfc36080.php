					...
					<div class="col-sm-10 col-md-10">
								<div class="page-wrapper">
								    		...
								    		<div id="manage-1">
												...
												<form action="<?php echo e(URL::to('product/manage_product_group_update',$edit_group->id)); ?>" method="post" enctype="multipart/form-data">
												<?php echo csrf_field(); ?>
												...
												<div class="" id="">
													...
													<thead>
														...
														<tr class="">
															<td class="">
																<?php if(trim($edit_group->image) != ''): ?>
																<img style="height:100px;width:100px;" src="<?php echo e(URL::to('public/banner-images',$edit_group->image)); ?>" alt="" />
																<?php else: ?>
																<img style="height:100px;width:100px;" src="<?php echo e(URL::to('public/assets/default-image_450.jpg')); ?>" alt="" />
																<?php endif; ?>
																<p>Change image: <input type='file' name='image' style="border:1px solid #DDD;"></p>
															</td>
															<td style="text-align: center;">
																<label><input type="checkbox" name="show_image" <?php echo e($edit_group->show_banner==1?'checked':''); ?>></label>
															</td>
															<td class="">
																<input type="text" name="name" value="<?php echo e($edit_group->name); ?>" style="border: 1px solid #DDD;height: 43px;width: 234px;padding-left: 2%;font-size: 19px;" required>
															</td>
															<td class="">
																<input type="number" name="sort" style="border: 1px solid #DDD;height: 43px;width: 50px;padding-left: 2%;font-size: 19px;text-align: center;" value="<?php echo e($edit_group->sort); ?>" required>
															</td>
															<td style="text-align: center;">
																<label><input type="checkbox" name="active_group"  <?php echo e($edit_group->active==1?'checked':''); ?>></label>
															</td>
															<td class="" >
