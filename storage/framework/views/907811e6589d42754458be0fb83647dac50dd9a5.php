...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a  itemprop="item" href="<?php echo e(URL::to('contact_message_form')); ?>" class="top-path-li-a"><span itemprop="name" style="color:#333">Contact Us</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<div class="row" style="margin-bottom:4%;background-color:#fff !important;padding-bottom:20px;">
	...
	<div class="col-sm-12">
		<div class="col-sm-1"></div>
			<!-- <form action="<?php echo URL::to('contact/message/form_success'); ?>" method="post" class="contact_message_form" enctype="multipart/form-data"> -->
			<?php echo Form::open(['route'=>'contact_message_form_success']); ?>
		...
		<div class="row cont_margin">
			<div id="footer-shadow" class="col-md-6">
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<img itemprop="image" class="img-responsive img-circle" style="padding-bottom:10px;" src="<?php echo asset('assets/fontend/bdtdc-images/S-M-Shahab-Uddin.png'); ?>" alt="S M Shahab Uddin" />
						
					</div>
				
			</div>
			<div class="col-md-6">
				<img itemprop="image" class="img-responsive header_img_fix" src="<?php echo asset('assets/fontend/img/TB1v.D.jpg'); ?>" alt="showcase" />
			</div>
		</div>
	</div>
