...
<div class="row padding_0">
   <div class="col-sm-12" style="padding: 0; min-height: 60px; padding-top: 15px;">
      <ul class="nav nav-tab nav-pills trade-show-ul" style="background:none;border-bottom: 1px solid #dae2ed; margin-left: 0;" aria-label="Navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
         ...
         <li class="" style="margin-left: 10px;"><a itemprop="url" itemprop="url"  class="padding_0" href="<?php echo e(route('select.suppliers')); ?>" target="_blank" data-toggle="tab" aria-expanded="false" style="background-color: #f5f5f5;color: #5b9bd1;">Quality Suppliers</a></li>
         <li class=""><a itemprop="url" itemprop="url"  style="font-size: 13px;" class="padding_0" href="<?php echo e(route('trade.show')); ?>" data-toggle="tab" aria-expanded="false">BuyerSeller Events</a></li>
         <li class=""><a itemprop="url" itemprop="url"   style="font-size: 13px;" class="padding_0" href="<?php echo URL::to('research',null); ?>" target="_blank">BuyerSeller Research</a></li>
         <li class=""><a itemprop="url" itemprop="url"  style="font-size: 13px;" class="padding_0" href="<?php echo e(route('bdtdc.service')); ?>" data-toggle="tab" aria-expanded="false" target="_blank">Service Highlight</a></li>
      </ul>
   </div>
</div>
<div class="row padding_0" style="background-color: #fff;">
   ...
   <div class="col-sm-7" style="margin-top: 15px;">
      <div class="col-sm-12 col-md-12 col-lg-12 padding_0">
         <img itemprop="image" style="height:250px;width:100%; width:100%;"  src="<?php echo asset('assets/fontend/imgsss/Poverty-Banner-1.jpg'); ?>" class="girl img-responsive" alt="">
      </div>
      <div class="col-sm-12 col-md-12 col-lg-12 padding_0">
         ...
         <p class="portal-content-p" style="float: initial;clear: both;">
            ...
            <button type="button" class="btn btn-primary btn-md" style="border-radius:3px !important;    margin-top: 4px;"><a href="<?php echo e(URL::to('about-us')); ?>" target="_blank" style="color:#fff;">About BuyerSeller</a></button>
            <br>
            <br>
