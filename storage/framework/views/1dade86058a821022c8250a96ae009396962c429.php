<?php $__env->startSection('page_css'); ?>
  ...
  <div class="row">
  			<div class="col-sm-12 col-md-12 col-lg-12">
		              ...
		              <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('terms_use',null)); ?>" class="top-path-li-a"><span itemprop="name">Terms of use</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<?php echo $__env->make('fontend.footerpage.rules_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	      ...
	      <div class="col-sm-9 padding_0" style="padding-left:6%;">         
				...
				<div class="col-sm-12" style="margin-top:2%;">
					...
					<p style="padding-top:20px;">Welcome to <a href="<?php echo e(URL::to('/')); ?>" style="font-size: 14px;padding-right:20%;color: #06C;">www.BuyerSeller.Asia!</a></p>
					<p style="font-size: 14px;padding-right:20%;padding-top:20px;">
						These Terms of Use depict the terms and conditions relevant to your entrance and utilization of the sites
						 at <a itemprop="url" href="<?php echo e(URL::to('/')); ?>" style="font-size: 14px;color: #06C;">www.BuyerSeller.Asia</a>. This record is a lawfully obligatory comply 
						 between you as the user(s) of the Sites (alluded to as "you", "your" or "Client" hereinafter) and the 
						 <a itemprop="url" href="<?php echo e(URL::to('/')); ?>" style="font-size: 14px;color: #06C;">BuyerSeller.Asia</a> substance recorded in statement 2.1 underneath (alluded to as "we", "our" or "BuyerSeller.Asia" 
						 hereinafter). 
					</p>
				</div>
				<div class="col-sm-12" style="margin-top:2%;">
