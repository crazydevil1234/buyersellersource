 ...
 <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('about-us')); ?>" class="top-path-li-a"> <span itemprop="name" style="color: #333;">About BuyerSeller</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('media/room')); ?>"" class="top-path-li-a"> <span itemprop="name" style="color: #333;">Media Room</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<!-- <div class="row padding_0">
		<div class="col-sm-12" style="padding: 0; min-height: 60px; padding-top: 15px;">
				<ul class="nav nav-tab nav-pills trade-show-ul" style="background:none;border-bottom: 1px solid #dae2ed; margin-left: 0;" aria-label="Navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
								...
								<li class=""><a itemprop="url"  style="font-size: 13px;" class="padding_0" href="<?php echo e(URL::to('tradeshow')); ?>" data-toggle="tab" aria-expanded="false">BDTDC Events</a></li>
							<li class=""><a itemprop="url"   style="font-size: 13px;" class="padding_0" href="<?php echo URL::to('research'); ?>" target="_blank">BDTDC Research</a></li>
								<li class=""><a itemprop="url"  style="font-size: 13px;" class="padding_0" href="<?php echo URL::to('bdtdc/service'); ?>" data-toggle="tab" aria-expanded="false" target="_blank">Service Highlight</a></li>
...
<div class="row padding_0" style="background-color: #fff;">
	...
	<div class="col-sm-7" style="margin-top: 15px;">
				<div class="col-sm-12 col-md-12 col-lg-12 padding_0">
						<img itemprop="image" style="height:300px; width:100%; " src="<?php echo asset('assets/fontend/bdtdc-images/Think-bdtdc_layout.jpg'); ?>" class="girl img-responsive" alt="Think Bangladesh_layout">
				</div>
			<div class="col-sm-12 col-md-12 col-lg-12 padding_0">
							<span ><img itemprop="image" style="margin-top:20px; padding-bottom:10px;" src="<?php echo asset('assets/fontend/bdtdc-images/daily-star-logo.png'); ?>" alt="daily-star-logo"></span>
