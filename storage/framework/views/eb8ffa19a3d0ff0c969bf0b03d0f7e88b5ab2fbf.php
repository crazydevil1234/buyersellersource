...
<link property='stylesheet' rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/fontend/page/success.css')); ?>" media="screen" data-name="skins">
    ...
    margin-bottom: 1.4%;">
	    <div class="col-md-12 no-padding">
	            ...
	            <div style="float: left">
	                <h3 class="cong-h3"><img class="suc-img" src="<?php echo asset('assets/fontend/product-images/success.1.png'); ?>" alt="sucess">Congratulations! </h3>
	                <h4 class="cong-h4" style="margin-left:43px;"> Your submission is complete.</h4>

	                <h4 class="cong-h4" style="margin-left:34px;"><a class="btn" href="<?php echo e(URL::to('get-quotations',null)); ?>">Post More Requests >></a></h4>
	                </div>
	                <div style="float: right;">
	                	<h4 class="cong-h4" style="margin-left:0px;padding-left: 0px"><a style="" class="btn" href="<?php echo e(URL::to('/',null)); ?>">Back to Home Page >></a></h4>
	                </div>
...
100% payment refund up to Buyer Protection Amount</h3>
                              <div class="" style="margin-left:32px;">
                                  <a class="learn" href="<?php echo e(URL::to('BuyerChannel/pages/trade_assurance',5)); ?>"> <label for="" style="font-size:16px;color:#8C3A05;cursor:pointer;">Learn More</label></a>
                              </div>
	                        </div>
	                        <div class="home-page">
            ...
            ?>
        <?php endif; ?>
	                        		<h3><a href="<?php echo e(URL::to($dashboard_route,null)); ?>">Dashboard View >></a></h3>
	                        </div>
	                </div>
	                <div class="col-md-4" style="padding-left:0;">
	                   <div class="suces-img" style="padding: 78px;">
	                           <img style="width:48%;" class="suces-img-img" src="<?php echo asset('assets/gold/Buyer-protect.jpg'); ?>" alt="success">
