...
<div class="row padding_0" style="background:#fff; border-bottom: 1px solid rgba(0,0,0,.1); padding-bottom:5%; margin-bottom:2%;">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 padding_0">
		<div class="col-md-12">
			<img  itemprop="image" style="width:100%; max-height:550px;" src="<?php echo asset('assets/aboutus/office1.png'); ?>" class="img-responsive" alt=" office">
		</div>
		<!-- <div class="col-md-4">
		<img  itemprop="image" style="width:100%; max-height:550px;" src="<?php echo asset('assets/aboutus/office-2.png'); ?>" class="img-responsive" alt=" office">
			</div> -->
