<?php $__env->startSection('page_css'); ?>
  <link property='stylesheet' href="<?php echo asset('css/trade-services/secure-payment.css'); ?>" rel="stylesheet">
...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('FooterPage/pages/Secure_Payment',37)); ?>" class="top-path-li-a"><span itemprop="name">Secure Payment</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<div id="secure" class="row" style="background-color:#fff!important; position: relative;">
           ...
           <!-- <div style="position: absolute;bottom: 30px;left: 29%;">
             <a href="<?php echo e(URL::to('wholesale')); ?>" class="secur-pt">Buy Wholesale ></a>
          </div> -->
</div>
...
<div class="row" style="background-color:#E8F1FA;">
      <div class="col-sm-4" style="padding-top:20px;padding-bottom:20px;">
            <div class="col-sm-12">
                  <div class="col-sm-3">
                        <img itemprop="image" style="height:1%;" src="<?php echo asset('assets/helpcenter/images/l.png'); ?>" alt="Buyer Seller" />
                  </div>
                  <div class="col-sm-9">
      ...
      <div class="col-sm-4" style="padding-top:20px;padding-bottom:20px;">
            <div class="col-sm-12">
                  <div class="col-sm-3">
                        <img itemprop="image" style="height:1%;" src="<?php echo asset('assets/helpcenter/images/k.png'); ?>" alt="Buyer Seller" />
                  </div>
                  <div class="col-sm-9">
                        <p style="font-weight: 400;font-size: 1.5em;color: #333;">
      ...
      <div class="col-sm-4" style="padding-top:20px;padding-bottom:20px;">
            <div class="col-sm-12">
                  <div class="col-sm-3">
                        <img itemprop="image" style="height:1%;" src="<?php echo asset('assets/helpcenter/images/m.png'); ?>" alt="Buyer Seller" />
                  </div>
                  <div class="col-sm-9">
                        <p style="font-weight: 400;font-size: 1.5em;color: #333;">
...
<div class="row" style="background-color:#fff!important;margin-top:30px;margin-bottom:30px;border: 1px solid rgb(221, 221, 221);padding: 20px 10px 20px 30px;vertical-align: top;">
     ...
     <div class="col-sm-12">
           <div   class="col-sm-4 footer-shadow" style="padding-top:20px;">
                 <div class="col-sm-3">
                       <img itemprop="image" style="height:45px; width:52px; " class="img-responsive"   src="<?php echo asset('assets/fontend/img/cont-supp-icon.png'); ?>" alt="cont-supp-icon" />
                 </div>
                 <div class="col-sm-9">
...
resolve any issues.
           ...
           <div   class="col-sm-4 footer-shadow" style="padding-top:20px;">
                 <div class="col-sm-3">
                       <img itemprop="image" style="height:45px; width:52px; " class="img-responsive"   src="<?php echo asset('assets/fontend/img/dispute-icon.jpg'); ?>" alt="dispute-icon" />
                 </div>
                 <div class="col-sm-9">
                 <p style="font-size:14px;line-height: 1;font-weight: 400;color: #333;">
...
supplier.
           ...
           <div class="col-sm-4" style="padding-top:20px;">
                 <div class="col-sm-3">
                       <img itemprop="image" style="height:45px; width:52px; " class="img-responsive"   src="<?php echo asset('assets/fontend/img/duspute-service.png'); ?>" alt="duspute-service" />
                 </div>
                 <div class="col-sm-9">
...
<div class="row" style="background-color:#fff!important;margin-top:30px;margin-bottom:3%;border: 1px solid rgb(221, 221, 221);padding: 20px 10px 20px 30px;vertical-align: top;">
      ...
      <div class="col-sm-12" style="">
            <div class="col-sm-2 paymt-cd">
                     ...
                     <p>
                  <img itemprop="image" style="height:80px;width:50px;" src="<?php echo asset('assets/helpcenter/images/master.jpg'); ?>" alt="Buyer Seller" />
                  MasterCard</p>    
            ...
            <div class="col-sm-2 paymt-cd">
                     ...
                     <p>
                        <img itemprop="image" style="height:80px;width:50px;" src="<?php echo asset('assets/helpcenter/images/maesto.png'); ?>" alt="Buyer Seller" />
                        Maestro</p>   
            ...
            <div class="col-sm-2 paymt-cd">
                       ...
                       <p>
                        <img itemprop="image" style="height:80px;width:70px;" src="<?php echo asset('assets/helpcenter/images/visa.jpg'); ?>" alt="Buyer Seller" />
                        Visa</p>   
            ...
            <div class="col-sm-2 paymt-cd" style="padding-top:30px;">
                        ...
                        <img itemprop="image" style="height:40px;width:120px;" src="<?php echo asset('assets/helpcenter/images/western.png'); ?>" alt="Buyer Seller" />
                        
            </div>
            <div class="col-sm-1 paymt-cd" style="padding-top:30px;">
                  
                        <img itemprop="image" style="height:40px;width:80px;" src="<?php echo asset('assets/helpcenter/images/bank.jpg'); ?>" alt="Buyer Seller" />
                       
            </div>
            <div class="col-sm-2 paymt-cd" style="padding-top:30px;">
                
                        <img itemprop="image" style="height:40px;width:130px;padding-left:20px;" src="<?php echo asset('assets/helpcenter/images/web.png'); ?>" alt="Buyer Seller" />
                        
            </div>
            <div class="col-sm-1 paymt-cd" style="padding-top:30px;">
                  
                        <img itemprop="image" style="height:40px;width:80px;" src="<?php echo asset('assets/helpcenter/images/qiwi.png'); ?>" alt="Buyer Seller" />
