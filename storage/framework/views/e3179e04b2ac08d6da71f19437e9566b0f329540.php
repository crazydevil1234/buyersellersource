					      ...
					      <div class="collapse navbar-collapse" id="myNavbar" style="background: #fff;">
					      	<div class="container">
					      		<ul class="nav navbar-nav" style="width: 100%;">
					               <li style="width: 50%; float: left;" class="supp_active"><a href="#supplier" style="color: #333; font-size: 22px;"><img height="24" style="padding-right: 20px;"  src="<?php echo asset('assets/fontend/bdtdc-images/search-mirror.png'); ?>" alt="search mirror">Finding a Supplier</a></li>
					              <li style="width: 50%; float: left;"><a href="#contact" style="color: #333;font-size: 22px;"><img height="24" style="padding-right: 20px;"  src="<?php echo asset('assets/fontend/bdtdc-images/search-mirror.png'); ?>" alt="search mirror">Contacting a Supplier</a></li>
	...
	<div class="container-fluid padding_0" style="background-color: #fff;">
		<div class="container padding_0" id="supplier">
			<div class="row padding_0">
					...
					<div class="col-sm-12 col-md-12 padding_0">
						<img style="width: 100%; padding: 25px 0; margin: 0 auto; border:0 none; max-height: 350px;" src="<?php echo asset('assets/fontend/bdtdc-images/submit-request.jpg'); ?>" alt="submit request">
					</div>
					<div class="col-sm-12 col-md-12 padding_0">
								<div class="col-sm-4 col-md-4">
										<div class="supplier-iii">
											<div class="bb-protect">
												<img title="Buyer Protection" style="width: 65px; height: 65px;" src="<?php echo asset('assets/fontend/bdtdc-images/Buyer-protection-home.png'); ?>" alt="verified supplier">
											</div>
											<div class="ui3-title">
												Buyer Protection
											</div>
...
orders directly.
								...
								<div class="supplier-iii">
											<div class="bb-protect">
											<img title="Gold Supplier" style="width: 65px; height: 65px;" src="<?php echo asset('assets/fontend/bdtdc-images/gold_supplier20120802.jpg'); ?>" alt="Buyer protection home">
...
as a legally registered business on BuyerSeller.Asia.
								...
								<div class="col-sm-4 col-md-4">
										<div class="supplier-iii">
											<div class="bb-protect">
												<img title="Assessed Supplier" style="width: 65px; height: 65px;" src="<?php echo asset('assets/gold/Assessed-Supplier.png'); ?>" alt="assecedv">
											</div>
											<div class="ui3-title">
												Assessed Supplier
											</div>
	...
	<div class="container-fluid padding_0">
		<div class="container padding_0" id="contact">
				<div class="row">
					...
					<div class="col-sm-12 col-md-12 padding_0">
								<img style="width: 100%; padding: 25px 0; margin: 0 auto; border:0 none; max-height: 350px;" src="<?php echo asset('assets/fontend/bdtdc-images/leatrher-laugage.jpg'); ?>" alt="leatrher laugage">
								<img style="width: 100%; padding: 25px 0; margin: 0 auto; border:0 none; max-height: 190px;" src="<?php echo asset('assets/fontend/bdtdc-images/by-sequence.jpg'); ?>" alt="by sequence">
					</div>
			</div>
			</div>
			</div>
				...
				<div class="row"  style="width: 100%; padding-bottom: 25px; margin-bottom: 10px; border-bottom: 1px solid #e5e5e5;">
					...
					<div class="" style="background:#fff;">
	   				<div class="col-sm-4 col-md-4 col-lg-4" style="border-right: 1px solid #ddd;">
	   					...
	   					<img class="sourc-img" src="<?php echo asset('assets/fontend/bdtdc-images/hero1.jpg'); ?>" alt="contact-byuer">
	   					<h2 style="font-size: 20px;font-weight: normal;overflow: hidden;width: 100%;">Bd-Md-Forhad Ahmmed Russel</h2>
	   					<h5><a href="<?php echo e(URL::to('Home/Green-Field',1559)); ?>" target="_blank"> CEO of Green Field</a> </h5>
	   				...
	   				<div class="col-sm-4 col-md-4 col-lg-4" style="border-right: 1px solid #ddd;">
	   					<img class="sourc-img" src="<?php echo asset('assets/fontend/bdtdc-images/hero2.jpg'); ?>" alt="contact-gold-member">
	   					<h2 style="font-size: 20px;font-weight: normal;overflow: hidden;width: 100%;"> MIR MD. ALIMUZZAMAN</h2>
	   					<h5><a href="<?php echo e(URL::to('Home/Raid-International',1379)); ?>" target="_blank"> CEO Raid International</a></h5>
	   				...
	   				<div class="col-sm-4 col-md-4 col-lg-4" style="border-right: 0 none;">
	   					<img class="sourc-img" src="<?php echo asset('assets/fontend/bdtdc-images/hero3.jpg'); ?>" alt="contact-gold-member">
	   					<h2 style="font-size: 20px;font-weight: normal;overflow: hidden;width: 100%;">Mr. Mahfuz Haque</h2>
	   					<h5><a href="<?php echo e(URL::to('Home/Supplyhouse',1461)); ?>" target="_blank">CEO OF SUPPLY HOUSE</a></h5>
