...
<?php $__env->stopSection(); ?>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li"  itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('BuyerChannel/pages/meet_suppliers',13)); ?>" class="top-path-li-a"><span itemprop="name">Meet Suppliers</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
                         <li class="top-path-li"  itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('apply-sourceing-meeting',null)); ?>" class="top-path-li-a"><span itemprop="name">Apply for Sourceing Meeting</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
  ...
  <div class="row padding_0">
  	<?php echo Form::open(['route'=>'apply_sourcing_meeting_store']); ?>
  			...
  			<form role="form" autocomplete="off">
			    ...
			    <div class="form-group">
			     <div class="col-sm-12 col-md-12 col-lg-12" style="margin-top: 4%;">
			     			...
			     			<div class="col-sm-4 col-md-4 col-lg-4 col-padding">
			     					 <input type="text" name="name" value="<?php echo e($suppliers->name_string->name ?? ''); ?>" id="" class="form-control">
			     			</div>
			    ...
			    <div class="form-group">
			     <div class="col-sm-12 col-md-12 col-lg-12">
			     			...
			     			<div class="col-sm-4 col-md-4 col-lg-4 col-padding">
			     					 <input type="text" name="contact_person" value="<?php echo e($suppliers->users->first_name ?? ''); ?> <?php echo e($suppliers->users->last_name ?? ''); ?>"  id="" class="form-control">
			     			</div>
			     			<div class="col-sm-5 col-md-5 col-lg-5">
			    ...
			    <div class="form-group">
			     <div class="col-sm-12 col-md-12 col-lg-12">
			     			...
			     			<div class="col-sm-4 col-md-4 col-lg-4 col-padding">
			     					 <input type="email" name="email" id="" value="<?php echo e($suppliers->users->email ?? ''); ?>" class="form-control">
			     			</div>
			     			<div class="col-sm-5 col-md-5 col-lg-5">
			    ...
			    <div class="form-group">
			     <div class="col-sm-12 col-md-12 col-lg-12">
			     			...
			     			<div class="col-sm-2" style="margin-left: -30px;font-size: 10px;padding-left: 4%;">
			     				<!-- <p><?php echo e($suppliers->country->name ?? ''); ?></p> -->
                             <input type="text" class="form-control" aria-label="..." name="name" value="<?php echo e($suppliers->country->name ?? ''); ?>">
                         	</div>
			     			<!-- <div class="col-sm-4 col-md-4 col-lg-4 col-padding">
		     					 <select name="country" id="" class="form-control">
		     					 		<option><?php echo e($suppliers->country->name ?? ''); ?></option>
