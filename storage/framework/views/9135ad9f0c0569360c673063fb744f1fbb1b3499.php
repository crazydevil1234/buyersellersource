...
<img alt="logo" style="width:91%;height:auto" itemprop="logo" class="loggg" src="<?php echo e(asset('assets/logo.png')); ?>" />
</a>
</div>
...
<li><a target="_blank" style="padding-left:0" itemprop="url" href="<?php echo e(URL::to('online-marketplace',null)); ?>">Shop by Category</a></li>
...
<li><a target="_blank" itemprop="url" href="<?php echo e(URL::to($page->prefix.'/pages/'.$page->sort_name,$page->id)); ?>" class="prefix_url"><?php echo e($page->name); ?></a></li>
<?php endif; ?>
...
<li><a target="_blank" itemprop="url" href="<?php echo e(URL::to($page->slug,null)); ?>" class="prefix_url"><?php echo e($page->name); ?></a></li>
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</ul>
</li>
...
<li style="margin-left:0"><a target="_blank" itemprop="url" href="<?php echo e(URL::to('join',null)); ?>" class="join_btn">Join Free</a></li>
<?php endif; ?>
<?php if(Sentinel::check()): ?>
<?php
...
<span id="all_notification" style="margin-left:5px"><i data-count="<?php echo e($all_notifications); ?>" class="glyphicon notification-icon"></i></span>
...
<?php if(Sentinel::check()): ?>
<li><a target="_blank" itemprop="url" href="<?php echo e(URL::to($dashboard_route,null)); ?>">Dashboard</a></li>
<?php endif; ?>
<li title="" class="pusher_notification_1"><a target="_blank" itemprop="url" href="<?php echo e(URL::to('default','message')); ?>">New Inquiry <span style="margin-left:5px"><i data-count="<?php echo e($inquiry_notifications); ?>" class="glyphicon notification-icon"></i></span>
</a></li>
<li title="" class="pusher_notification_2" style="margin-bottom:10px"><a target="_blank" itemprop="url" href="<?php echo e(URL::to('Mybuying-Request',null)); ?>">New Quote <span style="margin-left:5px"><i data-count="<?php echo e($quote_notifications); ?>" class="glyphicon notification-icon"></i></span>
</a></li>
...
For Buyer</li>
<li><a target="_blank" itemprop="url" href="<?php echo e(URL::to('get-quotations',null)); ?>" target="_blank" class="" style="">Get Quotations Now</a>
</li>
<li class="navigation-menu-list-li"><a target="_blank" itemprop="url" href="<?php echo e(URL::to('Mybuying-Request',null)); ?>" class="navigation-menu-list-li-a">Manage Buying Requests</a></li>
...
<li class="navigation-menu-list-li"><a target="_blank" itemprop="url" target="_blank" href="<?php echo e(URL::to('dashboard','product')); ?>" class="navigation-menu-list-li-a">Display New Products</a></li>
<li class="navigation-menu-list-li"><a target="_blank" itemprop="url" target="_blank" href="<?php echo e(URL::to('dashboard','company_site')); ?>" class="navigation-menu-list-li-a">Company & Site</a></li>
<li class="navigation-menu-list-li"><a target="_blank" itemprop="url" target="_blank" href="<?php echo e(URL::to('quotation/management',null)); ?>" class="navigation-menu-list-li-a">Quotes Management</a></li>
<?php endif; ?>
<?php if(Sentinel::check()): ?>
...
<form class="form form-horizontal" itemprop="target" action="<?php echo URL::to('search-product',null); ?>" method="post">
...
<?php if(isset($header)): ?>
<input itemprop="query-input" name="key" class="form-control search_key" style="font-size:12px!important;border:1px solid #255E98!important" type="text" placeholder="<?php echo e($header->name ?? ''); ?>" required="required" required />
<?php else: ?>
...
<a target="_blank" itemprop="url" title="get quote" href="<?php echo e(URL::to('get-quotations',null)); ?>"><span style=""><img itemprop="image" style="max-width:100%;height:46px" class="pull-right" src="<?php echo asset('assets/gold/Get-Quotation-home.png'); ?>" alt="Get Quotation home" /></span></a>
</div>
</div>
</div>
</div>
