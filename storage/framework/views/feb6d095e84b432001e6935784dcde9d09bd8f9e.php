    ...
    <link property='stylesheet' href="<?php echo asset('css/for-buyers/trade-answers.css'); ?>" rel="stylesheet">
	...
	<div class="row" style="margin-bottom: 8px">
      ...
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a" ><span itemprop="name">Home</span> <i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('help-center',null)); ?>" class="top-path-li-a"><span itemprop="name">Help Center</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
      <li class="top-path-li" itemprop="itemListElement" itemscope
...
<div class="row" style="background:#fff;">
    <div class="col-md-8">
        <div class="trade-left">
            <img itemprop="image" style="width:250px;height:200px;" class="trade-left-img" src="<?php echo asset('assets/fontend/bdtdc-images/trtade-answer.jpg'); ?>" alt="trade answer">
            <div>
    ...
    <div class="col-md-4">
        <div class="trade-right" style="padding: 0 31px 10px;border: 1px solid #ccc;">
            <h3 class="trade-right-h3" style="padding: 10px 0; line-height: 0.7;"><a itemprop="url" class="trade-right-h3-a" href="<?php echo e(URL::to('SupplierChannel/pages/suppliers_memebership','23')); ?>">Why should one select a Gold Membership Package?</a></h3>
...
<div class="row" id="home_b" style="margin-bottom:28px;border-bottom: 1px solid rgba(0,0,0,.1);padding-bottom:2%;">
    <div class="col-md-2 col-xs-6" style="padding-left:0;margin-left:0; padding-top:3%;">
        <ul class="left-ul" style="margin-top:7%;">
           <li class="left-ul-li"><a itemprop="url" class="left-ul-li-a" href="<?php echo e(URL::to('about-us')); ?>">About BuyerSeller.Asia</a></li>
            ...
            <div class="td-ans-cont">
                ...
                <h4 class="td-ans-cont-h4">
                    <a itemprop="url" href="<?php echo e(URL::to('trade/answers',$t->id)); ?>">
                        <?php if($t->brif): ?>
                            <span><?php echo e($i); ?>. <?php echo e($t->brif); ?></span>
                        <?php endif; ?>
                    </a> 
                </h4>
            ...
            <div class="tab-content">
                <div id="questions" class="tab-pane fade in active">
                  <!--   <?php $__currentLoopData = $trade; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="ans-btun">
                            <?php if($t->user): ?>
                                <a itemprop="url" href="#"> <img itemprop="image" src="<?php echo e(URL::to('uploads',$t->user->profile_picture)); ?>" alt=""></a>
          ...
          <div class="modal-content">
            ...
            <div class="tab-content">
              ...
              <div id="trade" class="tab-pane fade in active">
               ...
               <form action="<?php echo e(URL::to('trade/answers',null)); ?>" method="post">
                <?php echo csrf_field(); ?>
...
/***** click sub-category*****/
  ...
  //finding suppliers
      $(document).on({click:function(e)
    {
      ...
      var category_url="<?php echo URL::to('pages/category_submit/category_id'); ?>";
