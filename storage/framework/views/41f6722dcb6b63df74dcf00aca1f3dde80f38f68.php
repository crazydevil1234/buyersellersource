	...
	<div class="tab-content">
	      ...
	      <div class="col-sm-12" style="border:1px solid #DAE2ED;border-top:none;padding-top:10px;background-color:#fff !important;padding-bottom: 15px; margin-bottom: 20px">
	      	...
	      	<div class="col-sm-3">
	      		<div class="framr-border">
	      			...
	      			<img itemprop="image" style="height: 146px;width: 144px; margin-left: 2px; padding-top: 32px;" src="<?php echo asset('assets/fontend/bdtdc-images/supplier115.jpg'); ?>" alt="" />
	      		</div>
		            ...
		            <ol class="carousel-indicators">
			         ...
			         <div class="carousel-inner" role="listbox">
		                <div class="item active">
		                 	<img itemprop="image" style="height:480px;max-height:480px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/suppliers/1.jpg'); ?>" alt="bangladesh means business">
						       
		                </div>

		            
		              <div class="item">
		                 <!--  <img itemprop="image" style="height:480px;max-height:480px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/suppliers/2.jpg'); ?>" alt="bangladesh means business"> -->
		                 <div>
		                 <div class="col-sm-12">
		                 				<div class="col-sm-6">
		                 					<img itemprop="image" style="height:80px;width:80px;margin-left: -1px; float:left;" src="<?php echo asset('assets/fontend/bdtdc-images/gold_supplier20120802.jpg'); ?>" alt="Gold Suppliers">
		                 					<h3 style="font-size:18px;margin-top:8%;">Gold Suppliers</h3>
		                 				</div>
		                 				<div class="col-sm-6">
		                 					<img itemprop="image" style="height:80px;width:80px;margin-left: -1px;float:left;" src="<?php echo asset('assets/fontend/bdtdc-images/verified-supplier.png'); ?>" alt="Assessed Suppliers">
		                 ...
		                 <div class="col-sm-12">
		                 				...
		                 				<div class="col-sm-6">
		                 					<img itemprop="image" style="height:80px;width:80px;margin-left: -1px;float:left;" src="<?php echo asset('assets/fontend/bdtdc-images/Buyer-protection-home.png'); ?>" alt="Buyer Protection">
		                 ...
		                 <div class="col-sm-12" style="padding-bottom:100px;">
		                 				<div class="col-sm-6">
		                 				<img itemprop="image" style="height:80px;width:80px;margin-left: -1px; float:left;" src="<?php echo asset('assets/gold/A&V-Check.png'); ?>" alt="A&V Check">
		                 					<h3 style="font-size:18px;margin-top:8%;">A&V Check</h3>
		                 				</div>
		                 				<div class="col-sm-6">
		                 					<img itemprop="image" style="height:80px;width:80px;margin-left: -1px;float:left;" src="<?php echo asset('assets/helpcenter/Hand-Shake-Icon.png'); ?>" alt="Hand Shake Icon">
		                  		...
		                  		<div class="col-sm-12" style="padding-bottom:100px;">
		                  				<div style="width:80%; display:block; padding-left:40px;">
		                  						<div style="width:100%; padding-bottom:40px;">
		                  							<img itemprop="image" style="height:80px;width:80px;margin-left: -1px; float:left;" src="<?php echo asset('assets/fontend/bdtdc-images/verified-supplier.png'); ?>" alt="Hand Shake Icon">
		                 ...
		                 <div class="item">
		                 		<div>
		                  		<div class="col-sm-12" style="padding-bottom:100px;">
		                  				<div style="width:80%; display:block; padding-left:40px;">
		                  						<div style="width:100%; padding-bottom:40px;">
		                  							<img itemprop="image" style="height:80px;width:80px;margin-left: -1px; float:left;" src="<?php echo asset('assets/helpcenter/Hand-Shake-Icon.png'); ?>" alt="A&V Check">
		                 ...
		                 <div class="item">
		                  <img itemprop="image" style="height:480px;max-height:480px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/verify-your-account.jpg'); ?>" alt="veryfiy account">
		                </div>
	    ...
	    <div id="menu1" class="tab-pane fade">
	      <div class="col-sm-12" style="border:1px solid #DAE2ED;border-top:none;padding-top:10px;background-color:#fff !important;">
	      	...
	      	<div class="col-sm-3">
	      		<img itemprop="image" style="height: 200px;width: 55%;" src="<?php echo asset('assets/suppliers/9.jpg'); ?>" alt="" />
	      	</div>
	      		<div class="col-sm-9" style="border-left: 2px solid #DAE2ED;">
	      		<p style="padding-top:20px;padding-bottom:20px;border-bottom: 2px solid #DAE2ED;text-align:center;font-size: 27px;">How to Select Suppliers</p>
	      		<div class="col-sm-12" style="border: 1px solid #DAE2ED;padding-bottom:20px;padding-top:20px;">
