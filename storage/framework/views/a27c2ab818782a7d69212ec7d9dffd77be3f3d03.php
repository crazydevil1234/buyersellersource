...
<div class="row">
		...
		<div class="row padding_0" style="background: #fff; margin-bottom: 20px; padding-bottom: 0%;">
				...
				<div class="col-sm-12 col-md-12 padding_0">
						<div class="col-sm-8 col-md-8">
							<div>
									<img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/bdtdc-images/overview_map.png'); ?>" class="img-responsive" alt="overview map">
								</div>
						</div>
				...
				<div class="col-sm-12 col-md-12">
							...
							<div class="col-sm-5 col-md-5">
									<img itemprop="image" style="margin-top: 20px; width:100%;"  src="<?php echo asset('assets/fontend/bdtdc-images/overview_city.jpg'); ?>" class="img-responsive" alt="overview city">
							</div>
				</div>
	...
	<div class="row padding_0" style="background: #fff; padding-bottom: 5%; margin-bottom: 28px;border-bottom: 1px solid #ddd;">
						...
						<div class="col-sm-5 col-md-5">
							<img itemprop="image" style=" width:100%;"  src="<?php echo asset('assets/fontend/bdtdc-images/overview_photo2.jpg'); ?>" class="img-responsive" alt="Rainbrush">
						</div>
	</div>
<?php $__env->stopSection(); ?>
