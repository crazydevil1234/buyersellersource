    ...
    <link property='stylesheet' href="<?php echo asset('css/for-suppliers/suppliers-memebership.css'); ?>" rel="stylesheet">
    ...
    <div class="row"  style="margin-bottom: 8px">
		...
		<div class="row padding_0" style="background-color: #fff; margin-top: 1px; padding-top: 5px;">
				 <img itemprop="image"   class="img-responsive header_img_fix" src="<?php echo asset('assets/helpcenter/images/member-solutions.jpg'); ?>" alt="member solutions" />
		</div>
			...
			<div class="pricetable pricingtable55" id="upgp">
				<div class="pricetable-inner" style="border-top: 1px solid #ddd;">
					<div class="pricetable-column labeling" style="width:20%; background:none; border:0 none; margin: 0 !important;">
						   <div class="pricetable-column-wall" style="border-right: 1px solid #ddd;">
							...
							<li class="priorty" style="border-bottom: 0 none !important;">Priority Ranking
 											<div class="member-list-right">
 												...
 												<p class="meb-cates-p">90% of buyers will view the first 3 search results pages only.</p>
 												 <img itemprop="image"   style="width: 558px; margin-top: 20px;" src="<?php echo asset('assets/fontend/bdtdc-images/priority-and-severity.jpg'); ?>" alt="priority and severity">
							...
							<li class="priorty" style="border-bottom: 0 none !important;">Exclusive Representation
								...
								<li class="pro-post" style="border-bottom: 0 none !important;">Product Posting
 										...
 										<img itemprop="image"   style="width: 558px; margin-top: 20px;" src="<?php echo asset('assets/fontend/bdtdc-images/product-advertising.jpg'); ?>" alt="product advertising">
 					 ...
 					 <img itemprop="image"   style="width: 558px; margin-top: 20px;" src="<?php echo asset('assets/fontend/bdtdc-images/product-display.jpg'); ?>" alt="product display">
								...
								<li class="buy-req" style="border-bottom: 0 none !important;">Ability to quote Buying Requests
										<div class="member-list-right-d" style="top: -120px;">
 												...
 												<img itemprop="image"   style="width: 558px; margin-top: 20px;" src="<?php echo asset('assets/fontend/bdtdc-images/request-for-quotation.jpg'); ?>" alt=" request for quotation">
								...
								<li class="ver-icon" style="border-bottom: 0 none !important;">Verified Icon
										<div class="member-list-right-e" style="top: -160px;">
 												...
 												<p class="meb-cates-p">Over 85% of buyers prefer to do business with Gold Suppliers only.</p>
 												 <img itemprop="image"   style="width: 558px; margin-top: 20px;" src="<?php echo asset('assets/fontend/bdtdc-images/verify-your-account.jpg'); ?>" alt="verify your account
">
								...
								<li class="custom-pro" style="border-bottom: 0 none !important;">Customized Website
									 <div class="member-list-right-f" style="top: -200px;">
 												...
 												<p class="meb-cates-p">Customized website contains:</p>
													...
													<img itemprop="image"   style="width: 558px; margin-top: 20px;" src="<?php echo asset('assets/fontend/bdtdc-images/website-personalization.png'); ?>" alt="website personalization">
					 ...
					 <?php $i = 1;$con = 0?>
					 <?php $__currentLoopData = $supplier_memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier_membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					 <?php $class_mem = 'mem'.$i;  ?>
					  
					<div class="pricetable-column highlight" style="width:20%">
					  <div class="pricetable-column-wall">
					  	
					  	<form action="<?php echo e(URL::to('user/upgrade')); ?>" method="post" class="<?php echo e($class_mem); ?>">
					  		<?php echo csrf_field(); ?>
						<div class="pricetable-header">
						 <!--  <div class="pricetable-fld-name" style="background-color: #fff !important; color: #666 !important; border:1px solid #e5e5e5; border-top: 0 none; border-right: 0 none; font-size: 11px !important;"> <?php echo e($supplier_membership->descriptions->name); ?></div> -->
						</div>
						
					
						  <?php if($supplier_membership->id == 1): ?>
						  		
						  		<img style="max-height: 135px; max-width: 135px;" src="<?php echo e(asset('assets/fontend/img/superior-membership.png')); ?>" alt="Gold">
						  	 <?php endif; ?>
						  	<?php if($supplier_membership->id == 2): ?>
						  		<img style="max-height: 135px; max-width: 135px;" src="<?php echo e(asset('assets/fontend/img/advance-membership.png')); ?>" alt="Gold">
						  	 <?php endif; ?>
						  	<?php if($supplier_membership->id == 3): ?>
						  		<img style="max-height: 135px; max-width: 135px;" src="<?php echo e(asset('assets/fontend/img/excellent-membership.png')); ?>" alt="Gold">
						  	 <?php endif; ?>
						  		<?php if($supplier_membership->id == 4): ?>
						...
						<ul class="features" style="background: #fff; border-right: 1px solid #ddd;">
							...
							<li><span>Product Showcase</span>
								<?php if($supplier_membership->Product_Showcases==0): ?>
								<i class="fa fa-times" aria-hidden="true" style="color:red;"></i>
								<?php else: ?>
								<?php echo e($supplier_membership->Product_Showcases); ?>

								<?php endif; ?>
							</li>
							<li><span>Buying Request</span><?php if($supplier_membership->Ability_to_quote_Buying_Requests==0): ?>
								<i class="fa fa-times" aria-hidden="true" style="color:red;"></i>
								<?php else: ?>
								Y
								<?php endif; ?>
								</li>
							<li><span>Verified icon</span><?php if($supplier_membership->Verified_Icon==0): ?>
								<i class="fa fa-times" aria-hidden="true" style="color:red;"></i>
								<?php else: ?>
								Y
								<?php endif; ?></li>
							<li><span>Customized minisite</span><?php if($supplier_membership->Customized_Website==0): ?>
									<i class="fa fa-times" aria-hidden="true" style="color:red;"></i>
								<?php else: ?>
									Y
								<?php endif; ?></li>
							<li><span>Personal service</span><?php if($supplier_membership->Personalized_Customer_Service==0): ?>
								 <i class="fa fa-times" aria-hidden="true" style="color:red;"></i>
								<?php else: ?>
									Y
								<?php endif; ?>
							...
							<li><span>Photobank size</span>
								<?php if($supplier_membership->Photo_Bank_Size==0): ?>
									150MB
								<?php else: ?>
									<?php echo e($supplier_membership->Photo_Bank_Size ?? ''); ?> GB
								<?php endif; ?>
							</li>
							...
							<div class="pricetable-button-container" style="padding-bottom: 0; padding-top: 0;">
								<input type="hidden" name="form_class" value="<?php echo e($class_mem); ?>">
							<input type="hidden" name="form_id" value="<?php echo e($supplier_membership->id); ?>">
							<?php if($supplier_membership->id == 4): ?>
								<?php if($active_user == 0): ?>
									<a itemprop="url"  href="<?php echo e(URL::to('join',null)); ?>" style="background: #eeeeee;box-shadow: none;color: #333 !important;border: 1px solid #ddd; text-shadow: none;">Apply Now</a>
									<?php else: ?>
	...
	<div  class="row item_sha" style="margin-bottom:2%;">
		...
		<div class="row cont_margin">
			...
			<div class="col-md-6">
				 <img itemprop="image"   class="img-responsive header_img_fix" src="<?php echo asset('assets/fontend/img/Chart.jpg'); ?>" alt="Chart" />
			</div>
		</div>
	</div>
	<div class="row" style="background-color: #fff; padding-bottom: 3%;margin-bottom: 10px;border-bottom: 1px solid rgba(0,0,0,.1);">
		<p class="mmember-p">To learn more about our Gold Supplier,<a itemprop="url"  href="<?php echo e(URL::to('Gold-supplier',null)); ?>">Click Here</a></p>
  ...
  <div class="modal fade" id="loginModal" role="dialog">
    <div class="modal-dialog" style="width: 720px;">
      <div class="modal-content" style="box-shadow: 2px 5px 8px rgba(0,0,0,.25);">
         <form name="form" class="login_form" method="POST" action="<?php echo e(URL::route('sessions.store')); ?>">
        <?php echo e(csrf_field()); ?>
	        ...
	        <div class="modal-header" style="padding-top: 5px; padding-bottom: 0;">
		          ...
		          <ul class="nav nav-tabs" style="border-bottom: 0 none; margin-bottom: 1px;">
					    ...
					    <li><a itemprop="url"  href="<?php echo e(URL::to('join',null)); ?>" target="_blank">Join BuyerSeller.Asia</a></li>
				  </ul>
