...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('about-us',null)); ?>" class="top-path-li-a"><span itemprop="name">About BDTDC</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('media/room',null)); ?>" class="top-path-li-a"><span itemprop="name">Media Room</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
            ...
            <ol class="carousel-indicators">
	         ...
	         <div class="carousel-inner" role="listbox">
                <div class="item active" style="padding:0 !important; margin:0 !important;">
                 <img itemprop="image" style="width:100%;margin-left: -1px;" src="<?php echo e(asset('assets/fontend/images/Apparel-&-Textile-Fair.jpg')); ?>" alt="Bangladesh dimond fair">
              ...
              <div class="item" style="padding:0 !important; margin:0 !important;">
                  <img itemprop="image" style="width:100%;margin-left: -1px;" src="<?php echo e(asset('assets/fontend/images/Footware-Trade-Show.jpg')); ?>" alt="Bangladesh apperal fair">
                   <div class="carousel-caption" style="width: 44%;padding: 10px 18px;top: 8.2%;right: 0 !important;bottom: inherit;zoom: 1;margin-left: 38%;">
                ...
                <div class="item" style="padding:0 !important; margin:0 !important;">
                  <img itemprop="image" style="width:100%;margin-left: -1px;" src="<?php echo e(asset('assets/fontend/images/Jute-and-Handicraft.jpg')); ?>" alt="Bangladesh lighting fair">
                   <div class="carousel-caption" style="width: 44%;padding: 10px 18px;top: 8.2%;right: 0 !important;bottom: inherit;zoom: 1;margin-left: 38%;">
                ...
                <div class="item" style="padding:0 !important; margin:0 !important;">
                  <img itemprop="image" style="width:100%;margin-left: -1px;" src="<?php echo e(asset('assets/fontend/images/Leather-Fair.jpg')); ?>" alt="Bangladesh electrical fair">
                   <div class="carousel-caption" style="width: 44%;padding: 10px 18px;top: 8.2%;right: 0 !important;bottom: inherit;zoom: 1;margin-left: 38%;">
			...
			<div class="col-lg-8" style="padding:0;padding-top: 15px">
					<div class="col-sm-12" style="background-color: #312E2C; max-height: 40px;">
						...
						<div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd; padding-bottom: 15px;" >
								...
								<a itemprop="url" href="#">
									<img  itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/dimond.jpg'); ?>" alt="dimond">
									</a>
								</div>
								<div class="col-sm-10">
						...
						<div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd; padding-bottom: 15px;" >
								<div class="col-sm-2" style="padding: 0;">
								<a itemprop="url" href="#">
									<img  itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/jewelry.jpg'); ?>" alt="jewelry">
									</a>
								</div>
								<div class="col-sm-10">
											<p style="font-size: 14px;color: #7c7c7c; padding-top: 20px; width: 100%; font-weight: bold;"> 1 - 5 March 2016</p>
						...
						<div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd; padding-bottom: 15px;" >
								<div class="col-sm-2" style="padding: 0;">
								<a itemprop="url" href="#">
									<img  itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/Home_Housewares.jpg'); ?>" alt="Home Housewares">
									</a>
								</div>
								<div class="col-sm-10">
											<p style="font-size: 14px;color: #7c7c7c; padding-top: 20px; width: 100%; font-weight: bold;"> 1 - 5 March 2016</p>
						...
						<div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd; padding-bottom: 15px;" >
								<div class="col-sm-2" style="padding: 0;">
								<a itemprop="url" href="#">
									<img  itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/pc-hardware.jpg'); ?>" alt="pc hardware">
									</a>
								</div>
								<div class="col-sm-10">
											<p style="font-size: 14px;color: #7c7c7c; padding-top: 20px; width: 100%; font-weight: bold;"> 1 - 5 March 2016</p>
						...
						<div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd; padding-bottom: 15px;" >
								<div class="col-sm-2" style="padding: 0;">
								<a itemprop="url" href="#">
									<img  itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/china-beauty.png'); ?>" alt="chinabeauty">
									</a>
								</div>
								<div class="col-sm-10">
											<p style="font-size: 14px;color: #7c7c7c; padding-top: 20px; width: 100%; font-weight: bold;"> 1 - 5 March 2016</p>
						...
						<div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd; padding-bottom: 15px;" >
								<div class="col-sm-2" style="padding: 0;">
								<a itemprop="url" href="#">
									<img  itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/light-building.jpg'); ?>" alt="light building">
									</a>
								</div>
								<div class="col-sm-10">
											<p style="font-size: 14px;color: #7c7c7c; padding-top: 20px; width: 100%; font-weight: bold;"> 1 - 5 March 2016</p>
