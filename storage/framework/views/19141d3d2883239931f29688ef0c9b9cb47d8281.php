	...
	<?php $__env->startSection('content'); ?>
	 <div class="row" style="margin-bottom: 8px">
      ...
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a" ><span itemprop="name">Home</span> <i class="fa fa-angle-right top-path-icon"></i></a></li>
                        <li class="top-path-li" itemprop="itemListElement" itemscope
      itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('about-us',null)); ?>" class="top-path-li-a"><span itemprop="name">About BuyerSeller</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
      <li class="top-path-li" itemprop="itemListElement" itemscope
...
<p class="advisory-p" style="font-size: 13px;">The companies are registered under the Companies Act 1994 and have to abide by the rules stated therein. If in any case, the entrepreneurs or the investors need some guidance regarding the procedures, the same can be fetched from the accounting and law firms within the country offering special support to start up businesses. 
						...
						<div class="col-sm-4">
							<img  class="advisory-img" style="height: 275px;" src="<?php echo e(asset('assets/fontend/bdtdc-images/historical-monuments.jpg')); ?>" alt="historical monuments">
