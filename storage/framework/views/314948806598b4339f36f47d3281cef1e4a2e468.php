   ...
   <div class="col-lg-9" style="padding:0;padding-top: 15px">
         ...
         <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
               <div class="item active">
                  <img itemprop="image" style="width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bdtdc-Training.jpg'); ?>" alt="bangladesh means business">
               </div>
               <div class="item">
                  <img itemprop="image" style="width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/confrence-center.jpg'); ?>" alt="bangladesh means business">
               </div>
               <div class="item">
                  <img itemprop="image" style="width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bdtdc-business-cousulting.jpg'); ?>" alt="bangladesh means business">
               </div>
            </div>
      ...
      <div class="col-sm-12 padding_0">
         <table class="table table-striped">
            ...
            <tbody>
               ...
               <tr>
                  <td><?php echo e($tradeshow->date); ?></td>
                  <td><a itemprop="url" class="trade-title1-a" href="<?php echo e(URL::to('tradeshow/info-details',$tradeshow->tradeshow_id)); ?>"><?php echo e($tradeshow->title); ?></a></td>
               </tr>
      ...
      <div class="col-sm-12 padding_0">
         <div style="padding: 20px 0;">
            <img itemprop="image" style="width: 100%; display: block; height: 40px;" src="<?php echo asset('assets/fontend/bdtdc-images/1289897437882_WhatNew_main.gif'); ?>" alt="sme">
         </div>
      ...
      <div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd; padding-bottom: 15px;">
         <div class="col-sm-2" style="padding: 0;">
            <a itemprop="url" href="#">
               <img itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/sme.jpg'); ?>" alt="sme">
            </a>
         </div>
         <div class="col-sm-10">
      ...
      <div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd;padding-bottom: 15px;">
         <div class="col-sm-2" style="padding: 0;">
            <a itemprop="url" href="#">
               <img itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/sme-smeiner.jpg'); ?>" alt="">
            </a>
         </div>
         <div class="col-sm-10">
      ...
      <div class="col-sm-12 padding_0" style=" padding-bottom: 15px;">
         <div class="col-sm-2" style="padding: 0;">
            <a itemprop="url" href="#">
               <img itemprop="image" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/sme-smeiner-2.jpg'); ?>" alt="">
            </a>
         </div>
         <div class="col-sm-10">
