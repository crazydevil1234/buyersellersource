...
<div class="row padding_0" style="background-color: #fff;border-bottom: 1px solid rgba(0,0,0,.1);">
	<div class="col-sm-2">
		<div class="side-bdtdc-menu">
				<ul style="padding-left: 0;">
					...
					<li><a itemprop="url"    href="<?php echo e(URL::to('contact')); ?>" target="_blank" class="frIco contac-con"><p>Contact Us</p></a></li>
				</ul>
		</div>
		<div class="promo-img">
		...
		<div class="sideSocial">
            <ul style="padding: 0; display: block; overflow: hidden;">
                ...
                <li><a href="#" class="frIco icoSS st_sharethis_custom"></a></li>
	...
	<div class="col-sm-7" style="margin-top: 15px;">
				<div class="col-sm-12 col-md-12 col-lg-12 padding_0">
						 <img style="height:300px" width="100%" src="<?php echo asset('assets/fontend/bdtdc-images/rainbow-hong-kong-Exhibition.jpg'); ?>" class="girl img-responsive" alt=""> 
				</div>
			<div class="col-sm-12 col-md-12 col-lg-12 padding_0">
