	...
	<div class="row sus-wrapper" style="border-bottom: 1px solid #999;">
		<div class="col-md-3">
				<div class="coll">
						<div class="sidebar">
							<img itemprop="image" class="sidebar-img" src="<?php echo asset('assets/helpcenter/company-logo-.jpg'); ?>" alt="trade answer">
						</div>
						<div class="mm" style="border-bottom:10%;">
						<div class="contact">
							<a itemprop="url"  href="<?php echo e(URL::to('contact',null)); ?>" target="_black">
									<p class="contact-p">Question ? Comments?<br> we want to your facedback !</p>
									<h3 class="contact-h3"><a href="<?php echo e(route('contact')); ?>">Contact Us</a></h3>
							</a>
						</div>
						<div class="cont-mess">
						...
						<div class="sidebar" style="margin-top: 20px;">
							...
							<img itemprop="image" class="sidebar-img" style=" height: 100px;" src="<?php echo asset('assets/fontend/bdtdc-images/fullsize_distr.png'); ?>" alt="trade answer">
							</a>
						</div>
				</div>
		</div>
	...
	<div class="row padding_0" style="background-color: #fff;padding-top: 3%; padding-bottom: 3%;">
			<div class="col-md-8 col-sm-8 col-lg-8">
				<div class="col-sm-12">
					...
					<img itemprop="image" style="width: 100%;"  class="sus-img" src="<?php echo asset('assets/fontend/bdtdc-images/comany-provide-logo12.png'); ?>" alt="trade answer">
					...
					<a itemprop="url"  target="_blank" href="http://web.unep.org/climatechange/cop21/">
						<img itemprop="image" style="width: 100%;"  class="sus-img" src="<?php echo asset('assets/fontend/bdtdc-images/comany-provide-logo2.png'); ?>" alt="trade answer">
						<p>COP21/CMP11</p>
						</a>
					</div>
					<div class="col-sm-2">
					<a itemprop="url"  target="_blank" href="https://www.ctc-n.org/">
						<img itemprop="image" style="width: 100%;" class="sus-img" src="<?php echo asset('assets/fontend/bdtdc-images/comany-provide-logo21.jpg'); ?>" alt="trade answer">
						<p style="text-align: center">CTCN</p>
						</a>
					</div>
					<div class="col-sm-2">
					<a itemprop="url"  target="_blank" href="http://www.unep.org/geo/">
						<img itemprop="image" style="width: 100%" class="sus-img" src="<?php echo asset('assets/fontend/bdtdc-images/geo_logo.png'); ?>" alt="trade answer">
						<p style="text-align: center">GEO</p>
						</a>
					</div>
					<div class="col-sm-2">
					<a itemprop="url"  target="_blank" href="http://www.unep.org/greeneconomy/">
						<img itemprop="image" style="width: 100%" class="sus-img" src="<?php echo asset('assets/fontend/bdtdc-images/comany-provide-logo3.jpg'); ?>" alt="trade answer">
					...
					<a itemprop="url"  target="_blank" href="http://www.unep.org/post2015/">
						<img itemprop="image" style="width: 100%" class="sus-img" src="<?php echo asset('assets/fontend/bdtdc-images/comany-provide-logo11.jpg'); ?>" alt="trade answer">
			...
			<div class="col-md-4 col-sm-4 col-lg-4">
					...
					<a itemprop="url"  target="_blank" href="http://uneplive.unep.org/">
						<img itemprop="image" style="width: 100%;" class="sus-img"  src="<?php echo asset('assets/fontend/bdtdc-images/comany-provide-logo.jpg'); ?>" alt="trade answer">
						<p style="text-align: center">UNEP Live</p>
					</a>
					</div>
					<div class="col-sm-6">
					<a itemprop="url"  target="_blank" href="http://thinkeatsave.org/">
						<img itemprop="image" style="width: 100%"  class="sus-img" src="<?php echo asset('assets/fontend/bdtdc-images/comany-provide-logo4.jpg'); ?>" alt="trade answer">
