...
<link property='stylesheet' href="<?php echo asset('css/about-us/entrepreneur-day.css'); ?>" rel="stylesheet"> <?php $__env->stopSection(); ?> <?php $__env->startSection('content'); ?>
<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12">
        <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
            <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                <a itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" class="top-path-li-a"> <span itemprop="name" style="color: #333;">Home </span><i class="fa fa-angle-right top-path-icon"></i></a>
            </li>
            <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                <a itemprop="item" href="<?php echo e(URL::to('about-us,null')); ?>" class="top-path-li-a"> <span itemprop="name" style="color: #333;">About BuyerSeller</span><i class="fa fa-angle-right top-path-icon"></i></a>
            </li>
            <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
    ...
    <div class="col-lg-12" style="padding:0;padding-top: 15px">
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img itemprop="image" style="height:350px;max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bdtdc-e1.jpg'); ?>" alt="bangladesh means business">                        
                        <?php echo $__env->make('contents_view.partials._slide-title', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>

                    <div class="item">
                        <img itemprop="image" style="height:350px;max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bdtdc-e2.jpg'); ?>" alt="bangladesh means business">
                        <?php echo $__env->make('contents_view.partials._slide-title', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>

                    <div class="item">
                        <img itemprop="image" style="height:350px;max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bdtdc-e3.jpg'); ?>" alt="bangladesh means business">
                        <?php echo $__env->make('contents_view.partials._slide-title', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>

                    <div class="item">
                        <img itemprop="image" style="height:350px;max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bdtdc-e4.jpg'); ?>" alt="bangladesh means business">
                        <?php echo $__env->make('contents_view.partials._slide-title', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
        ...
        <div class="col-sm-12 padding_0" style="border-bottom: dotted #ddd; padding-bottom: 15px;">
            <div class="col-sm-2" style="padding: 0;">
                ...
                <img itemprop="image" style="cursor: default;" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/bdtdc-enterpreneurship.jpg'); ?>" alt="">
        ...
        <div class="col-sm-12 padding_0" style=" padding-bottom: 15px;border-bottom: dotted #ddd;">
            <div class="col-sm-2" style="padding: 0;">
                <a itemprop="url" href="<?php echo e(URL::to('Entrepreneurs/globalleader',null)); ?>">
                    <img itemprop="image" style="width: 90%;min-height: 115px;padding-top: 4px;padding-left: 15px; margin-bottom: 10px; max-width: 300px;max-height: 130px;" class="bd-busi-img" src="<?php echo asset('assets/fontend/bdtdc-images/kazi_ahamed.jpg'); ?>" alt="">
            ...
            <div class="col-sm-8">
                ...
                <p style="text-align:left;">BuyerSeller.Asia (<a itemprop="url" href="<?php echo e(URL::to('/',null)); ?>">buyerseller.asia</a>), Entrepreneurship Internship Programs. An internship program that connects students with Bangladesh and Global Entrepreneurs.
                </p>
                <p>
                ...
                <p style="color:#5b9bd1;"> <a itemprop="url" style="color:#5b9bd1;" href="<?php echo e(URL::to('Entrepreneurs/globalleader',null)); ?>">Learn more..</a></p>
