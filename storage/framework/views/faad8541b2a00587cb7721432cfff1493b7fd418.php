            ...
            <ol class="carousel-indicators">
	         ...
	         <div class="carousel-inner" role="listbox">
                <div class="item active">
                 <img itemprop="image" style="max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bangladesh-business1.jpg'); ?>" alt="Bangladesh dimond fair">
              ...
              <div class="item">
                  <img itemprop="image" style="max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bangladesh-business2.jpg'); ?>" alt="Bangladesh apperal fair">
                   <div class="carousel-caption" style="width: 44%;padding: 10px 18px;top: 8.2%;right: 0 !important;bottom: inherit;zoom: 1;margin-left: 38%;">
             ...
             src="<?php echo asset('assets/fontend/bdtdc-images/bangladesh-business_4.jpg'); ?>" alt="Bangladesh lighting fair">
                   <div class="carousel-caption" style="width: 44%;padding: 10px 18px;top: 8.2%;right: 0 !important;bottom: inherit;zoom: 1;margin-left: 38%;">
                ...
                <div class="item">
                  <img itemprop="image" style="max-height:350px;width:100%;margin-left: -1px;" src="<?php echo asset('assets/fontend/bdtdc-images/bangladesh-business_3.jpg'); ?>" alt="Bangladesh electrical fair">
                   <div class="carousel-caption" style="width: 44%;padding: 10px 18px;top: 8.2%;right: 0 !important;bottom: inherit;zoom: 1;margin-left: 38%;">
                ...
                <span class="sr-only">Next</span>
        			...
        			<div class="col-sm-12 padding_0">
        				<div style="padding: 20px 0;">
        					<img itemprop="image" style="width: 100%; display: block; height: 40px;"  src="<?php echo asset('assets/fontend/bdtdc-images/1289897437882_WhatNew_main.gif'); ?>" alt="">
        				</div>
						...
						<div class="col-sm-12 padding_0" style="padding-bottom: 15px;">
								...
								<a itemprop="url" href="#">
									<img itemprop="image"   class="bd-busi-img" style="width: 108%; height: 107px;" src="<?php echo asset('assets/fontend/bdtdc-images/bd-finance.jpg'); ?>" alt="">
									</a>
								</div>
								<div class="col-sm-10">
