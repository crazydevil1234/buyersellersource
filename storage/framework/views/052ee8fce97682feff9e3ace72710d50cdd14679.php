...
<div class="row" style="background-color: #fff!important;">
    <div class="col-sm-=12">
    	...
    	<div class="col-sm-8" id="item_sha" style="margin-bottom:20px;margin-left: 0px;margin-top:30px;margin-bottom:30px;padding-bottom:20px;padding-top:10px;">
                ...
                <div style="margin-bottom: 15px;margin-top: 15px;"><div class="alert-box warning"><i style="color:#ce801f;" class="fa fa-exclamation-triangle" aria-hidden="true"></i><span style="font-weight: bold;">Warning: </span><?php echo e(session()->get('quotation_limit_alert')); ?></div></div>
                <?php else: ?>
                ...
                <?php endif; ?>
                <p style="padding-top: 10px;"><a href="<?php echo e(URL::to($_SERVER['HTTP_REFERER'])); ?>" class="btn btn-primary">Go back</a></p> 
    	</div>
        <div class="col-sm-2"></div>
    </div>
</div>
