...
<div class="row">
		<div class="col-md-10 padding_0" style="padding-bottom: 1%;margin-top: 1%;">
			...
			<li style="float: left" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="<?php echo e(URL::to('/',null)); ?>" style="color: #000"><span itemprop="name">Home &nbsp;</span> </a></li>
			<li style="float: left">
			<a itemprop="item" href="<?php echo e(URL::to('about-us',null)); ?>" style="color: #000"> 
				...
				<div class="col-sm-12 col-md-12">
							<div class="group-business-list">
									 ...
									 <div class="every-group"  style="margin-left: 12%;">
									 		<a href="http://www.globalsourcingbangladesh.com/" target="_blank">
											<img itemprop="image" style="width:100%;" src="<?php echo asset('assets/fontend/bdtdc-images/rainbows-badge-2.png'); ?>" class="img-responsive" alt="Global sourceing Bangladesh"></a>
									</div>
									...
									<div class="every-group"  style="margin-left: 7%;">
											<a href="http://www.appsolutelybest.com/" target="_blank">
											<img itemprop="image" style="width:100%" src="<?php echo asset('assets/fontend/bdtdc-images/rainbows-badge-3.png'); ?>" class="img-responsive" alt="Appsolutely best"></a>
									</div>
				...
				<div class="col-sm-12 col-md-12" style="padding-bottom: 5%;">
							...
							<div class="col-sm-4 col-md-4">
								<div class="every-group"  style="margin-left: -4%;">
											...
											<img itemprop="image"  style="min-height: 105px; width:100%;" src="<?php echo asset('assets/fontend/bdtdc-images/rainbows-badge.png'); ?>" class="img-responsive" alt="rainbow brush"></a>
									</div>
