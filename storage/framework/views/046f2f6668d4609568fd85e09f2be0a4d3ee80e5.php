		...
		<div class="row padding_0" style="background: #fff; margin-bottom: 20px; padding-bottom: %;">
				...
				<div class="col-sm-12 col-md-12 padding_0">
						<div class="col-sm-6 col-md-6" >
							<div>
									<img  itemprop="image" style=" max-width: 430px; max-height: 379px;" src="<?php echo asset('assets/gold/culture-first-min.png'); ?>" class="img-responsive" alt="Business Building">
								</div>
						</div>
...
<p class="overview-p">The larger we grow, the stronger we get. Sharing values enhances company community and cultures which enables to stay ahead in the race.</p>
							...
							<div class="col-sm-6 col-md-6">
									<img  itemprop="image" style="max-height: 400px;" src="<?php echo asset('assets/gold/business-value-min.png'); ?>" class="img-responsive" alt="business quality">
							</div>
				</div>
				<div class="col-sm-12 col-md-12">
						<div class="col-sm-1">
				...
				<div class="col-sm-12 col-md-12" style="padding-left: 7%; padding-right: 7%; padding-bottom: 4%;">
							<div class="col-sm-4 col-md-4">
									<div class="cultureBox" style="width: 100%;">
						            	<div  class="image"><img itemprop="image" style="height:120px; border-radius:50% !important;" src="<?php echo asset('assets/fontend/bdtdc-images/customer.jpg'); ?>" alt="customer"></div>
							...
							<div class="col-sm-4 col-md-4">
										<div class="cultureBox" style="width: 100%;">
							            	<div class="image"><img itemprop="image" style="height:120px; border-radius:50% !important;" src="<?php echo asset('assets/fontend/bdtdc-images/coporation.jpg'); ?>" alt="coporation"></div>
							...
							<div class="col-sm-4 col-md-4">
									<div class="cultureBox" style="width: 100%;">
						            	<div class="image"><img itemprop="image" style="height:120px; width: 140px; border-radius:50% !important;" src="<?php echo asset('assets/fontend/bdtdc-images/embrace.jpg'); ?>" alt="Embrace"></div>
				...
				<div class="col-sm-12 col-md-12" style="padding-left: 7%; padding-right: 7%; padding-bottom: 10%;">
							<div class="col-sm-4 col-md-4">
									<div class="cultureBox" style="width: 100%;height: auto;">
						            	<div class="image"><img itemprop="image" style="height:120px; border-radius:50% !important;" src="<?php echo asset('assets/fontend/bdtdc-images/virture.jpeg'); ?>" alt="virture"></div>
							...
							<div class="col-sm-4 col-md-4">
										<div class="cultureBox" style="width: 100%;height: auto;">
							            	<div class="image"><img itemprop="image" style="height:120px; border-radius:50% !important;" src="<?php echo asset('assets/fontend/bdtdc-images/produce.png'); ?>" alt="produce"></div>
							...
							<div class="col-sm-4 col-md-4">
									<div class="cultureBox" style="width: 100%;height: auto;">
						            	<div class="image"><img itemprop="image" style="height:120px; border-radius:50% !important;" src="<?php echo asset('assets/fontend/bdtdc-images/alligaince.jpg'); ?>" alt="alligaince"></div>
