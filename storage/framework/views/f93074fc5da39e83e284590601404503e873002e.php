				...
				<form action="<?php echo URL::to('get_quotations',null); ?>" method="post" class="get_qutations" enctype="multipart/form-data">
									    ...
									    <div class="alert alert-danger" style="float: left;text-align: left;">
									        <ul>
									            <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									                <li style="text-align: left;"><?php echo $error; ?></li>
								...
								<div class="col-xs-12">
									<p class="formtitlecc" itemprop="name" style="padding: 0; text-align: center;">Complete Your Buying Request</p> 
								            ...
								            <div class="col-xs-12">
                                               ...
                                               <div class="col-xs-12">
                                                ...
                                                <div class="col-xs-12">
                                                 ...
                                                 <div class="col-xs-12">
                                                    <input name="quantity" style="height: 45px; text-align: left;padding-left: 15px; padding-top: 10px;" type="text" class="form-control quantity productview check_integer <?php echo e($errors->has('quantity')?'to-err2':''); ?>" placeholder="Estimated Order Quantity" required value="<?php echo e(Input::old('quantity')); ?>">
                                                ...
                                                <div class="col-xs-12">
                                                   ...
                                                   <div class="col-xs-12" style="padding-bottom:30px" > 
                                                    ...
                                                    <div id ="upload" align="left" class="col-md-12" style="background:#cecece;padding: 10px;font-size:15px;">
                                                    	<div>
	                                                    	 <a itemprop="url" class="upfile  <?php echo e($errors->has('attachment_1')?'to-err':''); ?>""> <i class="fa fa-paperclip"></i> Upload attachments</a>
                                                   ...
                                                   <div id="showe"  style="margin-top: 15px;"> 
                                                   	<div class="col-xs-12">		
                                                   	<select style="height: 45px; text-align: left;padding-left: 15px;" name="fob" class="form-control <?php echo e($errors->has('fob')?'to-err2':''); ?>" value="<?php echo e(Input::old('fob')); ?>">
										  ...
										  <label style="padding: 2px;"><input type="checkbox" class="agreement" name="agreement" checked value="<?php echo e(Input::old('agreement')); ?>">
									   ...
									   <div class="col-xs-12" style="margin-top:15px; ">    
									   <div  align="left" class="checkbox" style="padding-left: 20px;" >
										  <label style="padding: 2px;"><input type="checkbox" class="rules" name="rules" checked value="<?php echo e(Input::old('rules')); ?>">
