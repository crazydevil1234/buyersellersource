...
Route::group(['middleware' => ['auth', 'admin']], function()
{
    ...
    Route::post('admin/profiles/update', ['as' => 'admin.profiles.update', 'uses' => 'Admin\AdminUsersController@update']);
    ...
    Route::get('admin',function(){
        return  redirect(URL::to('admin/dashboard',null,is_secured()));
    });
...
Route::get('Bdsource-home-page',['as'=>'bdsource.page','uses'=>'Front\Bdsource\BdsourceController@index']);
